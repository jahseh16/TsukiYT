...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean z) {
        ...
        String strJoinToString$default = zIsEmpty ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING : CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new Function1() { // from class: cj1.y
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TypeReference.asString$lambda$0(this.y, (KTypeProjection) obj);
            }
        }, 24, null);
        if (isMarkedNullable()) {
            str = "?";
