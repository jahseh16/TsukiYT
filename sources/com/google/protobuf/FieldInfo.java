...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private FieldInfo(Field field, int i, FieldType fieldType, Class<?> cls, Field field2, int i5, boolean z, boolean z5, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    public static FieldInfo forExplicitPresenceField(Field field, int i, FieldType fieldType, Field field2, int i5, boolean z, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i5)) {
            return new FieldInfo(field, i, fieldType, null, field2, i5, false, z, null, null, null, enumVerifier, null);
        }
    ...
    public static FieldInfo forLegacyRequiredField(Field field, int i, FieldType fieldType, Field field2, int i5, boolean z, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i5)) {
            return new FieldInfo(field, i, fieldType, null, field2, i5, true, z, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i5);
    }
