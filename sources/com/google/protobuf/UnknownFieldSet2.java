...
public final class UnknownFieldSet2 implements MessageLite {
    ...
    public static final class Builder implements MessageLite.Builder {
        ...
        public boolean mergeFieldFrom(int i, CodedInputStream codedInputStream) throws IOException {
            ...
            if (tagWireType == 3) {
                Builder builderNewBuilder = UnknownFieldSet2.newBuilder();
                codedInputStream.readGroup(tagFieldNumber, builderNewBuilder, ExtensionRegistryLite.getEmptyRegistry());
        ...
        public Builder mergeFrom(byte[] bArr, int i, int i5) throws InvalidProtocolBufferException {
            try {
                CodedInputStream codedInputStreamNewInstance = CodedInputStream.newInstance(bArr, i, i5);
                mergeFrom(codedInputStreamNewInstance);
                codedInputStreamNewInstance.checkLastTagWas(0);
                return this;
            } catch (InvalidProtocolBufferException e4) {
    ...
    public static final class Field {
        ...
        private List<UnknownFieldSet2> group;
        ...
        public static final class Builder {
            ...
            public Builder addGroup(UnknownFieldSet2 unknownFieldSet2) {
                ...
                this.result.group.add(unknownFieldSet2);
                return this;
            }
        ...
        public int getSerializedSize(int i) {
            ...
            Iterator<UnknownFieldSet2> it5 = this.group.iterator();
            while (it5.hasNext()) {
        ...
        public void writeTo(int i, Writer writer) throws IOException {
            ...
            if (writer.fieldOrder() == Writer.FieldOrder.ASCENDING) {
                for (int i5 = 0; i5 < this.group.size(); i5++) {
                    ...
                    this.group.get(i5).writeTo(writer);
    ...
    public static final class Parser extends AbstractParser<UnknownFieldSet2> {
        ...
        public UnknownFieldSet2 parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            ...
            try {
                ...
                throw e4.setUnfinishedMessage(builderNewBuilder.buildPartial());
            } catch (IOException e5) {
                throw new InvalidProtocolBufferException(e5).setUnfinishedMessage(builderNewBuilder.buildPartial());
            }
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UnknownFieldSet2) && this.fields.equals(((UnknownFieldSet2) obj).fields);
    }
