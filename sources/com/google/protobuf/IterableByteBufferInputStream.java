...
class IterableByteBufferInputStream extends InputStream {
    ...
    private void updateCurrentByteBufferPos(int i) {
        int i5 = this.currentByteBufferPos + i;
    ...
    public int read() throws IOException {
        ...
        int i5 = UnsafeUtil.getByte(((long) this.currentByteBufferPos) + this.currentAddress) & 255;
        updateCurrentByteBufferPos(1);
        return i5;
    }
    ...
    public int read(byte[] bArr, int i, int i5) throws IOException {
        ...
        int i8 = this.currentByteBufferPos;
        int i10 = iLimit - i8;
        if (i5 > i10) {
            i5 = i10;
        }
        if (this.hasArray) {
            System.arraycopy(this.currentArray, i8 + this.currentArrayOffset, bArr, i, i5);
