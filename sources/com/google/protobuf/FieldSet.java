...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public Object getRepeatedField(T t3, int i) {
            if (this.hasNestedBuilders) {
                ensureIsMutable();
            }
            return replaceBuilder(getRepeatedFieldAllowBuilders(t3, i), true);
        }

        public Object getRepeatedFieldAllowBuilders(T t3, int i) {
            if (!t3.isRepeated()) {
        ...
        public void setRepeatedField(T t3, int i, Object obj) {
            ensureIsMutable();
            if (!t3.isRepeated()) {
                throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
            }
        ...
        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t3, Object obj, boolean z) {
