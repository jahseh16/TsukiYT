...
final class CodedOutputStreamWriter implements Writer {
    ...
    private <V> void writeDeterministicBooleanMapEntry(int i, boolean z, V v6, MapEntryLite.Metadata<Boolean, V> metadata) throws IOException {
        this.output.writeTag(i, 2);
        this.output.writeUInt32NoTag(MapEntryLite.computeSerializedSize(metadata, Boolean.valueOf(z), v6));
        MapEntryLite.writeTo(this.output, metadata, Boolean.valueOf(z), v6);
    }
    ...
    private <V> void writeDeterministicIntegerMap(int i, MapEntryLite.Metadata<Integer, V> metadata, Map<Integer, V> map) throws IOException {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            this.output.writeTag(i, 2);
            this.output.writeUInt32NoTag(MapEntryLite.computeSerializedSize(metadata, Integer.valueOf(i10), v6));
            MapEntryLite.writeTo(this.output, metadata, Integer.valueOf(i10), v6);
        }
    }
    ...
    private <V> void writeDeterministicLongMap(int i, MapEntryLite.Metadata<Long, V> metadata, Map<Long, V> map) throws IOException {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            long j = jArr[i8];
            V v6 = map.get(Long.valueOf(j));
            this.output.writeTag(i, 2);
            this.output.writeUInt32NoTag(MapEntryLite.computeSerializedSize(metadata, Long.valueOf(j), v6));
            MapEntryLite.writeTo(this.output, metadata, Long.valueOf(j), v6);
        }
    }
    ...
    public void writeBoolList(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            iComputeBoolSizeNoTag += CodedOutputStream.computeBoolSizeNoTag(list.get(i8).booleanValue());
        }
    ...
    public void writeBytesList(int i, List<ByteString> list) throws IOException {
        for (int i5 = 0; i5 < list.size(); i5++) {
            this.output.writeBytes(i, list.get(i5));
        }
    }

    @Override // com.google.protobuf.Writer
    public void writeDouble(int i, double d4) throws IOException {
        this.output.writeDouble(i, d4);
    }
    ...
    public void writeDoubleList(int i, List<Double> list, boolean z) throws IOException {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            iComputeDoubleSizeNoTag += CodedOutputStream.computeDoubleSizeNoTag(list.get(i8).doubleValue());
        }
    ...
    public void writeFixed32List(int i, List<Integer> list, boolean z) throws IOException {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            iComputeFixed32SizeNoTag += CodedOutputStream.computeFixed32SizeNoTag(list.get(i8).intValue());
        }
    ...
    public void writeFixed64List(int i, List<Long> list, boolean z) throws IOException {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            iComputeFixed64SizeNoTag += CodedOutputStream.computeFixed64SizeNoTag(list.get(i8).longValue());
        }
    ...
    public void writeFloatList(int i, List<Float> list, boolean z) throws IOException {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            iComputeFloatSizeNoTag += CodedOutputStream.computeFloatSizeNoTag(list.get(i8).floatValue());
        }
    ...
    public void writeSFixed32(int i, int i5) throws IOException {
        this.output.writeSFixed32(i, i5);
    }
    ...
    public void writeSFixed32List(int i, List<Integer> list, boolean z) throws IOException {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            iComputeSFixed32SizeNoTag += CodedOutputStream.computeSFixed32SizeNoTag(list.get(i8).intValue());
        }
    ...
    public void writeSFixed64List(int i, List<Long> list, boolean z) throws IOException {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            iComputeSFixed64SizeNoTag += CodedOutputStream.computeSFixed64SizeNoTag(list.get(i8).longValue());
        }
    ...
    public void writeStringList(int i, List<String> list) throws IOException {
        ...
        if (!(list instanceof LazyStringList)) {
            while (i5 < list.size()) {
                this.output.writeString(i, list.get(i5));
                i5++;
            }
        } else {
            LazyStringList lazyStringList = (LazyStringList) list;
            while (i5 < list.size()) {
                writeLazyString(i, lazyStringList.getRaw(i5));
                i5++;
            }
        }
    }
