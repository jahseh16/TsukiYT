...
public class MapEntryLite<K, V> {
    ...
    public static class Metadata<K, V> {
        ...
        public Metadata(WireFormat.FieldType fieldType, K k3, WireFormat.FieldType fieldType2, V v6) {
    ...
    private MapEntryLite(WireFormat.FieldType fieldType, K k3, WireFormat.FieldType fieldType2, V v6) {
        this.metadata = new Metadata<>(fieldType, k3, fieldType2, v6);
        this.key = k3;
        this.value = v6;
    }

    public static <K, V> int computeSerializedSize(Metadata<K, V> metadata, K k3, V v6) {
        return FieldSet.computeElementSize(metadata.keyType, 1, k3) + FieldSet.computeElementSize(metadata.valueType, 2, v6);
    }

    public static <K, V> MapEntryLite<K, V> newDefaultInstance(WireFormat.FieldType fieldType, K k3, WireFormat.FieldType fieldType2, V v6) {
        return new MapEntryLite<>(fieldType, k3, fieldType2, v6);
    }
    ...
    public static <K, V> void writeTo(CodedOutputStream codedOutputStream, Metadata<K, V> metadata, K k3, V v6) throws IOException {
    ...
    public int computeMessageSize(int i, K k3, V v6) {
        return CodedOutputStream.computeTagSize(i) + CodedOutputStream.computeLengthDelimitedFieldSize(computeSerializedSize(this.metadata, k3, v6));
    }
    ...
    public void serializeTo(CodedOutputStream codedOutputStream, int i, K k3, V v6) throws IOException {
        codedOutputStream.writeTag(i, 2);
        codedOutputStream.writeUInt32NoTag(computeSerializedSize(this.metadata, k3, v6));
        writeTo(codedOutputStream, this.metadata, k3, v6);
    }
    ...
    private MapEntryLite(Metadata<K, V> metadata, K k3, V v6) {
