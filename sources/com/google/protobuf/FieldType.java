...
public final class FieldType {
    ...
    private FieldType(String str, int i, int i5, Collection collection, JavaType javaType) {
        int i8;
        this.id = i5;
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i8 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i8 == 2 || i8 == 3) ? false : true;
    }
                ...
                for (int i5 = 0; i5 < actualTypeArguments.length; i5++) {
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        for (int i8 = 0; i8 < typeParameters.length; i8++) {
                            if (type == typeParameters[i8]) {
                                actualTypeArguments[i5] = typeArr[i8];
                            }
                        }
