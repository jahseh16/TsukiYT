...
final class FloatArrayList extends AbstractProtobufList<Float> implements Internal.FloatList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean addAll(Collection<? extends Float> collection) {
        ...
        if (i8 > fArr.length) {
            this.array = Arrays.copyOf(fArr, i8);
        }
    ...
    public void removeRange(int i, int i5) {
        ...
        float[] fArr = this.array;
        System.arraycopy(fArr, i5, fArr, i, this.size - i5);
        this.size -= i5 - i;
        ((AbstractList) this).modCount++;
    }

    @Override // com.google.protobuf.Internal.FloatList
    public float setFloat(int i, float f3) {
        ensureIsMutable();
        ensureIndexInRange(i);
        float[] fArr = this.array;
        float f4 = fArr[i];
    ...
    @Override // com.google.protobuf.AbstractProtobufList, java.util.AbstractList, java.util.List
    public Float set(int i, Float f3) {
        return Float.valueOf(setFloat(i, f3.floatValue()));
    }
    ...
    @Override // com.google.protobuf.AbstractProtobufList, java.util.AbstractList, java.util.List
    public void add(int i, Float f3) {
        addFloat(i, f3.floatValue());
    }

    private void addFloat(int i, float f3) {
        int i5;
        ensureIsMutable();
