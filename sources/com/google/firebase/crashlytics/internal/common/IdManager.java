...
public class IdManager implements InstallIdProvider {
    ...
    private static String formatId(@NonNull String str) {
        return ID_PATTERN.matcher(str).replaceAll(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING).toLowerCase(Locale.US);
    }
    ...
    private String removeForwardSlashesIn(String str) {
        return str.replaceAll(FORWARD_SLASH_REGEX, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING);
    }
    ...
    public FirebaseInstallationId fetchTrueFid(boolean z) {
        ...
        if (z) {
            try {
                ...
                Logger.getLogger().w("Error getting Firebase authentication token.", e4);
                token = null;
            }
        } else {
            token = null;
        ...
        try {
            ...
            Logger.getLogger().w("Error getting Firebase installation id.", e5);
        }
    ...
    public synchronized InstallIdProvider.InstallIds getInstallIds() {
        ...
        if (this.dataCollectionArbiter.isAutomaticDataCollectionEnabled()) {
            ...
            if (firebaseInstallationIdFetchTrueFid.getFid() == null) {
                firebaseInstallationIdFetchTrueFid = new FirebaseInstallationId(string == null ? createSyntheticFid() : string, (String) null);
            }
