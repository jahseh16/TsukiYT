...
public class HeartBeatInfoStorage {
    ...
    private synchronized void cleanUpStoredHeartBeats() {
        try {
            ...
            String key = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
            String str = null;
    ...
    public synchronized boolean isSameDateUtc(long j, long j4) {
        return getFormattedDate(j).equals(getFormattedDate(j4));
    }
    ...
    public synchronized void storeHeartBeat(long j, String str) {
        ...
        if (this.firebaseSharedPreferences.getString(LAST_STORED_DATE, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING).equals(formattedDate)) {
