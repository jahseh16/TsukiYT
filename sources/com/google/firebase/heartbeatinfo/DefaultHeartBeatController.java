...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    private DefaultHeartBeatController(final Context context, final String str, Set<HeartBeatConsumer> set, Provider<UserAgentPublisher> provider, Executor executor) {
        this((Provider<HeartBeatInfoStorage>) new Provider() { // from class: c6.y
    ...
    public Task<String> getHeartBeatsHeader() {
        return !i4.y(this.applicationContext) ? Tasks.forResult(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING) : Tasks.call(this.backgroundExecutor, new Callable() { // from class: c6.n3
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.y.lambda$getHeartBeatsHeader$1();
            }
        });
    }

    public Task<Void> registerHeartBeat() {
        return this.consumers.size() <= 0 ? Tasks.forResult(null) : !i4.y(this.applicationContext) ? Tasks.forResult(null) : Tasks.call(this.backgroundExecutor, new Callable() { // from class: c6.gv
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.y.lambda$registerHeartBeat$0();
            }
        });
    }
