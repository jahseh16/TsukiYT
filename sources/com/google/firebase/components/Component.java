...
public final class Component<T> {
    ...
    public static <T> Component<T> intoSet(final T t3, Class<T> cls) {
        return intoSetBuilder(cls).factory(new ComponentFactory() { // from class: z4.zn
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$intoSet$3(t3, componentContainer);
            }
        }).build();
    }
    ...
    public static <T> Component<T> of(Class<T> cls, final T t3) {
        return builder(cls).factory(new ComponentFactory() { // from class: z4.gv
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$of$0(t3, componentContainer);
            }
        }).build();
    }
    ...
    private Component(@Nullable String str, Set<Qualified<? super T>> set, Set<Dependency> set2, int i, int i5, ComponentFactory<T> componentFactory, Set<Class<?>> set3) {
        this.name = str;
    ...
    public static <T> Component<T> intoSet(final T t3, Qualified<T> qualified) {
        return intoSetBuilder(qualified).factory(new ComponentFactory() { // from class: z4.n3
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$intoSet$4(t3, componentContainer);
            }
        }).build();
    }
    ...
    public static <T> Component<T> of(final T t3, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new ComponentFactory() { // from class: z4.v
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$of$1(t3, componentContainer);
            }
        }).build();
    }
    ...
    public static <T> Component<T> of(final T t3, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
        return builder(qualified, qualifiedArr).factory(new ComponentFactory() { // from class: z4.y
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$of$2(t3, componentContainer);
            }
        }).build();
    }
