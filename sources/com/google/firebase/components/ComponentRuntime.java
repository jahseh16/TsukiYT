...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = new Provider() { // from class: z4.i9
    ...
    public static final class Builder {
        ...
        public Builder addComponentRegistrar(final ComponentRegistrar componentRegistrar) {
            this.lazyRegistrars.add(new Provider() { // from class: z4.t
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
    ...
    private void discoverComponents(List<Component<?>> list) {
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: z4.f
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return this.y.lambda$discoverComponents$0(component);
                    }
                }));
            }
            ...
            if (component.isValue()) {
                ...
                for (Qualified<? super Object> qualified : component.getProvidedInterfaces()) {
                    if (this.lazyInstanceMap.containsKey(qualified)) {
                        ...
                        arrayList.add(new Runnable() { // from class: com.google.firebase.components.y
        ...
        for (Map.Entry entry2 : map.entrySet()) {
            if (this.lazySetMap.containsKey(entry2.getKey())) {
                ...
                for (final Provider provider : (Set) entry2.getValue()) {
                    arrayList.add(new Runnable() { // from class: com.google.firebase.components.n3
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    private static Iterable<Provider<ComponentRegistrar>> toProviders(Iterable<ComponentRegistrar> iterable) {
        ...
        for (final ComponentRegistrar componentRegistrar : iterable) {
            arrayList.add(new Provider() { // from class: z4.c5
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap map;
        if (w.y(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
    ...
    public /* synthetic */ Set setOf(Qualified qualified) {
        return z4.a.v(this, qualified);
    }

    @Override // com.google.firebase.components.ComponentContainer
    public /* synthetic */ Provider setOfProvider(Class cls) {
        return z4.a.fb(this, cls);
    }
