...
public class FirebaseRemoteConfig {
    ...
    public /* synthetic */ Task lambda$activate$2(Task task, Task task2, Task task3) throws Exception {
        ...
        return (!task2.isSuccessful() || isFetchedFresh(configContainer, (ConfigContainer) task2.getResult())) ? this.activatedConfigsCache.put(configContainer).continueWith(this.executor, new Continuation() { // from class: i6.gv
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task4) {
                return Boolean.valueOf(this.y.processActivatePutTask(task4));
            }
    ...
    private Task<Void> setDefaultsWithStringsMapAsync(Map<String, String> map) {
        try {
            return this.defaultConfigsCache.put(ConfigContainer.newBuilder().replaceConfigsWith(map).build()).onSuccessTask(FirebaseExecutors.directExecutor(), new SuccessContinuation() { // from class: i6.zn
    ...
    public Task<Boolean> activate() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2}).continueWithTask(this.executor, new Continuation() { // from class: i6.y
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task3) {
                return this.y.lambda$activate$2(task, task2, task3);
            }
        });
    }
    ...
    public Task<FirebaseRemoteConfigInfo> ensureInitialized() {
        ...
        final Task taskCall = Tasks.call(this.executor, new Callable() { // from class: i6.c5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.y.getInfo();
            }
        });
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2, task3, taskCall, this.firebaseInstallations.getId(), this.firebaseInstallations.getToken(false)}).continueWith(this.executor, new Continuation() { // from class: i6.i9
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task4) {
    ...
    public Task<Void> fetch() {
        return this.fetchHandler.fetch().onSuccessTask(FirebaseExecutors.directExecutor(), new SuccessContinuation() { // from class: i6.n3
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
    ...
    public Task<Boolean> fetchAndActivate() {
        return fetch().onSuccessTask(this.executor, new SuccessContinuation() { // from class: i6.f
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
                return this.y.lambda$fetchAndActivate$1((Void) obj);
            }
        });
    }
    ...
    public Task<Void> reset() {
        return Tasks.call(this.executor, new Callable() { // from class: i6.fb
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.y.lambda$reset$6();
            }
        });
    }
    ...
    public Task<Void> setConfigSettingsAsync(@NonNull final FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new Callable() { // from class: i6.s
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.y.lambda$setConfigSettingsAsync$5(firebaseRemoteConfigSettings);
            }
        });
    }
    ...
    public Task<Void> setCustomSignals(@NonNull final CustomSignals customSignals) {
        return Tasks.call(this.executor, new Callable() { // from class: i6.a
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.y.lambda$setCustomSignals$8(customSignals);
            }
        });
    }
    ...
    public Task<Void> fetch(long j) {
        return this.fetchHandler.fetch(j).onSuccessTask(FirebaseExecutors.directExecutor(), new SuccessContinuation() { // from class: i6.v
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
