...
public class ConfigFetchHttpClient {
    ...
    public ConfigFetchHttpClient(Context context, String str, String str2, String str3, long j, long j4) {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map, Long l3, Map<String, String> map2) throws FirebaseRemoteConfigClientException {
        ...
        map3.put(RemoteConfigConstants$RequestFieldKey.PLATFORM_VERSION, Integer.toString(i));
        ...
        try {
            ...
            if (packageInfo != null) {
                ...
                map3.put(RemoteConfigConstants$RequestFieldKey.APP_BUILD, Long.toString(y.y(packageInfo)));
            }
        } catch (PackageManager.NameNotFoundException unused) {
        }
        map3.put(RemoteConfigConstants$RequestFieldKey.PACKAGE_NAME, this.context.getPackageName());
        map3.put(RemoteConfigConstants$RequestFieldKey.SDK_VERSION, "22.1.0");
        ...
        if (l3 != null) {
            map3.put(RemoteConfigConstants$RequestFieldKey.FIRST_OPEN_TIME, convertToISOString(l3.longValue()));
        }
    ...
    @Keep
    public ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l3, Date date, Map<String, String> map3) throws FirebaseRemoteConfigException {
