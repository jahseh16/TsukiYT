...
public class AbtExperimentInfo {
    ...
    public AbtExperimentInfo(String str, String str2, String str3, Date date, long j, long j4) {
    ...
    public static AbtExperimentInfo fromMap(Map<String, String> map) throws AbtException {
        ...
        try {
            return new AbtExperimentInfo(map.get("experimentId"), map.get("variantId"), map.containsKey(TRIGGER_EVENT_KEY) ? map.get(TRIGGER_EVENT_KEY) : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, protoTimestampStringParser.parse(map.get(EXPERIMENT_START_TIME_KEY)), Long.parseLong(map.get(TRIGGER_TIMEOUT_KEY)), Long.parseLong(map.get(TIME_TO_LIVE_KEY)));
