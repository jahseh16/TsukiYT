...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i, int i5) {
        return getErrorDialog(activity, i, i5, (DialogInterface.OnCancelListener) null);
    }
    ...
    public void setDefaultNotificationChannelId(@NonNull Context context, @NonNull String str) {
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkNotNull(v.y((NotificationManager) Preconditions.checkNotNull(context.getSystemService("notification")), str));
        }
        synchronized (zaa) {
            this.zac = str;
        }
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, int i5) {
        return showErrorDialogFragment(activity, i, i5, (DialogInterface.OnCancelListener) null);
    }
    ...
    public final Dialog zaa(@NonNull Context context, int i, @Nullable zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable DialogInterface.OnClickListener onClickListener) {
        ...
        if (strZab != null) {
            ...
            builder.setPositiveButton(strZab, r8);
        }
    ...
    public final void zae(Context context, int i, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        ...
        NotificationCompat.tl tlVarTa = new NotificationCompat.tl(context).i4(true).fb(true).wz(strZae).ta(new NotificationCompat.f().s(strZad));
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            tlVarTa.rz(context.getApplicationInfo().icon).c(2);
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                tlVarTa.y(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent);
            } else {
                tlVarTa.t(pendingIntent);
            }
        } else {
            tlVarTa.rz(R.drawable.stat_sys_warning).d(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).ud(System.currentTimeMillis()).t(pendingIntent).tl(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                NotificationChannel notificationChannelY = v.y(notificationManager, "com.google.android.gms.availability");
                String string = context.getResources().getString(com.google.android.gms.base.R.string.common_google_play_services_notification_channel_name);
                if (notificationChannelY == null) {
                    zn.y(notificationManager, fb.y("com.google.android.gms.availability", string, 4));
                } else if (!string.contentEquals(y.y(notificationChannelY))) {
                    n3.y(notificationChannelY, string);
                    zn.y(notificationManager, notificationChannelY);
                }
            }
            tlVarTa.c5(str2);
        }
        Notification notificationZn = tlVarTa.zn();
        if (i == 1 || i == 2 || i == 3) {
        ...
        notificationManager.notify(i5, notificationZn);
    }
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zag(@NonNull Activity activity, @NonNull LifecycleFragment lifecycleFragment, int i, int i5, @Nullable DialogInterface.OnCancelListener onCancelListener) {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i, int i5, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, "d"), i5), onCancelListener, null);
    }
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, int i5, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog errorDialog = getErrorDialog(activity, i, i5, onCancelListener);
        if (errorDialog == null) {
            return false;
        }
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i, int i5) {
        return getErrorDialog(fragment, i, i5, (DialogInterface.OnCancelListener) null);
    }

    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, @NonNull s.n3<IntentSenderRequest> n3Var, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i, null, onCancelListener, new zac(this, activity, i, n3Var));
        if (dialogZaa == null) {
            return false;
        }
        zad(activity, dialogZaa, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i, int i5, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, "d"), i5), onCancelListener, null);
    }
}
