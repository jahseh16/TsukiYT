...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public zabe(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, Api.AbstractClientBuilder abstractClientBuilder, Map map, List list, List list2, Map map2, int i, int i5, ArrayList arrayList) {
        ...
        this.zan = context;
        this.zaj = lock;
        this.zak = new zak(looper, zaayVar);
        this.zao = looper;
    ...
    public final PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zac.containsKey(Common.CLIENT_KEY)) {
            ...
            GoogleApiClient.ConnectionCallbacks zaazVar = new zaaz(this, atomicReference, statusPendingResult);
            GoogleApiClient.OnConnectionFailedListener zabaVar = new zaba(this, statusPendingResult);
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public final <L> ListenerHolder<L> registerListener(@NonNull L l3) {
        this.zaj.lock();
        try {
    ...
    public final String zaf() {
        ...
        dump(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, null, new PrintWriter(stringWriter), null);
