...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new n3();
    private final Set zaq = new n3();
    ...
    private final void zaJ(TaskCompletionSource taskCompletionSource, int i, GoogleApi googleApi) {
        ...
        handler.getClass();
        task.addOnCompleteListener((Executor) new zabk(handler), (OnCompleteListener) zacdVarZaa);
    }
    ...
    public final boolean handleMessage(@NonNull Message message) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        if (zabqVar2 == null) {
                            zalVar.zac(apiKey2, new ConnectionResult(13), (String) null);
                            ...
                            if (connectionResultZad != null) {
                                zalVar.zac(apiKey2, connectionResultZad, (String) null);
                            } else {
                                zabqVar2.zat(zalVar);
                                zabqVar2.zao();
                            }
            ...
            case 15:
                ...
                if (this.zan.containsKey(zabs.zab(zabsVar))) {
                    zabq.zal((zabq) this.zan.get(zabs.zab(zabsVar)), zabsVar);
                }
                return true;
            case 16:
                zabs zabsVar2 = (zabs) message.obj;
                if (this.zan.containsKey(zabs.zab(zabsVar2))) {
                    zabq.zam((zabq) this.zan.get(zabs.zab(zabsVar2)), zabsVar2);
                }
                return true;
    ...
    public final void zaw(MethodInvocation methodInvocation, int i, long j, int i5) {
        this.zar.sendMessage(this.zar.obtainMessage(18, new zace(methodInvocation, i, j, i5)));
    }
