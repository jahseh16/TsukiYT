...
public abstract class GoogleApiClient {
    ...
    @NonNull
    @KeepForSdk
    public <L> ListenerHolder<L> registerListener(@NonNull L l3) {
        throw new UnsupportedOperationException();
    }
    ...
    public static final class Builder {
        ...
        public Builder addApi(@NonNull Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            ...
            List impliedScopes = ((Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes((Object) null);
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                yVar.put(api2, Boolean.valueOf(z5));
                ...
                Api.Client clientBuildClient = abstractClientBuilder.buildClient(this.zai, this.zan, clientSettingsZaa, obj, zatVar, zatVar);
                yVar2.put(api2.zab(), clientBuildClient);
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, yVar, this.zaq, this.zar, yVar2, this.zal, zabe.zad(yVar2.values(), true), arrayList);
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApi(@NonNull Api<O> api, @NonNull O o) {
            ...
            Preconditions.checkNotNull(o, "Null options are not permitted for this Api");
            this.zaj.put(api, o);
            List impliedScopes = ((Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes(o);
            this.zac.addAll(impliedScopes);
            this.zab.addAll(impliedScopes);
            return this;
        }
