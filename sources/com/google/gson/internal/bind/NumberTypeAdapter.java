...
public final class NumberTypeAdapter extends TypeAdapter<Number> {
    public static final TypeAdapterFactory n3 = y(ToNumberPolicy.LAZILY_PARSED_NUMBER);
    public final ToNumberStrategy y;
    ...
    public NumberTypeAdapter(ToNumberStrategy toNumberStrategy) {
        this.y = toNumberStrategy;
    }

    public static TypeAdapterFactory getFactory(ToNumberStrategy toNumberStrategy) {
        return toNumberStrategy == ToNumberPolicy.LAZILY_PARSED_NUMBER ? n3 : y(toNumberStrategy);
    }

    public static TypeAdapterFactory y(ToNumberStrategy toNumberStrategy) {
    ...
    public Number read(JsonReader jsonReader) throws IOException {
        ...
        int i = AnonymousClass2.y[jsonTokenPeek.ordinal()];
        if (i == 1) {
            jsonReader.nextNull();
            return null;
        }
