...
public final class TypeAdapters {
    ...
    public static /* synthetic */ class AnonymousClass42 {
        ...
        static {
            ...
            try {
                y[JsonToken.STRING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                y[JsonToken.BOOLEAN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                y[JsonToken.BEGIN_ARRAY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                y[JsonToken.BEGIN_OBJECT.ordinal()] = 5;
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public final Map<String, T> n3 = new HashMap();
        public final Map<T, String> zn = new HashMap();
        ...
        public EnumTypeAdapter(final Class<T> cls) {
            try {
                for (Field field : (Field[]) AccessController.doPrivileged(new PrivilegedAction<Field[]>() { // from class: com.google.gson.internal.bind.TypeAdapters.EnumTypeAdapter.1
                    ...
                    this.y.put(strName, (T) r4);
                    this.n3.put(string, (T) r4);
                    this.zn.put((T) r4, strName);
                }
        ...
        public T read(JsonReader jsonReader) throws IOException {
            ...
            T t3 = this.y.get(strNextString);
            return t3 == null ? this.n3.get(strNextString) : t3;
        }

        @Override // com.google.gson.TypeAdapter
        public void write(JsonWriter jsonWriter, T t3) throws IOException {
            jsonWriter.value(t3 == null ? null : this.zn.get(t3));
        }
    }
    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i5 = AnonymousClass42.y[jsonTokenPeek.ordinal()];
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as BigDecimal; at path " + jsonReader.getPreviousPath(), e4);
                }
            }
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as BigInteger; at path " + jsonReader.getPreviousPath(), e4);
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as UUID; at path " + jsonReader.getPreviousPath(), e4);
                }
            }
        ...
        TypeAdapter<Currency> typeAdapterNullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as Currency; at path " + jsonReader.getPreviousPath(), e4);
                }
            }
        ...
        TypeAdapter<Calendar> typeAdapter13 = new TypeAdapter<Calendar>() { // from class: com.google.gson.internal.bind.TypeAdapters.26
            ...
            public Calendar read(JsonReader jsonReader) throws IOException {
                ...
                return new GregorianCalendar(i, i5, i8, i10, i11, i12);
            }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
            public final JsonElement n3(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i = AnonymousClass42.y[jsonToken.ordinal()];
                if (i == 4) {
                    jsonReader.beginArray();
            ...
            public final JsonElement y(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i = AnonymousClass42.y[jsonToken.ordinal()];
                if (i == 1) {
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).ct();
                }
                JsonToken jsonTokenPeek = jsonReader.peek();
                JsonElement jsonElementN3 = n3(jsonReader, jsonTokenPeek);
                if (jsonElementN3 == null) {
                    return y(jsonReader, jsonTokenPeek);
                }
                ArrayDeque arrayDeque = new ArrayDeque();
                while (true) {
                    if (jsonReader.hasNext()) {
                        String strNextName = jsonElementN3 instanceof JsonObject ? jsonReader.nextName() : null;
                        JsonToken jsonTokenPeek2 = jsonReader.peek();
                        JsonElement jsonElementN32 = n3(jsonReader, jsonTokenPeek2);
                        boolean z = jsonElementN32 != null;
                        if (jsonElementN32 == null) {
                            jsonElementN32 = y(jsonReader, jsonTokenPeek2);
                        }
                        if (jsonElementN3 instanceof JsonArray) {
                            ((JsonArray) jsonElementN3).add(jsonElementN32);
                        } else {
                            ((JsonObject) jsonElementN3).add(strNextName, jsonElementN32);
                        }
                        if (z) {
                            arrayDeque.addLast(jsonElementN3);
                            jsonElementN3 = jsonElementN32;
                        }
                    } else {
                        if (jsonElementN3 instanceof JsonArray) {
                            jsonReader.endArray();
                        ...
                        if (arrayDeque.isEmpty()) {
                            return jsonElementN3;
                        }
                        jsonElementN3 = (JsonElement) arrayDeque.removeLast();
                    }
                }
            }
