...
public class ReflectionAccessFilterHelper {
    ...
    public static boolean isAnyPlatformType(Class<?> cls) {
        ...
        return y(name) || name.startsWith("kotlin.") || name.startsWith("kotlinx.") || name.startsWith("scala.");
    }

    public static boolean isJavaType(Class<?> cls) {
        return n3(cls.getName());
    }
    ...
    public static boolean y(String str) {
        return str.startsWith("android.") || str.startsWith("androidx.") || n3(str);
    }
}
