...
public final class C$Gson$Types {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.typeArguments) ^ this.rawType.hashCode()) ^ y(this.ownerType);
        }
    ...
    public static boolean equals(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            return zn(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType.getActualTypeArguments(), parameterizedType2.getActualTypeArguments());
        }
        if (type instanceof GenericArrayType) {
    ...
    */
    public static java.lang.reflect.Type fb(java.lang.reflect.Type r9, java.lang.Class<?> r10, java.lang.reflect.Type r11, java.util.Map<java.lang.reflect.TypeVariable<?>, java.lang.reflect.Type> r12) {
        /*
            Method dump skipped, instruction units count: 229
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.C$Gson$Types.fb(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Map):java.lang.reflect.Type");
    }
    ...
    public static Type getCollectionElementType(Type type, Class<?> cls) {
        Type typeV = v(type, cls, Collection.class);
        return typeV instanceof ParameterizedType ? ((ParameterizedType) typeV).getActualTypeArguments()[0] : Object.class;
    }
    ...
    public static Type[] getMapKeyAndValueTypes(Type type, Class<?> cls) {
        ...
        Type typeV = v(type, cls, Map.class);
        return typeV instanceof ParameterizedType ? ((ParameterizedType) typeV).getActualTypeArguments() : new Type[]{Object.class, Object.class};
    }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        return fb(type, cls, type2, new HashMap());
    }

    public static Type s(Type type, Class<?> cls, TypeVariable<?> typeVariable) {
        Class<?> clsN3 = n3(typeVariable);
        if (clsN3 == null) {
            return typeVariable;
        }
        Type typeGv = gv(type, cls, clsN3);
        if (!(typeGv instanceof ParameterizedType)) {
            return typeVariable;
        }
        return ((ParameterizedType) typeGv).getActualTypeArguments()[a(clsN3.getTypeParameters(), typeVariable)];
    }

    public static WildcardType subtypeOf(Type type) {
        return new WildcardTypeImpl(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, y);
    }
