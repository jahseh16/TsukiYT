    ...
    static {
        ...
        if (z) {
            DATE_DATE_TYPE = new DefaultDateTypeAdapter.DateType<java.sql.Date>(java.sql.Date.class) { // from class: com.google.gson.internal.sql.SqlTypesSupport.1
                ...
                public java.sql.Date n3(Date date) {
            ...
            TIMESTAMP_DATE_TYPE = new DefaultDateTypeAdapter.DateType<Timestamp>(Timestamp.class) { // from class: com.google.gson.internal.sql.SqlTypesSupport.2
                @Override // com.google.gson.internal.bind.DefaultDateTypeAdapter.DateType
                /* JADX INFO: renamed from: zn, reason: merged with bridge method [inline-methods] */
                public Timestamp n3(Date date) {
                    return new Timestamp(date.getTime());
                }
            };
            DATE_FACTORY = SqlDateTypeAdapter.n3;
            TIME_FACTORY = SqlTimeTypeAdapter.n3;
            TIMESTAMP_FACTORY = SqlTimestampTypeAdapter.n3;
            return;
        }
        DATE_DATE_TYPE = null;
