    ...
    LONG_OR_DOUBLE { // from class: com.google.gson.ToNumberPolicy.3
        ...
        public Number readNumber(JsonReader jsonReader) throws JsonParseException, IOException {
            ...
            if (strNextString.indexOf(46) >= 0) {
                return y(strNextString, jsonReader);
            }
            try {
        ...
        public final Number y(String str, JsonReader jsonReader) throws IOException {
            try {
                ...
                throw new JsonParseException("Cannot parse " + str + "; at path " + jsonReader.getPreviousPath(), e4);
            }
        }
    },
    BIG_DECIMAL { // from class: com.google.gson.ToNumberPolicy.4
        ...
        public BigDecimal readNumber(JsonReader jsonReader) throws IOException {
            ...
            try {
                ...
                throw new JsonParseException("Cannot parse " + strNextString + "; at path " + jsonReader.getPreviousPath(), e4);
            }
        }
    }
}
