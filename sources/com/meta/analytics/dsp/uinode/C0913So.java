...
public final class C0913So extends FrameLayout implements MD {
    ...
    public boolean A08;
    public boolean A09;
    public final C1165b3 A0A;
    public final C5T A0B;
    public final C03696c A0C;
    public final C1064Yn A0D;
    public final J2 A0E;
    public final JA A0F;
    public final ViewOnSystemUiVisibilityChangeListenerC0718Lb A0G;
    public final MC A0H;
    public final FullScreenAdToolbar A0I;
    public final InterfaceC0752Mj A0J;
    public final ArrayList<C0823Pc> A0K;
    ...
    */
    private com.meta.analytics.dsp.uinode.PQ A08(boolean r26, int r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0913So.A08(boolean, int):com.facebook.ads.redexgen.X.PQ");
    }
    ...
    public C0913So(C1064Yn c1064Yn, InterfaceC0752Mj interfaceC0752Mj, J2 j22, C1165b3 c1165b3, C03696c c03696c, MC mc) {
        super(c1064Yn);
        ...
        this.A00 = 0;
        this.A01 = 0;
        this.A0B = new C0916Sr(this);
        this.A0D = c1064Yn;
        this.A0J = interfaceC0752Mj;
        this.A0E = j22;
        this.A0A = c1165b3;
        this.A0C = c03696c;
        this.A0H = mc;
        this.A0F = new JA(c1165b3.A0v(0).A12(), j22);
        ...
        this.A0G = viewOnSystemUiVisibilityChangeListenerC0718Lb;
        viewOnSystemUiVisibilityChangeListenerC0718Lb.A05(EnumC0717La.A03);
        this.A05 = new Q7(c1064Yn, interfaceC0752Mj, c1165b3.A0T(), mc);
    ...
    */
    private int A00() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0913So.A00():int");
    }
    ...
    public static /* synthetic */ int A02(C0913So c0913So, int i) {
        int i5 = c0913So.A01 + i;
        c0913So.A01 = i5;
        return i5;
    }
    ...
    private FullScreenAdToolbar A05() {
        ...
        fullScreenAdToolbar.setToolbarListener(new C0914Sp(this));
    ...
    private void A0B() {
        ...
        if (i > 0 && !TextUtils.isEmpty(this.A0A.A0v(i - 1).A12())) {
            ...
            C0777Ni c0777Ni = new C0777Ni();
            PQ pq = this.A04;
            C0777Ni c0777NiA03 = c0777Ni.A03(pq != null ? pq.getAdViewabilityChecker() : null);
            PQ pq2 = this.A04;
            j22.A9X(strA12, c0777NiA03.A02(pq2 != null ? pq2.getTouchDataRecorder() : null).A05());
        }
    }
    ...
    private void A0C() {
        this.A0D.A0E().A4E();
        this.A07 = true;
        this.A03 = new C0789Nu(this.A0D, this.A0A, this.A0E, this.A0H, this.A0I.getToolbarHeight(), this.A02);
        C0823Pc c0823Pc = null;
        Iterator<C0823Pc> it = this.A0K.iterator();
        while (true) {
            ...
            if (A0M[1].charAt(22) == '6') {
                ...
                C0823Pc next = it.next();
                if (next.A00 == C0823Pc.A06) {
                    c0823Pc = next;
                    break;
                }
            } else {
        ...
        PQ pq = this.A04;
        if (pq != null) {
            AbstractC0731Lo.A0J(pq);
            this.A04.A0z();
            this.A04 = null;
        }
        AbstractC0731Lo.A0J(this.A03);
        AbstractC0731Lo.A0G(1102, this.A03);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0G(float f3) {
        float seenCurrentPosMS;
        float fA01 = A01(this.A00 - 1);
        float seenCurrentPosMS2 = (this.A0A.A14() ? 0 : this.A01) + f3;
        if (fA01 > 0.0f) {
    ...
    private void A0I(ViewGroup viewGroup, C0823Pc c0823Pc) {
        if (c0823Pc.A00 == C0823Pc.A06 && c0823Pc.A03 != null) {
            OA.A00(this.A0D, viewGroup, c0823Pc.A03);
        } else {
            AbstractC0731Lo.A0M(viewGroup, c0823Pc.A01);
        }
        this.A0I.setFullscreen(c0823Pc.A05);
        this.A0I.A06(c0823Pc.A02, c0823Pc.A04);
    }

    private void A0J(AbstractC1167b5 abstractC1167b5) {
        if (A0V(abstractC1167b5)) {
            int i = this.A02;
            if (A0M[2].charAt(7) != '3') {
                throw new RuntimeException();
            }
            ...
            if (i == 2) {
                this.A0I.setOnlyPageDetails(abstractC1167b5.A10());
                return;
            }
        }
        this.A0I.setOnlyPageDetails(null);
    ...
    public void A0Q(boolean z) {
        boolean z5 = (!A0T() || A0S() || A0U()) ? false : true;
        boolean zA0S = A0S();
        if (A0M[1].charAt(22) != '6') {
            throw new RuntimeException();
        }
    ...
    public static boolean A0V(AbstractC1167b5 abstractC1167b5) {
    ...
    private void setupToolbarForAd(PQ pq) {
        ...
        this.A06 = true;
        AbstractC1167b5 abstractC1167b5A0v = this.A0A.A0v(this.A00);
        this.A0I.A09(this.A0D, abstractC1167b5A0v.A0r());
        this.A0I.A08(abstractC1167b5A0v.A10(), abstractC1167b5A0v.A12(), A01(this.A00));
        C0823Pc fullScreenAdStyle = pq.getFullScreenAdStyle();
