...
public abstract class AbstractC0641Hv {
    ...
    */
    public static com.meta.analytics.dsp.uinode.C0640Hu A06(byte[] r19, int r20, int r21) {
        /*
            Method dump skipped, instruction units count: 521
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0641Hv.A06(byte[], int, int):com.facebook.ads.redexgen.X.Hu");
    }

    public static String A07(int i, int i5, int i8) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A00, i, i + i5);
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            bArrCopyOfRange[i10] = (byte) ((bArrCopyOfRange[i10] ^ i8) ^ 29);
        }
    ...
    public static int A02(byte[] bArr, int i) {
        ...
        synchronized (A05) {
            ...
            for (int unescapedLength = 0; unescapedLength < i8; unescapedLength++) {
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L19:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0641Hv.A03(byte[], int, int):int");
    }
    ...
    */
    public static int A04(byte[] r8, int r9, int r10, boolean[] r11) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0641Hv.A04(byte[], int, int, boolean[]):int");
    }

    public static C0639Ht A05(byte[] bArr, int i, int i5) {
        I0 i02 = new I0(bArr, i, i5);
        i02.A07(8);
        int iA04 = i02.A04();
        int seqParameterSetId = i02.A04();
        i02.A06();
        return new C0639Ht(iA04, seqParameterSetId, i02.A0A());
    }

    public static void A09(I0 i02, int i) {
        int i5 = 8;
        int deltaScale = 8;
        for (int i8 = 0; i8 < i; i8++) {
            if (deltaScale != 0) {
                int lastScale = i02.A03();
                deltaScale = ((lastScale + i5) + NotificationCompat.FLAG_LOCAL_ONLY) % NotificationCompat.FLAG_LOCAL_ONLY;
            }
            if (deltaScale != 0) {
                i5 = deltaScale;
            }
    ...
    */
    public static void A0A(java.nio.ByteBuffer r8) {
        ...
        L6:
            ...
            if (r6 != r0) goto L6a
            r7 = 1
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.AbstractC0641Hv.A02
            r0 = 4
            r1 = r1[r0]
            r0 = 6
            ...
            throw r0
        L28:
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.AbstractC0641Hv.A02
        ...
        L81:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0641Hv.A0A(java.nio.ByteBuffer):void");
    }
    ...
    public static boolean A0C(String str, byte b4) {
        if (A07(46, 9, 117).equals(str) && (b4 & 31) == 6) {
            return true;
        }
