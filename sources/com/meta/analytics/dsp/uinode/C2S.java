...
public final class C2S {
    ...
    private final void A07() {
        C1113aD c1113aDA5S = this.A00.A5S();
        c1113aDA5S.A00(A02(518, 22, 120), 0L);
        c1113aDA5S.A02();
    }
    ...
    public final void A0N(String str) {
        ...
        if (mapA05 != null) {
            ...
            for (String str2 : strArr) {
                c1113aDA5S.A01(str2, mapA05.get(str2));
            }
            c1113aDA5S.A00(A02(518, 22, 120), System.currentTimeMillis());
            c1113aDA5S.A02();
        }
    }

    public final boolean A0O(Context context, boolean z) {
        return (z || C0653Ih.A29(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
