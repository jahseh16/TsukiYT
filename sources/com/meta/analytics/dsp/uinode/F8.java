...
public final class F8 {
     ...
     */
    public final synchronized int A09(C04479p c04479p, C1042Xr c1042Xr, boolean z, boolean z5, Format format, F7 f7) {
        if (!A0I()) {
            if (z5) {
                c1042Xr.A02(4);
                return -4;
        ...
        if (z || this.A0G[iA00] != format) {
            c04479p.A00 = this.A0G[iA00];
            return -5;
        }
        if (c1042Xr.A0B()) {
            return -3;
        }
        c1042Xr.A00 = this.A0F[iA00];
        c1042Xr.A02(this.A0B[iA00]);
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized void A0G(long j, int i, long j4, int i5, C3 c3) {
        if (this.A0A) {
            if ((i & 1) == 0) {
                return;
            } else {
    ...
    */
    ...
    private long A02(int i) {
        ...
        if (i5 == 0) {
            ...
            int i13 = i10 - 1;
            return this.A0E[i13] + ((long) this.A0C[i13]);
        }
    ...
    public final synchronized int A08(long j, boolean z, boolean z5) {
        int iA00 = A00(this.A03);
        if (!A0I() || j < this.A0F[iA00] || (j > this.A07 && !z5)) {
            return -1;
        }
        int i = this.A02;
    ...
    */
    public final long A0C(int r6) {
        /*
            ...
            r0 = 1
        L10:
            com.meta.analytics.dsp.uinode.AbstractC0620Ha.A03(r0)
            int r0 = r5.A02
            int r0 = r0 - r2
            r5.A02 = r0
            long r2 = r5.A06
    ...
    public final synchronized long A0D(long j, boolean z, boolean z5) {
        int i;
        int i5 = this.A02;
        if (i5 != 0) {
            long[] jArr = this.A0F;
            ...
            if (j >= jArr[searchLength]) {
                ...
                int iA01 = A01(searchLength, i5, j, z);
                if (iA01 == -1) {
                    return -1L;
                }
                return A02(iA01);
