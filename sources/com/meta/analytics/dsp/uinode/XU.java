...
public final class XU implements InterfaceC0502Bs {
    ...
    public static final InterfaceC0505Bv A0G;
    ...
    public long A02;
    public long A03;
    public InterfaceC0504Bu A04;
    public C4 A05;
    public XV A06;
    public Metadata A07;
    public final int A08;
    public final long A09;
    public final C0506Bw A0A;
    public final Bx A0B;
    public final By A0C;
    public final C0645Hz A0D;
    ...
    public XU(int i, long j) {
        this.A08 = i;
        this.A09 = j;
        this.A0D = new C0645Hz(10);
        this.A0C = new By();
        this.A0A = new C0506Bw();
        this.A02 = -9223372036854775807L;
        this.A0B = new Bx();
    }

    private int A00(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        if (this.A00 == 0) {
            interfaceC0503Bt.AFM();
            if (!interfaceC0503Bt.ADw(this.A0D.A00, 0, 4, true)) {
                return -1;
            }
            this.A0D.A0Y(0);
        ...
        int iAFQ = this.A05.AFQ(interfaceC0503Bt, this.A00, true);
        if (iAFQ == -1) {
            return -1;
        }
        ...
        this.A05.AFS(this.A02 + ((this.A03 * 1000000) / ((long) this.A0C.A03)), 1, this.A0C.A02, 0, null);
    ...
    */
    public static int A01(com.meta.analytics.dsp.uinode.C0645Hz r4, int r5) {
        /*
            int r1 = r4.A07()
            int r0 = r5 + 4
            if (r1 < r0) goto L3e
    ...
    private EE A02(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        interfaceC0503Bt.ADv(this.A0D.A00, 0, 4);
        this.A0D.A0Y(0);
        By.A04(this.A0D.A08(), this.A0C);
        return new EE(interfaceC0503Bt.A7I(), interfaceC0503Bt.A7i(), this.A0C);
    }

    private XV A03(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        C0645Hz c0645Hz = new C0645Hz(this.A0C.A02);
        interfaceC0503Bt.ADv(c0645Hz.A00, 0, this.A0C.A02);
        int i = 21;
        if ((this.A0C.A05 & 1) != 0) {
            int i5 = this.A0C.A01;
            if (A0F[5].length() != 24) {
        ...
        int xingBase = A01(c0645Hz, i);
        if (xingBase == A0J || xingBase == A0H) {
            E4 e4A01 = E4.A01(interfaceC0503Bt.A7I(), interfaceC0503Bt.A7i(), this.A0C, c0645Hz);
            if (e4A01 != null && !this.A0A.A03()) {
                interfaceC0503Bt.AFM();
                interfaceC0503Bt.A3W(i + 141);
                C0645Hz frame = this.A0D;
                interfaceC0503Bt.ADv(frame.A00, 0, 3);
                C0645Hz frame2 = this.A0D;
                frame2.A0Y(0);
                C0506Bw c0506Bw = this.A0A;
                C0645Hz frame3 = this.A0D;
                c0506Bw.A04(frame3.A0G());
            }
            interfaceC0503Bt.AGP(this.A0C.A02);
            if (e4A01 != null && !e4A01.A9I() && xingBase == A0H) {
                return A02(interfaceC0503Bt);
            }
            return e4A01;
        }
        if (xingBase == A0I) {
            EC ecA00 = EC.A00(interfaceC0503Bt.A7I(), interfaceC0503Bt.A7i(), this.A0C, c0645Hz);
            interfaceC0503Bt.AGP(this.A0C.A02);
            return ecA00;
        }
        interfaceC0503Bt.AFM();
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean A07(com.meta.analytics.dsp.uinode.InterfaceC0503Bt r14, boolean r15) throws java.lang.InterruptedException, java.io.IOException {
        /*
    ...
    public final void A8o(InterfaceC0504Bu interfaceC0504Bu) {
        this.A04 = interfaceC0504Bu;
        this.A05 = interfaceC0504Bu.AGi(0, 1);
        this.A04.A5Y();
    }
    ...
    public final int AEH(InterfaceC0503Bt interfaceC0503Bt, C0507Bz c0507Bz) throws InterruptedException, IOException {
        if (this.A01 == 0) {
            try {
                A07(interfaceC0503Bt, false);
            } catch (EOFException unused) {
                return -1;
            }
        }
        if (this.A06 == null) {
            XV xvA03 = A03(interfaceC0503Bt);
            this.A06 = xvA03;
            if (xvA03 == null || (!xvA03.A9I() && (this.A08 & 1) != 0)) {
                this.A06 = A02(interfaceC0503Bt);
            }
    ...
    public final boolean AGR(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        return A07(interfaceC0503Bt, true);
    }
}
