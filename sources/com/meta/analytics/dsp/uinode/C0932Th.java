...
public final class C0932Th extends AbstractC0783No {
    ...
    private void A04() {
        ...
        AbstractC0731Lo.A0K(this.A05);
        this.A05.setLayoutParams(AbstractC0783No.A08);
        this.A05.setTextColor(this.A0A ? this.A07.A06(true) : -1);
        AbstractC0731Lo.A0X(this.A05, true, 18);
        ...
        AbstractC0731Lo.A0X(this.A04, false, 14);
    ...
    public C0932Th(C1064Yn c1064Yn, int i, boolean z, C1P c1p, boolean z5, String str, J2 j22, MC mc, RE re, C0723Lg c0723Lg, C1U c1u) {
        super(c1064Yn, i, c1p, z5, str, j22, mc, re, c0723Lg, c1u);
        this.A0B = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0G = c1064Yn;
        ...
        this.A09 = new O5(c1064Yn, A0R, 5, A0Q, -1);
        ...
        this.A07 = c1p;
        this.A0H = C0653Ih.A0y(c1064Yn);
        AbstractC0731Lo.A0R(this, c1064Yn);
        this.A0A = C0653Ih.A24(c1064Yn);
        A06();
    }
    ...
    private void A03() {
        ...
        AbstractC0731Lo.A0X(this.A03, false, 16);
        if (this.A0H) {
    ...
    private void A05() {
        ...
        AbstractC0731Lo.A0X(this.A0F, false, 12);
    ...
    private void A06() {
        removeAllViews();
        super.A02.setLayoutParams(AbstractC0783No.A08);
        A04();
        A03();
        A02();
        A05();
        A07();
        AbstractC0731Lo.A0J(super.A02);
        AbstractC0731Lo.A0J(super.A04);
    ...
    private void A07() {
        ...
        if (TextUtils.isEmpty(this.A08.A04())) {
            AbstractC0731Lo.A0H(super.A04);
        }
        if (TextUtils.isEmpty(this.A06.A04())) {
            AbstractC0731Lo.A0H(this.A0F);
        }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0783No
    ...
    public void setInfo(C1N c1n, C1Q c1q, String str, String str2, InterfaceC0785Nq interfaceC0785Nq) {
        super.setInfo(c1n, c1q, str, str2, interfaceC0785Nq);
        this.A06 = c1n;
        this.A08 = c1q;
        A07();
    }
