...
public final class C0550Ee extends AbstractC1077Za {
    ...
    public final void A0J() {
        ...
        boolean z5 = !this.A09.isEmpty();
        boolean z7 = !this.A08.isEmpty();
        boolean z8 = !this.A07.isEmpty();
        if (z || z5 || z8 || z7) {
            ...
            if (z8) {
                ...
                Runnable runnable3 = new Runnable() { // from class: com.facebook.ads.redexgen.X.4F
                    @Override // java.lang.Runnable
                    public final void run() {
                        for (AnonymousClass56 holder : arrayList3) {
                            this.A00.A0X(holder);
                        }
                        arrayList3.clear();
                ...
                C3T.A0E(arrayList3.get(0).A0H, runnable3, Math.max(z5 ? A06() : 0L, z7 ? A05() : 0L) + (z ? A07() : 0L));
            }
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.meta.analytics.dsp.uinode.AbstractC1077Za
    public final boolean A0T(AnonymousClass56 anonymousClass56, int i, int i5, int i8, int i10) {
        ...
        this.A09.add(new C4M(anonymousClass56, translationX, translationY, i8, i10));
        return true;
    }
    ...
    */
    public final void A0K(com.meta.analytics.dsp.uinode.AnonymousClass56 r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0550Ee.A0K(com.facebook.ads.redexgen.X.56):void");
    }
    ...
    */
    public final boolean A0L() {
        /*
            ...
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C0550Ee.A0C
            r0 = 2
            r1 = r2[r0]
            r0 = 5
            r2 = r2[r0]
        ...
        L73:
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C0550Ee.A0C
            r0 = 7
            r1 = r1[r0]
            r0 = 30
            char r1 = r1.charAt(r0)
        ...
        Lba:
            ...
            goto Lb9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0550Ee.A0L():boolean");
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC1077Za
    public final boolean A0U(AnonymousClass56 anonymousClass56, AnonymousClass56 anonymousClass562, int i, int i5, int i8, int i10) {
        if (anonymousClass56 == anonymousClass562) {
            return A0T(anonymousClass56, i, i5, i8, i10);
        }
        ...
        A04(anonymousClass56);
        float prevTranslationX = i8 - i;
        int deltaY = (int) (prevTranslationX - translationX);
        float prevTranslationX2 = i10 - i5;
        ...
        this.A08.add(new C4L(anonymousClass56, anonymousClass562, i, i5, i8, i10));
        return true;
    }
    ...
    public final void A0Y(final AnonymousClass56 anonymousClass56, int i, int i5, int i8, int i10) {
        final View view = anonymousClass56.A0H;
        final int i11 = i8 - i;
        final int i12 = i10 - i5;
        if (i11 != 0) {
