    ...
    */
    ...
    public final int A05(int i) {
        ...
        while (true) {
            ...
            byte[] bArr = this.A03;
            int i11 = this.A02;
            int returnValue2 = bArr[i11];
            i8 |= (returnValue2 & 255) << i10;
            int returnValue3 = i11 + 1;
            if (!A02(returnValue3)) {
                i = 1;
            }
            this.A02 = i11 + i;
        ...
        byte[] bArr2 = this.A03;
        int i12 = this.A02;
        int returnValue4 = bArr2[i12];
        int i13 = returnValue4 & 255;
        String[] strArr = A04;
        String str = strArr[5];
        ...
        int i14 = i8 | (i13 >> returnValue6);
        int returnValue7 = (-1) >>> (32 - i);
        int i15 = i14 & returnValue7;
        if (i5 == 8) {
            this.A00 = 0;
            int returnValue8 = i12 + 1;
            this.A02 = i12 + (A02(returnValue8) ? 2 : 1);
        }
        A01();
        return i15;
    }
    ...
    public final void A07(int i) {
        ...
        this.A02 = numBytes;
        int i8 = this.A00 + (i - (oldByteOffset * 8));
        this.A00 = i8;
        if (i8 > 7) {
            int i10 = numBytes + 1;
            String[] strArr = A04;
