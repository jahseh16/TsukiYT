...
public abstract class C6E {
    ...
    */
    public static com.meta.analytics.dsp.uinode.C6C A01(com.meta.analytics.dsp.uinode.C03927f r5, com.meta.analytics.dsp.uinode.C6C r6) {
        /*
            if (r6 == 0) goto Lc
    ...
    public static C6C A02(C03927f c03927f, C6C c6c, C6D c6d) {
        C6F c6fA00 = null;
        try {
            if (AbstractC0652Ig.A06(c03927f) && (c6c == null || TextUtils.isEmpty(c6c.A03()))) {
                c6fA00 = C6G.A00(c03927f.getContentResolver());
            }
        } catch (Throwable th) {
            c03927f.A07().A9a(A04(12, 7, 6), C8A.A1S, new C8B(th));
        }
    ...
    public static void A07(C03927f c03927f) {
        long jA01;
        C6C c6cA02;
        try {
            C6D c6d = new C6D(c03927f);
            A06(c6d);
            if (A08()) {
                return;
            }
            ...
            if (jA01 > 0) {
                ...
                if (cacheTS - jA01 < AbstractC0652Ig.A00(c03927f)) {
                    return;
                }
            }
            if (AbstractC0652Ig.A07(c03927f)) {
                c6cA02 = A01(c03927f, A02(c03927f, null, c6d));
            } else {
                c6cA02 = A02(c03927f, A01(c03927f, null), c6d);
            }
            ...
            c03927f.A07().A9a(A04(12, 7, 6), C8A.A1R, new C8B(t3));
        }
    }
