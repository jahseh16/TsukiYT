...
public abstract class Q2 {
    ...
    public static Map<String, String> A01(C03927f c03927f, String str, String str2) {
        HashMap map = new HashMap();
        C8K c8k = new C8K(c03927f);
        int i = c03927f.getResources().getDisplayMetrics().widthPixels;
        int i5 = c03927f.getResources().getDisplayMetrics().heightPixels;
        map.put(A00(105, 10, 61), c03927f.A08().A02());
        ...
        map.put(A00(69, 13, 61), String.valueOf((int) (i5 / LD.A02)));
        map.put(A00(32, 2, 124), c03927f.A04().A8H());
