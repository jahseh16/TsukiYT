...
public final class C0478Au {
    ...
    public boolean A0L;
    public boolean A0M;
    public final InterfaceC0476As A0N;
    ...
    public C0478Au(InterfaceC0476As interfaceC0476As) {
        this.A0N = (InterfaceC0476As) AbstractC0620Ha.A01(interfaceC0476As);
        if (IF.A02 >= 18) {
            try {
    ...
    */
    private long A00() {
        ...
        L33:
            ...
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C0478Au.A0Q
            r0 = 7
            r1 = r2[r0]
            r0 = 3
            r2 = r2[r0]
        ...
        L6d:
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C0478Au.A0Q
            r0 = 1
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 9
        ...
        Lbe:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0478Au.A00():long");
    }
    ...
    private void A04() {
        ...
        if (jNanoTime - playbackPositionUs >= 30000) {
            ...
            while (true) {
                ...
                long playbackPositionUs3 = i10;
                this.A0E += this.A0O[i8] / playbackPositionUs3;
                i8++;
            }
        }
        if (this.A0M) {
    ...
    private void A07(long j) {
        if (this.A0L) {
            ...
            if (method != null && j - this.A08 >= 500000) {
                try {
                    long jIntValue = (((long) ((Integer) method.invoke(this.A0H, null)).intValue()) * 1000) - this.A05;
                    this.A0B = jIntValue;
    ...
    public final void A0G(AudioTrack audioTrack, int i, int i5, int i8) {
        this.A0H = audioTrack;
        this.A02 = i5;
        this.A00 = i8;
        this.A0I = new C0475Ar(audioTrack);
        this.A03 = audioTrack.getSampleRate();
        this.A0M = A0A(i);
        boolean zA0c = IF.A0c(i);
        this.A0L = zA0c;
        this.A05 = zA0c ? A02(i8 / i5) : -9223372036854775807L;
        this.A0A = 0L;
        this.A0D = 0L;
        this.A0C = 0L;
        this.A0K = false;
    ...
    public final boolean A0L(long j) {
        InterfaceC0476As interfaceC0476As;
        ...
        boolean zA0J = A0J(j);
        this.A0K = zA0J;
        if (hadData && !zA0J && playState != 1 && (interfaceC0476As = this.A0N) != null) {
            interfaceC0476As.ADQ(this.A00, C9W.A01(this.A05));
        }
        return true;
    }
}
