...
public final class VT implements J1 {
    ...
    public VT(C1063Ym c1063Ym, J0 j02) {
        this.A07 = j02;
        this.A06 = c1063Ym;
        this.A04 = (ConnectivityManager) c1063Ym.getSystemService(A03(293, 12, 10));
        this.A08 = C0875Rc.A01(c1063Ym);
        this.A03 = Ij.A0K(c1063Ym);
        this.A02 = Ij.A0J(c1063Ym);
    }
    ...
    public final void A0B() {
        try {
            ...
            if (!TextUtils.isEmpty(strA69) && rjADz != null) {
                if (rjADz.A83() != 200) {
                    ...
                    if (A0E[4].length() != 29) {
                        ...
                        if (iA83 == 413 && C0653Ih.A22(this.A06)) {
                            this.A07.ACo();
                            A05();
                            return;
                        } else {
            ...
            if (C0653Ih.A1t(this.A06) && jSONObjectA4a.has(strA03)) {
                this.A07.ABI(jSONObjectA4a.getJSONArray(strA03));
            }
            A06();
        } catch (Exception e4) {
