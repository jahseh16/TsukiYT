...
public final class C1G implements Serializable {
    ...
    public static String A01(int i, int i5, int i8) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            byte b4 = (byte) ((bArrCopyOfRange[i10] ^ i8) ^ 58);
            String[] strArr = A0B;
    ...
    public static C1G A00(JSONObject jSONObject) {
        ...
        C1I c1iA0I = new C1I().A0J(jSONObject.optString(A01(496, 9, 21))).A0H(jSONObject.optLong(A01(472, 24, 61), -1L)).A0D(iOptInt).A0C(jSONObject.optInt(A01(274, 18, 10), Reader.READ_DONE)).A0I(C02411c.A01(jSONObject));
