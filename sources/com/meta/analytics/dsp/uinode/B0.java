...
public final class B0 extends FrameLayout implements TD {
    ...
    public B0(C1064Yn c1064Yn, J2 j22, P0 p0, AbstractC1167b5 abstractC1167b5, String str, int i, C0723Lg c0723Lg) {
        super(c1064Yn);
        this.A03 = c1064Yn;
        this.A04 = j22;
        ...
        this.A06 = p0;
        this.A01 = i;
        PB preloadedDynamicWebViewController = PC.A02(abstractC1167b5.A0S());
        if (preloadedDynamicWebViewController != null) {
            this.A07 = preloadedDynamicWebViewController;
            this.A09 = true;
        } else {
            PB preloadedDynamicWebViewController2 = new PB(c1064Yn, abstractC1167b5, j22, i);
            this.A07 = preloadedDynamicWebViewController2;
            PC.A03(abstractC1167b5, preloadedDynamicWebViewController2);
            this.A09 = false;
        }
        if (c0723Lg != null) {
            this.A05 = c0723Lg;
            this.A07.A0Z(c0723Lg);
        } else {
        ...
        if (C0653Ih.A1W(c1064Yn)) {
            c1064Yn.A0A().AGx(this.A07.A0O(), abstractC1167b5.A12(), false, false, true);
        }
        A04();
    }
    ...
    private void A05(Intent intent, AbstractC1167b5 abstractC1167b5) {
        intent.putExtra(A01(157, 8, 17), KB.A07);
        intent.putExtra(A01(130, 18, 40), abstractC1167b5);
        intent.addFlags(268435456);
    }

    private final void A06(AbstractC1167b5 abstractC1167b5) {
        AdActivityIntent adActivityIntentA04 = C0702Kj.A04(this.A03);
        A05(adActivityIntentA04, abstractC1167b5);
        try {
            C0702Kj.A0A(this.A03, adActivityIntentA04);
        } catch (Exception e4) {
    ...
    private void A07(String str) {
        ...
        C0786Nr c0786Nr = new C0786Nr(this.A03, this.A08, this.A00, this.A05, this.A04, this.A02.A0y());
        HashMap map = new HashMap();
        map.put(A01(118, 12, 95), A01(148, 9, 37));
        c0786Nr.A07(this.A02.A12(), str, map);
    }

    public final void A08() {
        AbstractC0731Lo.A0J(this.A07.A0O());
