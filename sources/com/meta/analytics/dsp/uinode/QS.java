...
public class QS {
     ...
     */
    public QS(C1064Yn c1064Yn, J2 j22, QE qe, List<C2P> list, String str, boolean z, Bundle bundle, Map<String, String> map, QK qk2) {
        this.A0B = new Object();
        this.A01 = 0;
        this.A00 = 0;
        this.A03 = null;
        ...
        if (bundle != null) {
            this.A05 = new C1115aF(list, bundle.getBundle(A0F(6, 16, 29)), qk2);
            this.A01 = bundle.getInt(A0F(57, 18, 2));
            this.A00 = bundle.getInt(A0F(39, 18, 44));
        } else {
            this.A05 = new C1115aF(list, qk2);
        }
    ...
    public QS(C1064Yn c1064Yn, J2 j22, QE qe, List<C2P> list, String str, boolean z, Bundle bundle, QK qk2) {
        this(c1064Yn, j22, qe, list, str, z, bundle, null, qk2);
    }

    public QS(C1064Yn c1064Yn, J2 j22, QE qe, List<C2P> list, String str, boolean z, QK qk2) {
        this(c1064Yn, j22, qe, list, str, z, null, qk2);
    }

    private final float A0E() {
        return AbstractC0728Ll.A00(this.A06) * this.A08.getVolume();
    }

    private Map<String, String> A0H(int i) {
        HashMap<String, String> map = new HashMap<>();
        AbstractC0728Ll.A03(map, this.A08.getVideoStartReason() == QM.A02, !this.A08.A95());
        A0T(map);
        A0S(map);
        A0V(map, i);
        A0U(map);
    ...
    private Map<String, String> A0J(QG qg2, int i) {
        ...
        mapA0H.put(A0F(0, 6, 122), String.valueOf(qg2.A00));
        return mapA0H;
    }
    ...
    private final void A0O(int i, boolean z, boolean z5) {
        int i5;
        if (i <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || i < (i5 = this.A01)) {
            return;
        }
        if (i > i5) {
            this.A05.A06((i - i5) / 1000.0f, A0E());
            this.A01 = i;
            if (z5 || i - this.A00 >= 5000) {
