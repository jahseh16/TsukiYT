...
public final class X1 implements InterfaceC0528Cy {
    ...
    public X1(D7 d7, boolean z, boolean z5) {
        this.A09 = d7;
        this.A0B = z;
        this.A0C = z5;
    }

    private void A02(long j, int i, int i5, long j4) {
        if (!this.A05 || this.A03.A07()) {
            ...
            if (!this.A05) {
                if (this.A08.A03() && this.A06.A03()) {
                    ...
                    C0640Hu spsData = AbstractC0641Hv.A06(this.A08.A01, 3, this.A08.A00);
                    C0639Ht c0639HtA05 = AbstractC0641Hv.A05(this.A06.A01, 3, this.A06.A00);
                    ...
                    this.A03.A04(c0639HtA05);
                    this.A08.A00();
                    this.A06.A00();
                }
            } else if (this.A08.A03()) {
                this.A03.A05(AbstractC0641Hv.A06(this.A08.A01, 3, this.A08.A00));
                this.A08.A00();
            } else if (this.A06.A03()) {
                this.A03.A04(AbstractC0641Hv.A05(this.A06.A01, 3, this.A06.A00));
                this.A06.A00();
            }
        }
        if (this.A07.A04(i5)) {
            ...
            int unescapedLength = AbstractC0641Hv.A02(d4.A01, this.A07.A00);
    ...
    private void A03(long j, int i, long j4) {
        if (!this.A05 || this.A03.A07()) {
            this.A08.A01(i);
            this.A06.A01(i);
        }
    ...
    public final void A4R(C0645Hz c0645Hz) {
        ...
        C4 c4 = this.A02;
        int offset3 = c0645Hz.A04();
        c4.AFR(c0645Hz, offset3);
        while (true) {
            int iA04 = AbstractC0641Hv.A04(bArr, iA06, iA07, this.A0D);
            if (iA04 == iA07) {
                A04(bArr, iA06, iA07);
                return;
            }
            int lengthToNalUnit = AbstractC0641Hv.A01(bArr, iA04);
            int i = iA04 - iA06;
            String[] strArr = A0F;
    ...
    public final void A4p(InterfaceC0504Bu interfaceC0504Bu, DC dc) {
        ...
        this.A09.A03(interfaceC0504Bu, dc);
    }
