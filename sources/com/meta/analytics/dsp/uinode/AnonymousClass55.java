...
public class AnonymousClass55 implements Runnable {
    ...
    public int A02;
    public int A03;
    public final /* synthetic */ C0547Eb A06;
    public Interpolator A00 = C0547Eb.A1A;
    ...
    public AnonymousClass55(C0547Eb c0547Eb) {
        this.A06 = c0547Eb;
        this.A01 = new OverScroller(c0547Eb.getContext(), C0547Eb.A1A);
    }
    ...
    private int A01(int i, int i5, int i8, int i10) {
        int absDx;
        int containerSize = Math.abs(i);
        int delta = Math.abs(i5);
        int duration = containerSize > delta ? 1 : 0;
        int halfContainerSize = (int) Math.sqrt((i8 * i8) + (i10 * i10));
        int absDx2 = (int) Math.sqrt((i * i) + (i5 * i5));
        C0547Eb c0547Eb = this.A06;
        int width = duration != 0 ? c0547Eb.getWidth() : c0547Eb.getHeight();
    ...
    private final void A06(int i, int i5, int i8, int i10) {
        A0B(i, i5, A01(i, i5, i8, i10));
    }
    ...
    public final void A09(int i, int i5) {
        ...
        this.A03 = 0;
        this.A02 = 0;
        this.A01.fling(0, 0, i, i5, Integer.MIN_VALUE, Reader.READ_DONE, Integer.MIN_VALUE, Reader.READ_DONE);
        A07();
    }
    ...
    public final void A0B(int i, int i5, int i8) {
        A0C(i, i5, i8, C0547Eb.A1A);
    }

    public final void A0C(int i, int i5, int i8, Interpolator interpolator) {
        ...
        this.A03 = 0;
        this.A02 = 0;
        this.A01.startScroll(0, 0, i, i5, i8);
    ...
    public final void A0D(int i, int i5, Interpolator interpolator) {
        int iA01 = A01(i, i5, 0, 0);
        if (interpolator == null) {
            interpolator = C0547Eb.A1A;
        }
        A0C(i, i5, iA01, interpolator);
    }
