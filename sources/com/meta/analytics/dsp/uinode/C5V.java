...
public final class C5V implements AudienceNetworkActivityApi, Repairable {
    ...
    public C5V(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        C1064Yn c1064YnA02 = C03435c.A02(audienceNetworkActivity);
        this.A0N = c1064YnA02;
        c1064YnA02.A0L(this);
    }
    ...
    private void A08() {
        String str = this.A0E;
        if (str != null) {
            C0844Px c0844PxA01 = AbstractC0843Pw.A01(this.A0N, str);
            this.A0B = c0844PxA01;
            if (c0844PxA01 != null) {
    ...
    private void A09() {
        if ((this.A0N.A0F().A01() || C0653Ih.A1c(this.A0N)) && Build.VERSION.SDK_INT >= 24) {
    ...
    private void A0A() {
        boolean z = !this.A0J || C0653Ih.A1a(this.A0N);
    ...
    private void A0C(Intent intent) {
        if (C0653Ih.A11(this.A0L)) {
            ...
            if (kb != kb2 && Build.VERSION.SDK_INT >= 18) {
                ...
                AbstractC0731Lo.A0M(textView, Color.argb(160, 0, 0, 0));
    ...
    private void A0D(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            Bundle bundleA02 = C0702Kj.A02(bundle, DynamicLoaderImpl.class.getClassLoader());
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0H(String str, C02391a c02391a) {
        if (this.A08 == null) {
            return;
        }
        if (this.A09 == null) {
            C1064Yn c1064Yn = this.A0N;
            this.A09 = AbstractC0758Mp.A02(c1064Yn, c1064Yn.A09(), str, c02391a, this.A08, new ZW(this, null));
            this.A09.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        }
        AbstractC0731Lo.A0J(this.A09);
        AbstractC0731Lo.A0T(this.A06);
    ...
    public final void A0P(String str, C04248q c04248q) {
        Intent intent = new Intent(str + A06(0, 1, 84) + this.A0C);
        if (c04248q != null) {
            intent.putExtra(A06(402, 5, 105), c04248q);
        }
        C02792o.A00(this.A0L).A07(intent);
    }
    ...
    public final void finish(int i) {
        ...
        if (C0653Ih.A1U(this.A0N) && !this.A0H && !this.A0G) {
            this.A0N.A0E().AAX();
            A0L();
        }
        if (A0I() && !this.A0F) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        Intent intent = C0702Kj.A01(this.A0L.getIntent(), DynamicLoaderImpl.class.getClassLoader());
        this.A05 = intent;
        C1064Yn c1064YnA03 = C0702Kj.A03(intent);
        if (c1064YnA03 != null) {
            C1064Yn startAdContext = this.A0N;
            startAdContext.A0J(c1064YnA03.A0E());
            C1064Yn startAdContext2 = this.A0N;
            startAdContext2.A0C(c1064YnA03.A0B());
            C1064Yn startAdContext3 = this.A0N;
            startAdContext3.A0M(c1064YnA03.A0G());
        }
        A0D(this.A05, bundle);
        ...
        if (C0653Ih.A2N(this.A0N) && this.A07 == KB.A03 && z) {
            this.A0L.getWindow().setFlags(NotificationCompat.FLAG_GROUP_SUMMARY, NotificationCompat.FLAG_GROUP_SUMMARY);
        } else {
            this.A0L.requestWindowFeature(1);
            this.A0L.getWindow().setFlags(UserMetadata.MAX_ATTRIBUTE_SIZE, UserMetadata.MAX_ATTRIBUTE_SIZE);
        }
        RelativeLayout relativeLayout = new RelativeLayout(this.A0L);
        this.A06 = relativeLayout;
        AbstractC0731Lo.A0M(relativeLayout, 0);
        ...
        if (C0653Ih.A1x(this.A0L) && this.A0L.getWindow() != null) {
    ...
    */
    public final void onDestroy() {
        ...
        L66:
            ...
            boolean r0 = com.meta.analytics.dsp.uinode.C0653Ih.A11(r0)
            if (r0 == 0) goto L73
