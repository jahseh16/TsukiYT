...
import com.meta.analytics.dsp.uinode.C02270o;
...
public final class C02270o {
    ...
    public C02270o(J2 j22, final Activity activity, int i) {
        this.A05 = j22;
    ...
    public static C02270o A00(J2 j22, Activity activity) {
        return A01(j22, activity, Build.VERSION.SDK_INT);
    }

    public static C02270o A01(J2 j22, Activity activity, int i) {
        if (activity != null && i >= 14) {
            return new C02270o(j22, activity, i);
        }
        return null;
    }

    private void A04(String str, long j, long j4, EnumC02200g enumC02200g) {
        HashMap map = new HashMap();
        map.put(A02(9, 10, 8), Long.toString(j));
        map.put(A02(0, 9, 34), Long.toString(j4));
        if (enumC02200g != null) {
            map.put(A02(19, 7, 9), enumC02200g.name());
        }
    ...
    public final void A06(EnumC02200g enumC02200g) {
        this.A02 = enumC02200g;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC02200g enumC02200g = EnumC02200g.A04;
        if (A07[2].charAt(6) == '9') {
