...
public abstract class PE {
     ...
     */
    public static WebResourceResponse A00(C1064Yn c1064Yn, WebResourceRequest webResourceRequest, Uri uri, String str, HashMap<String, String> map) throws IOException {
        String strA02 = A02(85, 5, 49);
        C0985Vj c0985VjA0F = R0.A05(c1064Yn.A01()).A0F(c1064Yn);
        C03696c.A0H(c1064Yn, uri.toString());
        try {
            PF pf = new PF(c1064Yn.A01(), uri, c0985VjA0F);
            int iAvailable = pf.available();
            if (iAvailable <= 0) {
                A05(c1064Yn, 1, new Pair[]{new Pair(A02(61, 9, 77), String.valueOf(iAvailable))});
                return null;
            }
            ...
            try {
                ...
                if (!z) {
                    ...
                    A05(c1064Yn, 0, pairArr);
                    return null;
                }
                int i = pdA01.A01;
                int i5 = pdA01.A00 == -1 ? iAvailable - 1 : pdA01.A00;
                A06(map, iAvailable);
                map.put(A02(31, 13, 81), A02(75, 6, 17) + i + A02(1, 1, 52) + i5 + A02(2, 1, 110) + iAvailable);
                c1064Yn.A0E().A5O();
                return new WebResourceResponse(str, null, 206, A02(46, 15, 36), map, pf);
            } catch (NumberFormatException e4) {
                A05(c1064Yn, 3, new Pair[]{new Pair(strA02, e4.toString())});
                return null;
            }
        } catch (IOException e5) {
            A05(c1064Yn, 2, new Pair[]{new Pair(strA02, e5.toString())});
            return null;
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 8 out of bounds for length 8
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static void A05(C1064Yn c1064Yn, int i, Pair<String, String>[] pairArr) {
        ...
        c1064Yn.A0E().A5N(jSONObject.toString());
    }
