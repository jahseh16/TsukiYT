...
public final class U4 extends AbstractC0757Mo {
    ...
    public U4(C1064Yn c1064Yn, J2 j22, String str) {
        super(c1064Yn, j22, str);
        this.A04 = c1064Yn;
        this.A03 = C2T.A00(c1064Yn.A01());
        ...
        AbstractC0731Lo.A0M(scrollView, -218103809);
    ...
    public final void A0L() {
        this.A00.setImageBitmap(AbstractC0740Lx.A01(EnumC0739Lw.CROSS));
        this.A00.setOnClickListener(new N7(this));
        this.A00.setContentDescription(A0B(4, 18, 29));
        C0761Ms c0761Ms = new C0761Ms(this.A04);
        c0761Ms.setData(this.A03.A0H(), EnumC0739Lw.HIDE_AD);
        c0761Ms.setOnClickListener(new N8(this, c0761Ms));
        C0761Ms c0761Ms2 = new C0761Ms(this.A04);
        c0761Ms2.setData(this.A03.A0L(), EnumC0739Lw.REPORT_AD);
        c0761Ms2.setOnClickListener(new N9(this, c0761Ms2));
        C0761Ms c0761Ms3 = new C0761Ms(this.A04);
        c0761Ms3.setData(this.A03.A0M(), EnumC0739Lw.AD_CHOICES_ICON);
        c0761Ms3.setOnClickListener(new NA(this, c0761Ms3));
        ...
        AbstractC0731Lo.A0T(this.A01);
        this.A01.removeAllViews();
        this.A01.addView(this.A00);
        this.A01.addView(linearLayout, layoutParams);
        linearLayout.addView(c0761Ms, menuParams);
        linearLayout.addView(c0761Ms2, menuParams);
        linearLayout.addView(c0761Ms3, menuParams);
    }
    ...
    public final void A0N(C2W c2w, C2U c2u) {
        ...
        if (c2u == C2U.A05) {
            strA0H = this.A03.A0F();
            enumC0739Lw = EnumC0739Lw.REPORT_AD;
            i = -552389;
        } else {
            strA0H = this.A03.A0H();
            enumC0739Lw = EnumC0739Lw.HIDE_AD;
            i = -13272859;
        }
        C0755Mm c0755MmA0I = new C0755Mm(this.A04, this.A0B).A0I(strA0H);
        String title = this.A03.A0D();
        C0755Mm c0755MmA0H = c0755MmA0I.A0H(title);
        String title2 = c2w.A04();
        C0756Mn adHiddenView = c0755MmA0H.A0F(title2).A0K(false).A0E(enumC0739Lw).A0D(i).A0L(false).A0J(false).A0M();
    ...
    public final void A0O(C2W c2w, C2U c2u) {
        ...
        N6 n6 = new N6(this.A04, c2w, this.A0B, isReportFlow ? EnumC0739Lw.REPORT_AD : EnumC0739Lw.HIDE_AD);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, 0);
        layoutParams.gravity = 17;
        layoutParams.weight = 1.0f;
        this.A00.setImageBitmap(AbstractC0740Lx.A01(EnumC0739Lw.BACK_ARROW));
