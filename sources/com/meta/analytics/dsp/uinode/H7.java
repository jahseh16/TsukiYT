...
public final class H7<T extends H8> extends Handler implements Runnable {
    ...
    public final /* synthetic */ C0992Vq A09;
    ...
    public H7(C0992Vq c0992Vq, Looper looper, T loadable, H6<T> h62, int i, long j) {
        super(looper);
        this.A09 = c0992Vq;
        this.A05 = loadable;
        this.A01 = h62;
    ...
    public final void A06(long j) {
        AbstractC0620Ha.A04(this.A09.A00 == null);
        this.A09.A00 = this;
        if (j > 0) {
            ...
            try {
                try {
                    try {
                        ...
                        Log.e(strA01, A01(14, 32, 72), e5);
                        if (!this.A08) {
                            obtainMessage(3, new HC(e5)).sendToTarget();
                        }
                    }
                } catch (Exception e6) {
                    Log.e(strA01, A01(121, 35, 10), e6);
                    if (!this.A08) {
                        obtainMessage(3, new HC(e6)).sendToTarget();
                    }
                }
            } catch (Error e8) {
                Log.e(strA01, A01(46, 31, 117), e8);
                if (!this.A08) {
                    obtainMessage(4, e8).sendToTarget();
                }
                throw e8;
            } catch (InterruptedException unused) {
                AbstractC0620Ha.A04(this.A07);
                if (!this.A08) {
                    sendEmptyMessage(2);
                }
            }
