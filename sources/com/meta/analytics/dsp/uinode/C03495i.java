...
public final class C03495i implements NativeAdApi {
    ...
    public C03495i(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        V2.A0L(nativeAdBaseApi).A1Y(EnumC0674Jg.A05);
    }

    public C03495i(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C1064Yn c1064YnA11 = A00().A11();
            C1064Yn downloadContext = C03435c.A03(imageView.getContext());
            downloadContext.A0K(c1064YnA11);
