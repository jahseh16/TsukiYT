...
public final class X6 implements InterfaceC0528Cy {
    ...
    public X6(boolean z, String str) {
        this.A0D = new C0644Hy(new byte[7]);
        this.A0E = new C0645Hz(Arrays.copyOf(A0J, 10));
        A03();
        this.A0G = z;
        this.A0F = str;
    }

    private void A01() throws C04539v {
        this.A0D.A07(0);
        if (!this.A0C) {
            ...
            byte[] audioSpecificConfig = AbstractC0624He.A07(iA04, channelConfig, audioObjectType);
            Pair<Integer, Integer> pairA03 = AbstractC0624He.A03(audioSpecificConfig);
    ...
    private void A07(C4 c4, long j, int i, int i5) {
        this.A03 = 3;
        this.A00 = i;
        this.A07 = c4;
        this.A04 = j;
        ...
        while (iA06 < iA07) {
            ...
            switch (endOffset | i5) {
                case 329:
                    ...
                    break;
                case 511:
                    this.A01 = NotificationCompat.FLAG_GROUP_SUMMARY;
                    iA06 = i;
                    break;
                case 836:
                    this.A01 = UserMetadata.MAX_ATTRIBUTE_SIZE;
                    iA06 = i;
                    break;
                case 1075:
                    A05();
    ...
    private void A09(C0645Hz c0645Hz) {
        int iMin = Math.min(c0645Hz.A04(), this.A02 - this.A00);
        this.A07.AFR(c0645Hz, iMin);
    ...
    private boolean A0A(C0645Hz c0645Hz, byte[] bArr, int i) {
        ...
        while (c0645Hz.A04() > 0) {
            switch (this.A03) {
                case 0:
                    ...
                    break;
                case 1:
                    if (A0A(c0645Hz, this.A0E.A00, 10)) {
                        A02();
                    }
                    break;
                case 2:
                    if (A0A(c0645Hz, this.A0D.A00, this.A0B ? 7 : 5)) {
                        A01();
                    }
                    break;
                case 3:
    ...
    public final void A4p(InterfaceC0504Bu interfaceC0504Bu, DC dc) {
        dc.A05();
        this.A0A = dc.A04();
        this.A09 = interfaceC0504Bu.AGi(dc.A03(), 1);
        if (this.A0G) {
            dc.A05();
