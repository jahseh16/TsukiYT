...
public abstract class K0 {
    ...
    public static long A00(String str, EnumC0674Jg enumC0674Jg) {
        if (A01.containsKey(str)) {
            return A01.get(str).longValue();
        }
        switch (C0693Jz.A00[enumC0674Jg.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    public static String A02(K1 k12) {
        AbstractC0683Jp.A05(A01(44, 15, 94), A01(22, 22, 87), A01(14, 8, 116));
    ...
    public static void A05(long j, K1 k12) {
        A01.put(A03(k12), Long.valueOf(j));
    }
    ...
    public static boolean A08(K1 k12) {
        ...
        Long l3 = A00.get(strA03);
        if (A05[3].charAt(17) != 'M') {
            throw new RuntimeException();
        }
        A05[6] = "HNdF4hlEpt9Mz";
        return System.currentTimeMillis() - l3.longValue() < A00(strA03, k12.A06());
    }
}
