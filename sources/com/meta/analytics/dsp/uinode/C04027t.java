...
public final class C04027t {
    ...
    public C04027t(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
        options.remove(null);
        this.A00 = num;
        this.A01 = num2;
    ...
    public C04027t(String[] strArr, Integer num, Integer num2) {
    ...
    public static C04027t A00(String str) {
        if (str == null) {
            return null;
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        ...
        return new C04027t(linkedHashSet, numValueOf, numValueOf2, str);
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C04027t)) {
            return false;
        }
        C04027t c04027t = (C04027t) obj;
        ...
        A06[0] = "YHhc40Na8nm";
        Integer num2 = c04027t.A00;
        if (num != num2 && (num == null || !num.equals(num2))) {
            return false;
        }
        Integer num3 = this.A01;
        Integer num4 = c04027t.A01;
        return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c04027t.A03);
    }
