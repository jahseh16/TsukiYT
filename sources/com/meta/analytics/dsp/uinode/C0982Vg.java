...
public final class C0982Vg implements HK {
    ...
    public long A00;
    public boolean A01;
    public final InterfaceC0984Vi A02;
    public final HS A03;
    ...
    public final synchronized void A4N(File file) throws HI {
        AbstractC0620Ha.A04(!this.A01);
        C0981Vf c0981VfA00 = C0981Vf.A00(file, this.A03);
        AbstractC0620Ha.A04(c0981VfA00 != null);
        HR hrA09 = this.A03.A09(c0981VfA00.A04);
        AbstractC0620Ha.A01(hrA09);
        AbstractC0620Ha.A04(hrA09.A0D());
        if (file.exists()) {
            if (file.length() == 0) {
                file.delete();
                return;
            ...
            if (jA00 != -1) {
                AbstractC0620Ha.A04(c0981VfA00.A02 + c0981VfA00.A01 <= jA00);
            }
            A0A(c0981VfA00);
            this.A03.A0G();
            notifyAll();
    ...
    public C0982Vg(File file, InterfaceC0984Vi interfaceC0984Vi) {
        this(file, interfaceC0984Vi, null, false);
    }

    public C0982Vg(File file, InterfaceC0984Vi interfaceC0984Vi, HS hs) {
        if (A0D(file)) {
            this.A04 = file;
            this.A02 = interfaceC0984Vi;
            this.A03 = hs;
    ...
    public C0982Vg(File file, InterfaceC0984Vi interfaceC0984Vi, byte[] bArr, boolean z) {
        this(file, interfaceC0984Vi, new HS(file, bArr, z));
    }

    private C0981Vf A00(String str, long j) throws HI {
        C0981Vf span;
        HR hrA09 = this.A03.A09(str);
        if (hrA09 == null) {
            C0981Vf c0981VfA02 = C0981Vf.A02(str, j);
            if (A08[7].length() == 15) {
                throw new RuntimeException();
            }
    ...
    public final synchronized C0981Vf AGV(String str, long j) throws HI, InterruptedException {
        C0981Vf span;
        while (true) {
            span = AGW(str, j);
            if (span == null) {
    ...
    public final synchronized C0981Vf AGW(String str, long j) throws HI {
        AbstractC0620Ha.A04(!this.A01);
        C0981Vf c0981VfA00 = A00(str, j);
        if (c0981VfA00.A05) {
            C0981Vf cacheSpan = this.A03.A09(str).A07(c0981VfA00);
            A0C(c0981VfA00, cacheSpan);
            return cacheSpan;
        }
    ...
    public void A04() {
        ...
        for (File file : fileArrListFiles) {
            if (!file.getName().equals(A03(106, 24, 45))) {
                C0981Vf c0981VfA00 = file.length() > 0 ? C0981Vf.A00(file, this.A03) : null;
                if (c0981VfA00 != null) {
                    A0A(c0981VfA00);
                } else {
                    file.delete();
    ...
    private void A05() throws HI {
        ...
        while (it.hasNext()) {
            for (C0981Vf c0981Vf : it.next().A08()) {
                if (!c0981Vf.A03.exists()) {
                    arrayList.add(c0981Vf);
                }
            }
        }
    ...
    private void A0A(C0981Vf c0981Vf) {
        this.A03.A0A(c0981Vf.A04).A09(c0981Vf);
        this.A00 += c0981Vf.A01;
        A0B(c0981Vf);
    }

    private void A0B(C0981Vf c0981Vf) {
        ArrayList<HJ> arrayList = this.A05.get(c0981Vf.A04);
        if (arrayList != null) {
            for (int i = arrayList.size() - 1; i >= 0; i--) {
                arrayList.get(i).ADB(this, c0981Vf);
            }
        }
        this.A02.ADB(this, c0981Vf);
    }

    private void A0C(C0981Vf c0981Vf, HO ho) {
        ArrayList<HJ> arrayList = this.A05.get(c0981Vf.A04);
        if (arrayList != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
                arrayList.get(i).ADD(this, c0981Vf, ho);
            }
        }
        this.A02.ADD(this, c0981Vf, ho);
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.HK
    public final synchronized long A6G(String str, long j, long j4) {
        HR cachedContent;
        AbstractC0620Ha.A04(!this.A01);
        cachedContent = this.A03.A09(str);
        return cachedContent != null ? cachedContent.A04(j, j4) : -j4;
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.HK
    public final synchronized File AGT(String str, long j, long j4) throws HI {
        HR hrA09;
        AbstractC0620Ha.A04(!this.A01);
        hrA09 = this.A03.A09(str);
        AbstractC0620Ha.A01(hrA09);
        ...
        this.A02.ADE(this, str, j, j4);
        return C0981Vf.A04(this.A04, hrA09.A02, j, System.currentTimeMillis());
    }
}
