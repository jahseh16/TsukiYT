...
public final class SY {
    ...
    public static void A08() {
        A03 = new byte[]{92, 95, 94, 89, 88, 91, 90, 85, 84, 87, 86, 81, 80, 83, 82, 77, 76, 79, 78, 73, 72, 75, 74, 69, 68, 71, 124, 127, 126, 121, 120, 123, 122, 117, 116, 119, 118, 113, 112, 115, 114, 109, 108, 111, 110, 105, 104, 107, 106, 101, 100, 103, 45, 44, 47, 46, 41, 40, 43, 42, 37, 36, 54, 50, 48, 51, 33, 55, 22, 55, 62, 38, 51, 45, 123, 42, 13, 57, 40, 37, 35, 57, 9, 54, 58, 40, 62, 61, 51, 58, 106, 111, 19, 27, 21, 15, 47, 19, 9, 18, 24, 51, 18, 127, 101, 64, 127, 115, 97, 119, 116, 122, 115, 35, 38, 104, 123, 108, 109, 119, 113, 112, 22, 79, 8, 31, 31, 79, 87, 79, 62, 36, 55, 40, 50, 40, 53, 46, 40, 40, 41, 50, 32, 44, 53, 50, 46, 44, 61, 79, 16};
    }
    ...
    public static long A01(List<SZ> list, int i, int i5) {
        ...
        for (int i8 = i + 1; i8 < i + i5; i8++) {
            long jA03 = list.get(i8).A03();
            long jA01 = list.get(i8).A01();
    ...
    public static String A03(String str) {
        ...
        for (int n3 = 0; n3 < sb.length(); n3 += 3) {
            ...
            sb3.append(strA02.charAt(n42)).append(strA02.charAt(n22)).append(strA02.charAt(iCharAt & 63));
        }
        StringBuilder r3 = new StringBuilder();
        String base64chars = sb2.substring(0, sb2.length() - p2.length());
        return r3.append(base64chars).append((Object) p2).toString();
    }
    ...
    @Nullable
    public static String A06(@Nullable List<SZ> list, int i, int i5, boolean z) {
        ...
        if (i5 > 1) {
            A0A(list, i, i5);
            map.put(A02(64, 9, 58), Long.valueOf(A01(list, i, i5)));
            ArrayList arrayList = new ArrayList();
            List<Long> viewable50FrameTimestampList = new ArrayList<>();
            List<Long> audioFrameTimestampList = new ArrayList<>();
            for (int i8 = i + 1; i8 < i + i5; i8++) {
                arrayList.add(Long.valueOf(list.get(i8).A03()));
                arrayList.add(Long.valueOf(list.get(i8).A01()));
                arrayList.add(Long.valueOf(list.get(i8).A02()));
                viewable50FrameTimestampList.add(Long.valueOf(list.get(i8).A00()));
                if (list.get(i8).A00() != 0) {
                    z5 = true;
                }
                if (z) {
                    audioFrameTimestampList.add(Long.valueOf(list.get(i8).A04()));
                    if (list.get(i8).A04() != 0) {
                        z7 = true;
                    }
                }
            }
            ...
            map.put(A02(94, 9, 20), Boolean.valueOf(z5));
            if (z) {
                map.put(A02(81, 11, 55), A05(audioFrameTimestampList));
                map.put(A02(103, 12, 126), Boolean.valueOf(z7));
            }
        }
        ...
        A04[2] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
    ...
    public static void A09(StringBuilder sb, long j) {
        while (j >= 128) {
            int b4 = 128 - 1;
            char c = (char) ((((long) b4) & j) | ((long) 128));
            j >>= 7;
            sb.append(c);
        }
        int b6 = (int) j;
    ...
    public static void A0A(List<SZ> list, int i, int i5) {
        long jA00;
        for (int i8 = (i + i5) - 1; i8 > i; i8--) {
            int i10 = i8 - 1;
            list.get(i8).A09(list.get(i8).A03() - list.get(i10).A03());
            int i11 = i8 - 1;
            list.get(i8).A07(list.get(i8).A01() - list.get(i11).A01());
            int i12 = i8 - 1;
            list.get(i8).A08(list.get(i8).A02() - list.get(i12).A02());
            SZ sz = list.get(i8);
            int i13 = i8 - 1;
            long jA04 = 0;
            if (list.get(i13).A00() == -1) {
                ...
                int i14 = i8 - 1;
                jA00 = list.get(i8).A00() - list.get(i14).A00();
            }
            sz.A06(jA00);
            SZ sz2 = list.get(i8);
            int i15 = i8 - 1;
            if (list.get(i15).A04() != -1) {
                int i16 = i8 - 1;
                jA04 = list.get(i8).A04() - list.get(i16).A04();
            }
            sz2.A0A(jA04);
            list.get(i8).A08(list.get(i8).A02() - list.get(i8).A01());
        }
    }
