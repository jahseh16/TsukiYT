...
public final class C0517Ck {
    ...
    public final C0645Hz A0A = new C0645Hz(255);
    ...
    public final boolean A03(InterfaceC0503Bt interfaceC0503Bt, boolean z) throws InterruptedException, IOException {
        this.A0A.A0V();
        A02();
        boolean hasEnoughBytes = interfaceC0503Bt.A7I() == -1 || interfaceC0503Bt.A7I() - interfaceC0503Bt.A7d() >= 27;
        if (hasEnoughBytes) {
            boolean hasEnoughBytes2 = interfaceC0503Bt.ADw(this.A0A.A00, 0, 27, true);
            if (hasEnoughBytes2) {
                if (this.A0A.A0M() != A0C) {
                    if (z) {
                        return false;
                    }
                    throw new C04539v(A00(4, 46, 60));
                }
                ...
                if (iA0E != 0) {
                    ...
                    throw new C04539v(A00(50, 31, 66));
                }
                ...
                this.A01 = iA0E2 + 27;
                this.A0A.A0V();
                interfaceC0503Bt.ADv(this.A0A.A00, 0, this.A02);
