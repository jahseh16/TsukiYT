...
public class C1085Zj implements C4B {
    ...
    public C1085Zj(C0547Eb c0547Eb) {
        this.A00 = c0547Eb;
    }
    ...
    public final void A57(int i) {
        ...
        View view = A6M(i);
        if (view != null && (anonymousClass56A0F = C0547Eb.A0F(view)) != null) {
            if (!anonymousClass56A0F.A0c() || anonymousClass56A0F.A0f()) {
                anonymousClass56A0F.A0T(NotificationCompat.FLAG_LOCAL_ONLY);
            } else {
