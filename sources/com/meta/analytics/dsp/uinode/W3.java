...
public final class W3 implements InterfaceC0615Gu {
    ...
    public final long ADl(C0619Gy c0619Gy) throws IOException {
        ...
        if (A00(102, 4, 80).equals(scheme)) {
            ...
            throw new C04539v(scheme3);
        }
        String scheme4 = A00(82, 20, 87) + scheme;
        throw new C04539v(scheme4);
    }
