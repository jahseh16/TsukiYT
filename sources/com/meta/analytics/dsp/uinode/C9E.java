...
public final class C9E implements Closeable {
    ...
    public final synchronized AnonymousClass92 A0A(int i, int i5, byte[] bArr, int i8, int[] iArr, int i10) throws IOException {
        if (!this.A00) {
            for (C9D file : this.A02) {
                if (file.A00() == i) {
                    return new AnonymousClass92(i, file.A02(i5, bArr, i8, iArr, i10));
                }
            }
