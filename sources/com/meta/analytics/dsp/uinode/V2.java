...
public final class V2 implements Ad, NativeAdBaseApi, Repairable, JX {
    ...
    private void A0f(View view, View view2, List<View> list, boolean z) {
        ...
        if (c1182bKA0C == null) {
            ...
            Log.e(A0n, strA0W3);
            C0670Jb c0670Jb = new C0670Jb(AdErrorType.NATIVE_AD_IS_NOT_LOADED, strA0W3);
            A11().A0E().A2m(C0722Lf.A01(this.A00), c0670Jb.A03().getErrorCode(), c0670Jb.A04());
            if (!C0653Ih.A2F(this.A0c) || (v1 = this.A0G) == null) {
                return;
            }
            v1.ABR(c0670Jb);
            return;
        ...
        ZX zx = this.A0U.get();
        if (zx != null && c1182bKA0C.A08() == 1) {
            zx.A03(EnumC0739Lw.AN_INFO_ICON);
        }
        if (view2 == null) {
            if (this.A0J == EnumC0674Jg.A05) {
                AdErrorType adErrorType = AdErrorType.NO_MEDIAVIEW_IN_NATIVEAD;
                String strA0W4 = A0W(243, 21, 68);
                C0670Jb c0670Jb2 = new C0670Jb(adErrorType, strA0W4);
                A11().A0E().A2m(C0722Lf.A01(this.A00), c0670Jb2.A03().getErrorCode(), c0670Jb2.A04());
                V1 v12 = this.A0G;
                if (v12 != null) {
                    v12.ABR(c0670Jb2);
                }
            ...
            C0670Jb c0670Jb3 = new C0670Jb(adErrorType2, strA0W5);
            A11().A0E().A2m(C0722Lf.A01(this.A00), c0670Jb3.A03().getErrorCode(), c0670Jb3.A04());
            V1 v13 = this.A0G;
            if (v13 != null) {
                v13.ABR(c0670Jb3);
            }
        ...
        boolean z7 = (view2 instanceof AdNativeComponentView) && ((AdNativeComponentView) view2).getAdContentsView() != null;
        boolean z8 = z && (view2 instanceof ImageView);
        if (!z7 && !z8) {
            if (this.A0G != null) {
                C0670Jb c0670Jb4 = new C0670Jb(AdErrorType.UNSUPPORTED_AD_ASSET_NATIVEAD, A0W(519, 31, 15));
                A11().A0E().A2m(C0722Lf.A01(this.A00), c0670Jb4.A03().getErrorCode(), c0670Jb4.A04());
                this.A0G.ABR(c0670Jb4);
                return;
            }
            return;
        }
        ...
        if (view instanceof ViewGroup) {
            C0751Mi c0751Mi = new C0751Mi(this.A0c, new V8(this));
            this.A0K = c0751Mi;
            ((ViewGroup) view).addView(c0751Mi);
        }
        if (c1182bKA0C.A0S()) {
        ...
        int iA00 = A00();
        this.A0P = new V6(this, view2, z8, c1182bKA0C);
        ...
        C1172bA c1172bA = new C1172bA(this.A0c, new V3(this, null), this.A0R, this.A0a);
        this.A09 = c1172bA;
        c1172bA.A0D(arrayList);
        A0o.put(view, new WeakReference<>(this));
        if (Build.VERSION.SDK_INT < 18 || !C0653Ih.A11(this.A0c)) {
            return;
        }
        C0775Ng c0775Ng = new C0775Ng();
        this.A0L = c0775Ng;
        c0775Ng.A0C(this.A0g);
        this.A0L.A0B(this.A0c.getPackageName());
        this.A0L.A0A(this.A0R);
        C1182bK c1182bK = this.A0a;
        if (c1182bK != null && c1182bK.A0E().A03() > 0) {
    ...
    public V2(Context context, String str, JO jo, boolean z) {
        ...
        this.A0J = EnumC0674Jg.A05;
        this.A0E = JL.A04;
        this.A08 = AnonymousClass12.A03;
        this.A0U = new WeakReference<>(null);
        this.A0i = new ArrayList();
        this.A0f = new C0723Lg();
        this.A0Z = false;
        this.A0Y = false;
        this.A00 = -1L;
        if (context instanceof C1064Yn) {
            this.A0c = (C1064Yn) context;
        } else if (!z) {
            this.A0c = C03435c.A04(context);
        } else {
            this.A0c = C03435c.A03(context);
        }
        this.A0c.A0L(this);
        this.A0g = str;
        this.A0d = jo;
    ...
    public V2(C1064Yn c1064Yn, C1182bK c1182bK, C8T c8t, JO jo) {
        this((Context) c1064Yn, (String) null, jo, true);
        this.A0a = c1182bK;
        this.A0D = c8t;
        this.A0j = true;
        this.A05 = new View(c1064Yn);
    }

    public V2(C1064Yn c1064Yn, C1182bK c1182bK, C8T c8t, JO jo, C1142ag c1142ag) {
        this(c1064Yn, c1182bK, c8t, jo);
        this.A0B = c1142ag;
    }
    ...
    public static Drawable A05(C1064Yn c1064Yn, Bitmap bitmap, boolean z, String str) {
        BitmapDrawable bitmapDrawableA00;
        BitmapDrawable bitmapDrawable = new BitmapDrawable(c1064Yn.getResources(), bitmap);
        if (z && (bitmapDrawableA00 = AbstractC0843Pw.A00(c1064Yn, str)) != null) {
    ...
    public static NativeAdBase A0A(Context context, String str, String str2) throws C0671Jc {
        EnumC0674Jg enumC0674JgA00 = C0679Jl.A00(str2);
        if (enumC0674JgA00 != null) {
            EnumC0674Jg enumC0674Jg = EnumC0674Jg.A04;
            String[] strArr = A0m;
            if (strArr[7].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            ...
            if (enumC0674JgA00 == enumC0674Jg) {
                return new NativeBannerAd(context, str);
            }
            EnumC0674Jg template = EnumC0674Jg.A05;
            if (enumC0674JgA00 == template) {
                return new NativeAd(context, str);
            }
            throw new C0671Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(42, 34, 84), enumC0674JgA00));
        }
        throw new C0671Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(114, 50, 50), str2));
    }

    private final C1182bK A0C() {
        C1182bK c1182bK = this.A0a;
        if (c1182bK != null && c1182bK.A0R()) {
            return c1182bK;
        }
        return null;
    }
    ...
    private void A0a() {
        if (!TextUtils.isEmpty(getAdChoicesLinkUrl())) {
            C0712Kv.A0M(new C0712Kv(), this.A0c, AbstractC0715Ky.A00(getAdChoicesLinkUrl()), A1B());
        }
    }
    ...
    private void A0g(FrameLayout frameLayout, String str) {
        ...
        C0844Px c0844PxA01 = AbstractC0843Pw.A01(C03435c.A03(this.A0c), str);
        this.A0N = c0844PxA01;
        if (c0844PxA01 != null) {
            frameLayout.addView(c0844PxA01, new FrameLayout.LayoutParams(-1, -1));
            frameLayout.bringChildToFront(this.A0N);
        }
    }

    private void A0h(C1182bK c1182bK, boolean z) {
        if (c1182bK == null) {
            return;
        }
        ...
        if (zEquals) {
            AnonymousClass14 anonymousClass14A0E = c1182bK.A0E();
            String clientToken = c1182bK.A6T();
            if (!TextUtils.isEmpty(clientToken)) {
                this.A0b.A0d(new JA(clientToken, this.A0c.A09()));
            }
            if (anonymousClass14A0E.A0G() != null) {
                C03676a c03676a = new C03676a(anonymousClass14A0E.A0G().getUrl(), anonymousClass14A0E.A0G().getHeight(), anonymousClass14A0E.A0G().getWidth(), c1182bK.A0G(), A0W(596, 6, 89));
                c03676a.A00 = this.A0C;
                this.A0b.A0V();
                this.A0b.A0b(c03676a);
            }
            if (!this.A0J.equals(EnumC0674Jg.A04)) {
                if (anonymousClass14A0E.A0F() != null) {
                    this.A0b.A0b(new C03676a(anonymousClass14A0E.A0F().getUrl(), anonymousClass14A0E.A0F().getHeight(), anonymousClass14A0E.A0F().getWidth(), c1182bK.A0G(), A0W(596, 6, 89)));
                }
                List<V2> listA0H = c1182bK.A0H();
                String[] strArr = A0m;
                if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                    throw new RuntimeException();
                }
                ...
                if (listA0H != null) {
                    for (V2 v22 : c1182bK.A0H()) {
                        if (v22.getAdCoverImage() != null) {
                            this.A0b.A0b(new C03676a(v22.getAdCoverImage().getUrl(), v22.getAdCoverImage().getHeight(), v22.getAdCoverImage().getWidth(), c1182bK.A0G(), A0W(596, 6, 89)));
                        }
                    }
                }
                String strA0d = anonymousClass14A0E.A0d();
                if (!TextUtils.isEmpty(strA0d)) {
                    this.A0b.A0a(new C6Y(strA0d, c1182bK.A0G(), A0W(596, 6, 89), anonymousClass14A0E.A0A()));
                }
            }
            AbstractC1167b5 abstractC1167b5A0D = anonymousClass14A0E.A0D();
            if (abstractC1167b5A0D != null && abstractC1167b5A0D.A0m()) {
                C6Y c6y = new C6Y(abstractC1167b5A0D.A0M(), abstractC1167b5A0D.A0S(), strA0W);
                c6y.A04 = true;
                c6y.A03 = A0W(0, 5, 0);
                this.A0b.A0X(c6y);
            }
        }
        this.A0b.A0W(new V9(this, c1182bK, z), new C6V(c1182bK.A0G(), strA0W));
    }
    ...
    private void A0i(AnonymousClass15 anonymousClass15) {
        ...
        c1182bK.A0K(anonymousClass15);
    }

    public static void A0j(NativeAdImageApi nativeAdImageApi, ImageView imageView, C1064Yn c1064Yn) {
        if (nativeAdImageApi != null && imageView != null) {
            new AsyncTaskC0941Tq(imageView, c1064Yn).A05(nativeAdImageApi.getHeight(), nativeAdImageApi.getWidth()).A07(nativeAdImageApi.getUrl());
        }
    }
    ...
    public final C1182bK A0y() {
        return this.A0a;
    }

    public final AbstractC1167b5 A0z() {
        return A0F().A0D();
    }

    public final C03696c A10() {
        return this.A0b;
    }

    public final C1064Yn A11() {
        return this.A0c;
    }
    ...
    public final String A1G() {
        C1182bK c1182bK = this.A0a;
        if (c1182bK == null || TextUtils.isEmpty(c1182bK.A0E().A0d())) {
            return null;
        }
    ...
    public final void A1I() {
        ...
        C1064Yn c1064Yn = this.A0c;
        AbstractC0757Mo abstractC0757MoA01 = AbstractC0758Mp.A01(c1064Yn, c1064Yn.A09(), A1B(), this.A07);
        if (abstractC0757MoA01 == null) {
            A0a();
        } else {
            ((ZG) this.A07.getNativeAdLayoutApi()).A03(abstractC0757MoA01);
            abstractC0757MoA01.A0K();
        }
    }
    ...
    public final void A1K(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            boolean zA11 = C0653Ih.A11(view.getContext());
            String[] strArr = A0m;
            if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                throw new RuntimeException();
            }
    ...
    public final void A1R(NativeAdBase nativeAdBase, NativeAdListener nativeAdListener) {
        ...
        A0m(new C0493Bj(nativeAdListener, nativeAdBase));
    }
    ...
    public final void A1T(C1182bK c1182bK) {
        A0h(c1182bK, true);
        if (this.A0G != null) {
            List<V2> listA0H = c1182bK.A0H();
            String[] strArr = A0m;
            ...
            if (listA0H != null) {
                VB vb = new VB(this);
                Iterator<V2> it = c1182bK.A0H().iterator();
                while (it.hasNext()) {
                    it.next().A0i(vb);
                }
            }
    ...
    public final void A1V(JL jl, String str, C6i c6i) {
        ...
        if (this.A0j) {
            AdSettings.IntegrationErrorMode integrationErrorModeA00 = AbstractC02621x.A00(this.A0c);
            ...
            if (!integrationErrorMode.equals(integrationErrorModeA00)) {
                C0670Jb c0670Jb = new C0670Jb(AdErrorType.LOAD_AD_CALLED_MORE_THAN_ONCE, A0W(566, 30, 115));
                A11().A0E().A2m(C0722Lf.A01(this.A00), c0670Jb.A03().getErrorCode(), c0670Jb.A04());
                V1 v1 = this.A0G;
                if (v1 != null) {
                    v1.ABR(c0670Jb);
        ...
        this.A0C = c6i;
        C02591u c02591u = new C02591u(this.A0g, this.A0J, A0R(), null, 1, new C1135aZ());
        c02591u.A05(jl);
        c02591u.A06(this.A0S);
        c02591u.A07(this.A0T);
        FO fo = new FO(this.A0c, c02591u);
        this.A0A = fo;
        fo.A0P(new VC(this));
        this.A0A.A0T(str);
    }

    public final void A1W(JR jr2) {
        this.A0H = jr2;
    }
    ...
    public final void A1Y(EnumC0674Jg enumC0674Jg) {
        if (!A0q()) {
            if (EnumC0674Jg.A04.equals(enumC0674Jg)) {
                C1064Yn c1064Yn = this.A0c;
                String[] strArr = A0m;
                if (strArr[7].length() != strArr[5].length()) {
                    throw new RuntimeException();
                ...
                c1064Yn.A0E().A2s(AdPlacementType.NATIVE_BANNER.toString(), this.A0g);
            } else {
                this.A0c.A0E().A2s(AdPlacementType.NATIVE.toString(), this.A0g);
            }
        }
        this.A0J = enumC0674Jg;
    }
    ...
    */
    ...
    public final void destroy() {
        AbstractC0683Jp.A05(A0W(553, 7, 7), A0W(363, 19, 23), A0W(5, 8, 76));
        if (C0653Ih.A1W(this.A0c)) {
    ...
    public final Drawable getPreloadedIconViewDrawable() {
        ...
        if (adapter != null && (jpA0G = A0F().A0G()) != null && (bitmapA0M = this.A0b.A0M(jpA0G.getUrl())) != null) {
            ...
            return A05(c1064YnA11, bitmapA0M, zA1d, A1C());
        }
        return null;
    }
    ...
    public final boolean hasCallToAction() {
        C1182bK c1182bK = this.A0a;
        return c1182bK != null && c1182bK.A0Q();
    }
    ...
    public final boolean isAdLoaded() {
        C1182bK c1182bK = this.A0a;
        return c1182bK != null && c1182bK.A0R();
    }

    public final void loadAd() {
        AbstractC0683Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(13, 8, 89));
    ...
    public final void loadAd(NativeAdBase.NativeLoadAdConfig nativeLoadAdConfig) {
        AbstractC0683Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(21, 8, 126));
    ...
    public final void repair(Throwable th) {
        ...
        A11().A0E().A2m(C0722Lf.A01(this.A00), 2001, str);
        V1 v1 = this.A0G;
        if (v1 != null) {
            v1.ABR(new C0670Jb(2001, str));
        }
    }
