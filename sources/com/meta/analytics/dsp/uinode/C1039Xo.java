...
public final class C1039Xo implements C1 {
    ...
    public C1039Xo(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    public final C0 A7t(long j) {
        ...
        if (c22.A01 < j) {
            ...
            if (iA00 != chunkIndex - 1) {
                ...
                long j4 = this.A04[chunkIndex2];
                int chunkIndex3 = iA00 + 1;
                C2 seekPoint = new C2(j4, this.A03[chunkIndex3]);
