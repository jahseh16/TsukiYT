...
public final class C3F extends AbstractC03756j {
    ...
    public static Point A02(DG dg, Format format) throws DP {
        ...
        int i5 = z ? format.A0F : format.A08;
        float f3 = i5 / i;
        for (int i8 : A0f) {
            int i10 = (int) (i8 * f3);
            if (i8 <= i || i10 <= i5) {
            ...
            if (IF.A02 >= 21) {
                ...
                Point pointA0E = dg.A0E(i11, i8);
                if (dg.A0H(pointA0E.x, pointA0E.y, format.A01)) {
                    return pointA0E;
                }
            } else {
                int iA04 = IF.A04(i8, 16) * 16;
                int iA042 = IF.A04(i10, 16) * 16;
                if (iA04 * iA042 <= DR.A00()) {
                    int i12 = z ? iA042 : iA04;
                    if (!z) {
                        iA04 = iA042;
                    }
                    return new Point(i12, iA04);
                }
            }
        }
        return null;
    ...
    public C3F(Context context, DM dm, long j, InterfaceC0486Bc<FrameworkMediaCrypto> interfaceC0486Bc, boolean z, Handler handler, InterfaceC0649Id interfaceC0649Id, int i) {
        super(2, dm, interfaceC0486Bc, z);
        this.A0U = j;
        this.A0T = i;
        Context applicationContext = context.getApplicationContext();
        this.A0V = applicationContext;
        this.A0W = new IT(applicationContext);
        this.A0X = new C0648Ic(handler, interfaceC0649Id);
        this.A0Y = A0M();
    ...
    */
    ...
    private final void A0I(MediaCodec mediaCodec, int i, long j, long j4) {
        A09();
        IC.A02(A05(1161, 19, 109));
    ...
    private void A0L(Surface surface) throws C04359c {
        if (surface == null) {
            if (this.A0N != null) {
                surface = this.A0N;
            } else {
    ...
    private final boolean A0P(long j, long j4) {
        return A0O(j);
    }

    private final boolean A0Q(long j, long j4) {
        return A0N(j);
    }

    private final boolean A0R(long j, long j4) {
        return A0N(j) && j4 > 100000;
    }

    private final boolean A0S(MediaCodec mediaCodec, int i, long j, long j4) throws C04359c {
        int iA10 = A10(j4);
        if (iA10 == 0) {
            return false;
        }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int A1C(com.meta.analytics.dsp.uinode.DM r10, com.meta.analytics.dsp.uinode.InterfaceC0486Bc<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> r11, com.facebook.ads.internal.exoplayer2.thirdparty.Format r12) throws com.meta.analytics.dsp.uinode.DP {
        /*
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC03756j
    public final void A1G() throws C04359c {
        super.A1G();
        this.A04 = 0;
    }
    ...
    */
    ...
    public final void A1N(C1042Xr c1042Xr) {
        this.A04++;
        this.A0K = Math.max(c1042Xr.A00, this.A0K);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean A1Q(long r32, long r34, android.media.MediaCodec r36, java.nio.ByteBuffer r37, int r38, int r39, long r40, boolean r42) throws com.meta.analytics.dsp.uinode.C04359c {
        /*
    ...
    public final void A8V(int i, Object obj) throws C04359c {
        ...
        if (i == 4) {
            ...
            mediaCodecA1D.setVideoScalingMode(i5);
            return;
        }
        super.A8V(i, obj);
    }
