...
public final class TT extends OL {
    ...
    public TextView A0F;
    public AbstractC1167b5 A0G;
    public NJ A0H;
    public NK A0I;
    public U1 A0J;
    public ViewOnClickListenerC0936Tl A0K;
    public OP A0L;
    public C0809Oo A0M;
    public boolean A0N;
    public boolean A0O;
    ...
    public final AbstractC02210h A0c;
    public final JA A0d;
    public final O0 A0e;
    public final O1 A0f;
    public final KP A0g;
    ...
    public TT(OP op) {
        ...
        this.A08 = 0;
        this.A01 = 0;
        this.A0i = new RunnableC0801Og(this);
        this.A0P = false;
        ...
        this.A0g = kpA0A;
        if (kpA0A != null) {
            AbstractC0731Lo.A0K(kpA0A);
        }
        View viewA03 = this.A0L.A03();
        this.A0b = viewA03;
        this.A0c = C02220i.A01(op.A05(), op.A06(), op.A04().A12(), AbstractC0715Ky.A00(op.A04().A0x().A0F().A05()), new HashMap(), false, true, this.A0G.A0y());
        ...
        if (sa != null && C0653Ih.A18(getAdContextWrapper())) {
            AbstractC0780Nl.A00(sa.getVideoImplView(), C0653Ih.A19(getAdContextWrapper()), new ViewOnClickListenerC0802Oh(this));
        } else if (sa == null && this.A0A != null && C0653Ih.A16(getAdContextWrapper())) {
            AbstractC0780Nl.A00(this.A0A, C0653Ih.A17(getAdContextWrapper()), new ViewOnClickListenerC0803Oi(this));
        }
        this.A0E = null;
        this.A0K = null;
    }
    ...
    public TT(OP op, boolean z) {
        ...
        this.A0Y = this.A0X && abstractC1167b5A04.A0o();
        if (this.A0X) {
            int iA0E = abstractC1167b5A04.A0E();
            this.A02 = iA0E;
            if (iA0E == 0) {
                A16();
            ...
            String strA0U = abstractC1167b5A04.A0U();
    ...
    private void A0K() {
        AbstractC0731Lo.A0J(this.A0D);
        LinearLayout linearLayout = new LinearLayout(this.A0L.A05());
        this.A0D = linearLayout;
        AbstractC0731Lo.A0R(linearLayout, getAdContextWrapper());
    ...
    public void A16() {
        A0d(((C0577Ff) this.A0c).A0G().toString());
        A0g(true);
    }

    private void A0M() {
        ExecutorC0725Li.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.Oa
            @Override // java.lang.Runnable
            public final void run() {
                this.A00.A15();
            }
    ...
    private void A0P() {
        AbstractC0731Lo.A0J(this.A0C);
        LinearLayout linearLayout = new LinearLayout(this.A0L.A05());
        this.A0C = linearLayout;
        linearLayout.setOrientation(1);
        AbstractC0731Lo.A0K(this.A0C);
        A0U();
    ...
    private void A0T() {
        ...
        if (this.A0G.A0l()) {
            this.A0A.setOnClickListener(new ViewOnClickListenerC0804Oj(this));
        }
        ...
        AbstractC0731Lo.A0K(this.A0F);
        C0809Oo c0809Oo = new C0809Oo(this.A0L.A05(), this.A0L.A04(), this.A0L.A06(), this.A0L.A09(), this.A0L.A0B(), this.A0L.A07(), getColors(), new TU(this));
        this.A0M = c0809Oo;
        c0809Oo.setAutoClickTime(this.A0L.A04(), this.A0L.A08());
        AbstractC0731Lo.A0G(1001, this.A0M);
        addView(this.A0M);
        A0V();
        A0K();
        if (C0653Ih.A0y(this.A0L.A05())) {
            this.A0D.setOnClickListener(new ViewOnClickListenerC0805Ok(this));
            if (this.A0L.A08() != null) {
                this.A0L.A08().setCTAClickListener(new ViewOnClickListenerC0806Ol(this));
            }
        }
    }
    ...
    public void A0d(String str) {
        ...
        if (this.A0Y) {
            ...
            AbstractC0731Lo.A0J(this.A0K);
        }
        AbstractC0731Lo.A0J(this.A0J);
        TY ty = new TY(this);
        if (this.A0L.A05().A0D() == null) {
            this.A0L.A05().A0E().A8e();
        }
        if (!AbstractC0654Ii.A02(this.A0L.A05()) && this.A0L.A05().A0D() != null) {
        ...
        this.A0J.setOnTouchListener(new ViewOnTouchListenerC0798Od(this));
        setUpBrowserControls(this.A0J);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -1);
        layoutParams.weight = 0.9f;
        if (this.A0Y || this.A0G.A0n()) {
            C1064Yn c1064YnA05 = this.A0L.A05();
            ...
            ViewOnClickListenerC0936Tl viewOnClickListenerC0936Tl = new ViewOnClickListenerC0936Tl(c1064YnA05, strA0L, c1pA00, this.A0L.A04().A0x().A0F().A06(), this.A0L.A06(), this.A0L.A09(), this.A0L.A0B(), this.A0L.A07(), this.A0L.A04().A0y());
            this.A0K = viewOnClickListenerC0936Tl;
            viewOnClickListenerC0936Tl.setCta(this.A0L.A04().A0x().A0F(), this.A0L.A04().A12(), new HashMap());
        }
        if (!this.A0Y || this.A0K == null) {
            ...
            if (this.A0N) {
                ViewOnClickListenerC0936Tl viewOnClickListenerC0936Tl2 = this.A0K;
                int i = A0n;
                viewOnClickListenerC0936Tl2.setPadding(i, 0, i, 0);
            }
    ...
    public void A0g(boolean z) {
        ...
        if (z) {
            C0809Oo c0809Oo = this.A0M;
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(c0809Oo, strA0J, c0809Oo.getY(), this.A05 / 5);
        }
        ...
        duration.addUpdateListener(new C0799Oe(this));
        ...
        animatorSet.addListener(new C0800Of(this, z));
        animatorSet.start();
    }
    ...
    */
    private void A0h(boolean r8) {
        /*
            ...
            com.meta.analytics.dsp.uinode.AbstractC0731Lo.A0J(r0)
            android.view.View r0 = r7.A0A
            if (r0 != 0) goto L17
            com.facebook.ads.redexgen.X.OP r0 = r7.A0L
            android.view.View r0 = r0.A02()
            r7.A0A = r0
            com.meta.analytics.dsp.uinode.AbstractC0731Lo.A0K(r0)
        L17:
            boolean r4 = r7.A0O
        ...
        L60:
            ...
            boolean r0 = com.meta.analytics.dsp.uinode.C0653Ih.A16(r0)
            if (r0 == 0) goto La2
    ...
    */
    public final void A10(com.meta.analytics.dsp.uinode.C1G r6, java.lang.String r7, double r8, android.os.Bundle r10) {
        ...
        L17:
            ...
            r0 = 8
            com.meta.analytics.dsp.uinode.AbstractC0731Lo.A0N(r1, r0)
            com.facebook.ads.redexgen.X.OP r0 = r5.A0L
            com.facebook.ads.redexgen.X.Yn r0 = r0.A05()
            boolean r0 = com.meta.analytics.dsp.uinode.C0653Ih.A0y(r0)
            if (r0 == 0) goto L30
            android.widget.LinearLayout r1 = r5.A0D
            r0 = 0
            r1.setClickable(r0)
    ...
    public final /* synthetic */ void A18(View view) {
        ExecutorC0725Li.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.OX
            @Override // java.lang.Runnable
            public final void run() {
                this.A00.A14();
            }
