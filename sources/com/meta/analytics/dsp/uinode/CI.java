...
public final class CI implements WP, WQ {
    ...
    public CI(WP wp, boolean z, long j, long j4) {
        this.A05 = wp;
    ...
    private AD A00(long j, AD ad2) {
        long toleranceBeforeUs = IF.A0E(ad2.A01, 0L, j - this.A01);
        long j4 = ad2.A00;
        long j7 = this.A00;
        long jA0E = IF.A0E(j4, 0L, j7 == Long.MIN_VALUE ? Long.MAX_VALUE : j7 - j);
        if (toleranceBeforeUs == ad2.A01 && jA0E == ad2.A00) {
            return ad2;
        }
    ...
    public static boolean A02(long j, InterfaceC0601Gg[] interfaceC0601GgArr) {
        if (j != 0) {
            for (InterfaceC0601Gg interfaceC0601Gg : interfaceC0601GgArr) {
                if (interfaceC0601Gg != null && !AbstractC0638Hs.A09(interfaceC0601Gg.A7u().A0O)) {
                    return true;
                }
            }
        }
    ...
    public final long A5x(long j, AD ad2) {
        ...
        return this.A05.A5x(j, A00(j, ad2));
    }
    ...
    */
    public final long AFl(long r10) {
        ...
        L50:
            r8 = 1
        L51:
            com.meta.analytics.dsp.uinode.AbstractC0620Ha.A04(r8)
            return r6
        */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final long AFm(com.meta.analytics.dsp.uinode.InterfaceC0601Gg[] r16, boolean[] r17, com.meta.analytics.dsp.uinode.FB[] r18, boolean[] r19, long r20) {
        /*
            r15 = this;
            r4 = r18
            int r0 = r4.length
        ...
        L59:
            r0 = 1
        L5a:
            com.meta.analytics.dsp.uinode.AbstractC0620Ha.A04(r0)
            r5 = 0
        L5e:
            int r0 = r4.length
            if (r5 >= r0) goto L94
