...
public final class ExecutorC0736Lt implements Executor {
    ...
    static {
        A04();
        A08 = new ExecutorC0736Lt(A00(7, 7, 8), 0);
        A06 = new ExecutorC0736Lt(A00(0, 5, 91), 0);
        A07 = new ExecutorC0736Lt(A00(5, 2, 3), 0);
        A03 = 32;
        A0C = Executors.newSingleThreadExecutor();
        A0B = Executors.newFixedThreadPool(5);
        A0D = new AtomicBoolean();
        A0E = new AtomicBoolean();
        A0A = Executors.newCachedThreadPool(new ThreadFactoryC0734Lr());
        A09 = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    }

    public ExecutorC0736Lt(String str, int i) {
        this.A02 = i;
        int CPU_COUNT = Runtime.getRuntime().availableProcessors();
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(Math.max(2, Math.min(CPU_COUNT - 1, 4)), (CPU_COUNT * 2) + 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactoryC0735Ls(this, str));
    ...
    public static void A05(Context context) {
        A0D.set(C0653Ih.A2K(context));
        A0E.set(C0653Ih.A2J(context));
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (ExecutorC0736Lt.class) {
            int i = A03;
            if (reservedExecutorQueueSize == i) {
                ...
                if (c1063YmA00 != null) {
                    c1063YmA00.A07().A9a(A00(42, 7, 27), C8A.A1d, new C8B(A00(21, 21, 46), A00(14, 7, 25) + i));
                }
            }
        }
