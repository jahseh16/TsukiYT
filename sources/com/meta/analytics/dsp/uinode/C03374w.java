...
public final class C03374w {
    ...
    public final /* synthetic */ C0547Eb A08;
    ...
    public C03374w(C0547Eb c0547Eb) {
        this.A08 = c0547Eb;
        ...
        if (this.A08.A04.A0A() && (iA04 = this.A08.A00.A04(i)) > 0) {
            ...
            if (iA04 < offsetPosition) {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    AnonymousClass56 anonymousClass562 = this.A02.get(i10);
    ...
    private final AnonymousClass56 A02(int i, boolean z) {
        ...
        if (!z && (viewA08 = this.A08.A01.A08(i)) != null) {
            AnonymousClass56 anonymousClass56A0F = C0547Eb.A0F(viewA08);
        ...
        for (int i8 = 0; i8 < size2; i8++) {
            AnonymousClass56 anonymousClass562 = this.A06.get(i8);
    ...
    */
    private final com.meta.analytics.dsp.uinode.AnonymousClass56 A03(long r8, int r10, boolean r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C03374w.A03(long, int, boolean):com.facebook.ads.redexgen.X.56");
    }
    ...
    */
    public final com.meta.analytics.dsp.uinode.AnonymousClass56 A0I(int r21, boolean r22, long r23) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C03374w.A0I(int, boolean, long):com.facebook.ads.redexgen.X.56");
    }
    ...
    public final void A0M() {
        int size = this.A06.size();
        for (int i = 0; i < size; i++) {
            C03314p c03314p = (C03314p) this.A06.get(i).A0H.getLayoutParams();
            if (c03314p != null) {
                c03314p.A01 = true;
            }
        }
    ...
    public final void A0U(AbstractC03184c abstractC03184c, AbstractC03184c abstractC03184c2, boolean z) {
        A0P();
        A0H().A08(abstractC03184c, abstractC03184c2, z);
    }
    ...
    */
    public final void A0X(com.meta.analytics.dsp.uinode.AnonymousClass56 r10) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C03374w.A0X(com.facebook.ads.redexgen.X.56):void");
    }
