...
public final class RunnableC0630Hk implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public RunnableC0630Hk(Handler handler) {
        this.A04 = handler;
    }
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C0628Hi(IF.A0P(A04(0, 67, 61), Boolean.valueOf(zEglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static void A06(int[] iArr) {
        ...
        if (iGlGetError == 0) {
            ...
            throw new C0628Hi(A04(181, 29, 20) + Integer.toHexString(iGlGetError));
        }
    }

    public final SurfaceTexture A07() {
        return (SurfaceTexture) AbstractC0620Ha.A01(this.A00);
    }
    ...
    public final void A08() {
        ...
        if (eGLSurface != null) {
            ...
            if (strArr[2].length() == strArr[4].length()) {
                ...
                if (!eGLSurface.equals(eGLSurface2)) {
