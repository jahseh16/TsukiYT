...
public abstract class C3T {
    ...
    static {
        if (Build.VERSION.SDK_INT >= 26) {
            A00 = new C02170d() { // from class: com.facebook.ads.redexgen.X.0U
            };
            return;
        }
    ...
    public static C03013k A05(View view, C03013k c03013k) {
        return A00.A08(view, c03013k);
    }

    public static C03013k A06(View view, C03013k c03013k) {
        return A00.A09(view, c03013k);
    }
