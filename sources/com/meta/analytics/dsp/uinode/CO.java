...
public abstract class CO {
    ...
    public static Pair<long[], long[]> A05(XT xt) {
        ...
        for (int i = 0; i < iA0H; i++) {
            jArr[i] = iA01 == 1 ? c0645Hz.A0N() : c0645Hz.A0M();
            jArr2[i] = iA01 == 1 ? c0645Hz.A0L() : c0645Hz.A08();
            if (c0645Hz.A0U() != 1) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static CN A0B(C0645Hz c0645Hz) {
        long jA0M;
        c0645Hz.A0Y(8);
        int iA01 = CJ.A01(c0645Hz.A08());
        c0645Hz.A0Z(iA01 == 0 ? 8 : 16);
        ...
        if (z) {
            ...
            jA0M = iA01 == 0 ? c0645Hz.A0M() : c0645Hz.A0N();
            if (jA0M == 0) {
                jA0M = -9223372036854775807L;
            }
        }
        ...
        int iA083 = c0645Hz.A08();
        c0645Hz.A0Z(4);
        int iA084 = c0645Hz.A08();
        int iA085 = c0645Hz.A08();
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static C0511Ce A0C(XT xt, XS xs, long j, DrmInitData drmInitData, boolean z, boolean z5) throws C04539v {
        long j4 = j;
        ...
        A01[7] = "VRI";
        long jA0F = j4 == -9223372036854775807L ? -9223372036854775807L : IF.A0F(j4, 1000000L, jA04);
        XT xtA062 = xtA06.A06(CJ.A0i).A06(CJ.A17);
        Pair<Long, String> pairA06 = A06(xtA06.A07(CJ.A0d).A00);
        CM cmA0A = A0A(xtA062.A07(CJ.A1B).A00, cnA0B.A00, cnA0B.A01, (String) pairA06.second, drmInitData, z5);
        long[] jArr = null;
        long[] jArr2 = null;
        if (!z) {
        ...
        return new C0511Ce(cnA0B.A00, iA02, ((Long) pairA06.first).longValue(), jA04, jA0F, cmA0A.A02, cmA0A.A01, cmA0A.A03, cmA0A.A00, jArr, jArr2);
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static C0512Cf A0D(C0645Hz c0645Hz, int i, int i5, String str) {
        int i8 = i + 8;
        while (i8 - i < i5) {
            c0645Hz.A0Y(i8);
            int iA08 = c0645Hz.A08();
            if (c0645Hz.A08() == CJ.A1H) {
                int iA01 = CJ.A01(c0645Hz.A08());
                c0645Hz.A0Z(1);
                int i10 = 0;
                int i11 = 0;
                ...
                if (z && iA0E2 == 0) {
                    ...
                    c0645Hz.A0c(bArr2, 0, iA0E3);
                }
                return new C0512Cf(z, str, iA0E2, bArr, i10, i11, bArr2);
            }
            i8 += iA08;
        }
        return null;
    ...
    */
    public static com.meta.analytics.dsp.uinode.C0514Ch A0E(com.meta.analytics.dsp.uinode.C0511Ce r35, com.meta.analytics.dsp.uinode.XT r36, com.meta.analytics.dsp.uinode.C0506Bw r37) throws com.meta.analytics.dsp.uinode.C04539v {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0K(com.meta.analytics.dsp.uinode.C0645Hz r23, int r24, int r25, int r26, int r27, int r28, com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmInitData r29, com.meta.analytics.dsp.uinode.CM r30, int r31) throws com.meta.analytics.dsp.uinode.C04539v {
        /*
    ...
    public static float A00(C0645Hz c0645Hz, int i) {
        c0645Hz.A0Y(i + 8);
        int vSpacing = c0645Hz.A0H();
        int hSpacing = c0645Hz.A0H();
        return vSpacing / hSpacing;
    }

    public static int A01(C0645Hz c0645Hz) {
        int iA0E = c0645Hz.A0E();
        int size = iA0E & 127;
        while ((iA0E & 128) == 128) {
            iA0E = c0645Hz.A0E();
    ...
    public static int A02(C0645Hz c0645Hz) {
        c0645Hz.A0Y(16);
        int iA08 = c0645Hz.A08();
        int trackType = A05;
        if (iA08 == trackType) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static int A03(com.meta.analytics.dsp.uinode.C0645Hz r7, int r8, int r9) {
        /*
            int r3 = r7.A06()
        L4:
            int r0 = r3 - r8
        ...
        L29:
            ...
            com.meta.analytics.dsp.uinode.AbstractC0620Ha.A05(r4, r0)
            int r1 = r7.A08()
    ...
    public static long A04(C0645Hz c0645Hz) {
        int fullAtom = 8;
        c0645Hz.A0Y(8);
        if (CJ.A01(c0645Hz.A08()) != 0) {
            fullAtom = 16;
        }
        c0645Hz.A0Z(fullAtom);
    ...
    public static Pair<Long, String> A06(C0645Hz c0645Hz) {
        c0645Hz.A0Y(8);
        int fullAtom = CJ.A01(c0645Hz.A08());
        int languageCode = fullAtom == 0 ? 8 : 16;
        c0645Hz.A0Z(languageCode);
    ...
    public static Pair<String, byte[]> A07(C0645Hz c0645Hz, int i) {
        c0645Hz.A0Y(i + 8 + 4);
        c0645Hz.A0Z(1);
        A01(c0645Hz);
        c0645Hz.A0Z(2);
        ...
        c0645Hz.A0Z(1);
        A01(c0645Hz);
        String mimeType = AbstractC0638Hs.A03(c0645Hz.A0E());
        ...
        c0645Hz.A0Z(12);
        c0645Hz.A0Z(1);
        int flags = A01(c0645Hz);
        byte[] bArr = new byte[flags];
        c0645Hz.A0c(bArr, 0, flags);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static android.util.Pair<java.lang.Integer, com.meta.analytics.dsp.uinode.C0512Cf> A08(com.meta.analytics.dsp.uinode.C0645Hz r10, int r11, int r12) {
        /*
    ...
    public static Pair<Integer, C0512Cf> A09(C0645Hz c0645Hz, int i, int i5) {
        Pair<Integer, C0512Cf> pairA08;
        int iA06 = c0645Hz.A06();
        while (true) {
            int i8 = iA06 - i;
            if (A01[3].charAt(18) == 'y') {
            ...
            if (i8 < i5) {
                c0645Hz.A0Y(iA06);
                int iA08 = c0645Hz.A08();
                AbstractC0620Ha.A05(iA08 > 0, A0I(574, 32, 87));
                int childAtomSize = c0645Hz.A08();
                int childPosition = CJ.A14;
                if (childAtomSize == childPosition && (pairA08 = A08(c0645Hz, iA06, iA08)) != null) {
                    return pairA08;
                }
                iA06 += iA08;
            } else {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.meta.analytics.dsp.uinode.CM A0A(com.meta.analytics.dsp.uinode.C0645Hz r23, int r24, int r25, java.lang.String r26, com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmInitData r27, boolean r28) throws com.meta.analytics.dsp.uinode.C04539v {
        /*
    ...
    public static Metadata A0F(XS xs, boolean z) {
        ...
        c0645Hz.A0Y(8);
        while (c0645Hz.A04() >= 8) {
            int atomPosition = c0645Hz.A06();
            int iA08 = c0645Hz.A08();
            if (c0645Hz.A08() == CJ.A0h) {
                c0645Hz.A0Y(atomPosition);
                return A0H(c0645Hz, atomPosition + iA08);
            }
            c0645Hz.A0Z(iA08 - 8);
        }
        return null;
    ...
    public static Metadata A0G(C0645Hz c0645Hz, int i) {
        c0645Hz.A0Z(8);
        ArrayList arrayList = new ArrayList();
        while (c0645Hz.A06() < i) {
            Id3Frame id3FrameA04 = CW.A04(c0645Hz);
            if (id3FrameA04 != null) {
    ...
    public static Metadata A0H(C0645Hz c0645Hz, int i) {
        c0645Hz.A0Z(12);
        while (true) {
            int iA06 = c0645Hz.A06();
            if (A01[2].charAt(2) == 't') {
            ...
            strArr[5] = "e";
            if (iA06 < i) {
                int iA062 = c0645Hz.A06();
                int atomType = c0645Hz.A08();
                int atomSize = c0645Hz.A08();
                int atomPosition = CJ.A0a;
                if (atomSize == atomPosition) {
                    c0645Hz.A0Y(iA062);
                    return A0G(c0645Hz, iA062 + atomType);
                }
                int atomPosition2 = atomType - 8;
                c0645Hz.A0Z(atomPosition2);
            } else {
                return null;
            }
        }
    ...
    public static void A0L(C0645Hz c0645Hz, int i, int i5, int i8, int i10, String str, CM cm) throws C04539v {
        String strA0I;
        c0645Hz.A0Y(i5 + 8 + 8);
        ...
        cm.A02 = Format.A09(Integer.toString(i10), strA0I, null, -1, 0, str, -1, null, j, listSingletonList);
    }

    public static void A0M(C0645Hz c0645Hz, int i, int childPosition, int i5, int i8, String mimeType, boolean z, DrmInitData drmInitData, CM cm, int i10) throws C04539v {
        int iA0I;
        int iA0F;
        int iA03;
        DrmInitData drmInitData2 = drmInitData;
        int childPosition2 = i;
        c0645Hz.A0Y(childPosition + 8 + 8);
        int quickTimeSoundDescriptionVersion = 0;
        if (z) {
            quickTimeSoundDescriptionVersion = c0645Hz.A0I();
            c0645Hz.A0Z(6);
        } else {
            c0645Hz.A0Z(8);
        }
        if (quickTimeSoundDescriptionVersion == 0 || quickTimeSoundDescriptionVersion == 1) {
            ...
            c0645Hz.A0Z(16);
            iA0F = (int) Math.round(c0645Hz.A03());
            iA0I = c0645Hz.A0H();
            c0645Hz.A0Z(20);
        } else {
            return;
        }
        int channelCount = c0645Hz.A06();
        if (childPosition2 == CJ.A0R) {
            Pair<Integer, C0512Cf> pairA09 = A09(c0645Hz, childPosition, i5);
            if (A01[2].charAt(2) == 't') {
                throw new RuntimeException();
            }
            A01[1] = "rXJd0uQKTdLTB";
            if (pairA09 != null) {
                ...
                if (drmInitData2 == null) {
                    ...
                    drmInitData2 = drmInitData2.A02(((C0512Cf) pairA09.second).A02);
                }
                cm.A03[i10] = (C0512Cf) pairA09.second;
            }
            c0645Hz.A0Y(channelCount);
        }
        String strA0I = null;
        ...
        while (channelCount - childPosition < i5) {
            c0645Hz.A0Y(channelCount);
            int childAtomSize = c0645Hz.A08();
            AbstractC0620Ha.A05(childAtomSize > 0, A0I(574, 32, 87));
            int atomType4 = c0645Hz.A08();
            if (atomType4 == CJ.A0T || (z && atomType4 == CJ.A1W)) {
                if (atomType4 == CJ.A0T) {
                    iA03 = channelCount;
                } else {
                    iA03 = A03(c0645Hz, channelCount, childAtomSize);
                }
                if (iA03 != -1) {
                    Pair<String, byte[]> pairA07 = A07(c0645Hz, iA03);
                    strA0I = (String) pairA07.first;
                    bArr = (byte[]) pairA07.second;
                    if (A0I(467, 15, 17).equals(strA0I)) {
                        Pair<Integer, Integer> pairA03 = AbstractC0624He.A03(bArr);
                ...
                strArr[5] = "M";
                if (atomType4 == i11) {
                    c0645Hz.A0Y(channelCount + 8);
                    cm.A02 = AQ.A07(c0645Hz, Integer.toString(i8), mimeType, drmInitData2);
                } else if (atomType4 == CJ.A0I) {
                    c0645Hz.A0Y(channelCount + 8);
                    cm.A02 = AQ.A08(c0645Hz, Integer.toString(i8), mimeType, drmInitData2);
                } else if (atomType4 == CJ.A0H) {
                    cm.A02 = Format.A07(Integer.toString(i8), strA0I, null, -1, -1, iA0I, iA0F, null, drmInitData2, 0, mimeType);
                } else if (atomType4 == CJ.A06) {
                    bArr = new byte[childAtomSize];
                    c0645Hz.A0Y(channelCount);
                    c0645Hz.A0c(bArr, 0, childAtomSize);
                }
            }
        ...
        cm.A02 = Format.A06(Integer.toString(i8), strA0I, null, -1, -1, iA0I, iA0F, atomType5, bArr != null ? Collections.singletonList(bArr) : null, drmInitData2, 0, mimeType);
    }

    public static boolean A0N(long[] jArr, long j, long j4, long j7) {
        int length = jArr.length - 1;
        int latestDelayIndex = IF.A06(3, 0, length);
        int lastIndex = jArr.length;
        return jArr[0] <= j4 && j4 < jArr[latestDelayIndex] && jArr[IF.A06(lastIndex - 3, 0, length)] < j7 && j7 <= j;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static byte[] A0O(com.meta.analytics.dsp.uinode.C0645Hz r7, int r8, int r9) {
        /*
            int r3 = r8 + 8
        L2:
            int r4 = r3 - r8
