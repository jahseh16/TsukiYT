...
public final class DR {
    ...
    */
    ...
    static {
        ...
        sparseIntArray2.put(31, NotificationCompat.FLAG_GROUP_SUMMARY);
        ...
        map.put(A07(361, 3, 70), Integer.valueOf(NotificationCompat.FLAG_LOCAL_ONLY));
        map.put(A07(313, 4, 79), Integer.valueOf(UserMetadata.MAX_ATTRIBUTE_SIZE));
        ...
        map.put(A07(233, 3, 93), Integer.valueOf(NotificationCompat.FLAG_GROUP_SUMMARY));
    ...
    */
    ...
    public static Pair<Integer, Integer> A03(String str, String[] strArr) {
        ...
        try {
            ...
            int i5 = A03.get(numValueOf2.intValue(), -1);
            if (i5 == -1) {
    ...
    */
    ...
    public static synchronized List<DG> A09(String str, boolean z) throws DP {
        ...
        DQ c1007Wi = IF.A02 >= 21 ? new C1007Wi(z) : new C1008Wj();
        ArrayList<DG> arrayListA08 = A08(r4, c1007Wi, str);
        if (z && arrayListA08.isEmpty() && 21 <= IF.A02 && IF.A02 <= 23) {
            c1007Wi = new C1008Wj();
            arrayListA08 = A08(r4, c1007Wi, str);
        ...
        if (A07(922, 14, 50).equals(str)) {
            ...
            arrayListA08.addAll(A08(key, c1007Wi, str));
        }
        A0B(arrayListA08);
