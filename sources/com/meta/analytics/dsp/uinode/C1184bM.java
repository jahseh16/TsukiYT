...
public final class C1184bM implements InterfaceC02280p, InterfaceC02461h {
    ...
    private int A00() {
        ...
        EnumC0781Nm enumC0781NmA02 = A02();
        if (enumC0781NmA02 == EnumC0781Nm.A06) {
            return -1;
        }
        if (enumC0781NmA02 == EnumC0781Nm.A04) {
            switch (rotation) {
                case 2:
                case 3:
                    return 8;
    ...
    private void A06(Intent intent) {
        ...
        c02471i.A0I(intent, rewardData, Q7.A03(rewardData, this.A0A, this.A06));
    }

    private final void A07(C1064Yn c1064Yn, AnonymousClass10 anonymousClass10, C02601v c02601v, EnumSet<CacheFlag> enumSet, String str) {
        C02471i c02471i = new C02471i(c1064Yn, c02601v, this, str);
        C1F c1fA0D = c02471i.A0D();
        if (C0653Ih.A0q(c1064Yn)) {
            boolean z = c1fA0D instanceof AbstractC1167b5;
            String[] strArr = A0C;
            if (strArr[3].charAt(11) == strArr[7].charAt(11)) {
                A0C[2] = "TkuXboGIr4gI6uBXxoSPLVsF8oObr4N9";
                if (z && AbstractC02250l.A06(this.A05, AbstractC02250l.A01(c1064Yn, c02601v.A03(), ((AbstractC1167b5) c1fA0D).A12()), c1064Yn.A09())) {
                    this.A05.A0E().A4K();
        ...
        this.A04 = c02471i;
        A08(c02471i.A0E());
        c02471i.A0J(c1064Yn, enumSet);
    }

    private void A08(KB kb) {
        if (kb.equals(KB.A04)) {
            this.A05.A0E().AGG(EnumC02180e.A04);
            return;
        }
        if (kb.equals(KB.A0A)) {
            this.A05.A0E().AGG(EnumC02180e.A03);
            return;
        }
        if (kb.equals(KB.A0B)) {
            this.A05.A0E().AGG(EnumC02180e.A0A);
            return;
        }
        if (kb.equals(KB.A0D)) {
            this.A05.A0E().AGG(EnumC02180e.A0C);
            return;
        }
        if (kb.equals(KB.A0C)) {
            this.A05.A0E().AGG(EnumC02180e.A0B);
            return;
        }
        ...
        if (this.A04.A0K()) {
            this.A05.A0E().AGG(EnumC02180e.A07);
        } else if ((A09() instanceof AbstractC1167b5) && this.A04.A0L((AbstractC1167b5) A09())) {
            this.A05.A0E().AGG(EnumC02180e.A09);
        } else {
            this.A05.A0E().AGG(EnumC02180e.A08);
        }
    }
    ...
    public final void A0A(C1064Yn c1064Yn, AnonymousClass10 anonymousClass10, C02601v c02601v, EnumSet<CacheFlag> enumSet, String str, String str2, RewardData rewardData) {
        this.A05 = c1064Yn;
        this.A02 = anonymousClass10;
        String strA02 = c02601v.A02();
        this.A08 = strA02;
        this.A06 = strA02 != null ? strA02.split(A03(107, 1, 19))[0] : A03(0, 0, 5);
        this.A00 = c02601v.A00();
        this.A07 = str2;
        this.A01 = rewardData;
        A07(c1064Yn, anonymousClass10, c02601v, enumSet, str);
    }
    ...
    public final boolean A0B() {
        ...
        AdActivityIntent adActivityIntentA04 = C0702Kj.A04(this.A05);
        ...
        try {
            ...
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!C0702Kj.A0J(this.A05, adActivityIntentA04)) {
                    this.A05.A0E().AF0();
            ...
            C0702Kj.A0A(this.A05, adActivityIntentA04);
            return true;
        } catch (C0700Kh e4) {
