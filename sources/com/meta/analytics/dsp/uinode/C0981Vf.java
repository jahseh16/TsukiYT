...
public final class C0981Vf extends HO {
     ...
     */
    public static C0981Vf A00(File file, HS hs) {
        ...
        return new C0981Vf(strA0C, Long.parseLong(matcher.group(2)), length, Long.parseLong(matcher.group(3)), file);
    }

    public static String A06(int i, int i5, int i8) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A00, i, i + i5);
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            bArrCopyOfRange[i10] = (byte) ((bArrCopyOfRange[i10] - i8) - 9);
        }
    ...
    public C0981Vf(String str, long j, long j4, long j7, File file) {
        super(str, j, j4, j7, file);
    }

    public static C0981Vf A01(String str, long j) {
        return new C0981Vf(str, j, -1L, -9223372036854775807L, null);
    }

    public static C0981Vf A02(String str, long j) {
        return new C0981Vf(str, j, -1L, -9223372036854775807L, null);
    }

    public static C0981Vf A03(String str, long j, long j4) {
        return new C0981Vf(str, j, j4, -9223372036854775807L, null);
    }

    public static File A04(File file, int i, long j, long j4) {
        StringBuilder sbAppend = new StringBuilder().append(i);
        String strA06 = A06(0, 1, 9);
        return new File(file, sbAppend.append(strA06).append(j).append(strA06).append(j4).append(A06(1, 7, 12)).toString());
    }
    ...
    public final C0981Vf A08(int i) {
        AbstractC0620Ha.A04(this.A05);
        long jCurrentTimeMillis = System.currentTimeMillis();
        return new C0981Vf(this.A04, this.A02, this.A01, jCurrentTimeMillis, A04(this.A03.getParentFile(), i, this.A02, jCurrentTimeMillis));
    }
}
