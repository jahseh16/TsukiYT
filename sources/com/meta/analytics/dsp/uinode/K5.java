...
public final class K5 {
     ...
     */
    private C0966Up A01(C1064Yn c1064Yn, JSONObject jSONObject, long j) throws JSONException {
        ...
        if (jSONObject2.has(strA042)) {
            ...
            while (true) {
                ...
                if (strArr[5].charAt(22) == strArr[0].charAt(22)) {
                    ...
                    JC.A06(c1064Yn, jSONObject3, j, null);
                    ...
                    if (jSONObjectOptJSONObject != null) {
                        ...
                        c1064Yn.A0E().A4t(AdErrorType.UNKNOWN_ERROR.getErrorCode(), A04(67, 18, 82));
                    }
                    i++;
                } else {
        ...
        return new C0966Up(c8s, jSONObject.optString(A04(29, 18, 1)));
    }
    ...
    public static void A05() {
        A01 = new byte[]{116, 113, 74, 103, 112, 101, 122, 103, 97, 124, 123, 114, 74, 118, 122, 123, 115, 124, 114, 49, 52, 49, 32, 36, 53, 34, 47, 42, 61, 23, 24, 41, 0, 23, 26, 31, 18, 23, 2, 31, 25, 24, 41, 3, 3, 31, 18, 96, 107, 98, 106, 109, 92, 115, 98, 113, 98, 110, 112, 23, 27, 16, 17, 103, 98, 119, 98, 65, 68, 81, 68, 106, 71, 79, 64, 70, 81, 5, 76, 86, 5, 75, 80, 73, 73, 44, 41, 60, 41, 23, 37, 39, 44, 45, 36, 23, 60, 49, 56, 45, 68, 67, 76, 127, 84, 69, 83, 84, 127, 67, 79, 78, 70, 73, 71, 85, 84, 87, 88, 95, 88, 69, 88, 94, 95, 74, 93, 93, 64, 93, 3, 0, 4, 17, 16, 23, 0, 58, 6, 10, 11, 3, 12, 2, 15, 7, 17, 17, 3, 5, 7, 73, 85, 88, 90, 92, 84, 92, 87, 77, 74, 89, 95, 76, 78, 70, 72, 95, 94, 69, 72, 65, 84};
    }
    ...
    private C0965Uo A02(JSONObject jSONObject) {
        return new C0965Uo(jSONObject.optString(A04(144, 7, 21), A04(0, 0, 87)), jSONObject.optInt(A04(59, 4, 3), 0), null);
    }

    private C0965Uo A03(JSONObject jSONObject) {
        try {
            ...
            return new C0965Uo(jSONObject.optString(A04(144, 7, 21), A04(0, 0, 87)), jSONObject.optInt(A04(59, 4, 3), 0), new C8S(c8tA00, adReportingConfig, definition.optString(A04(0, 19, 98)), null));
    ...
    */
    public final com.meta.analytics.dsp.uinode.K7 A06(com.meta.analytics.dsp.uinode.C1064Yn r8, java.lang.String r9, long r10) throws org.json.JSONException {
        /*
            r7 = this;
