...
public final class M9 extends LinearLayout {
    ...
    public M9(C1064Yn c1064Yn, int i) {
        super(c1064Yn);
        this.A03 = c1064Yn;
        this.A02 = C2T.A00(c1064Yn.A01());
        setOrientation(0);
        this.A00 = new ImageView(c1064Yn);
        this.A01 = new ImageView(c1064Yn);
        A04(i);
    }

    private void A04(int i) {
        EnumC0739Lw enumC0739Lw;
        A05(this.A00, EnumC0739Lw.AD_CHOICES_ICON);
        if (i == 2) {
            int i5 = A05;
            ...
            AbstractC0731Lo.A0X(textView, true, 13);
        ...
        if (i == 1) {
            enumC0739Lw = EnumC0739Lw.AN_INFO_ICON;
        } else {
            enumC0739Lw = EnumC0739Lw.DEFAULT_INFO_ICON;
        }
        A05(this.A01, enumC0739Lw);
        int i11 = A06;
    ...
    public static void A05(ImageView imageView, EnumC0739Lw enumC0739Lw) {
        imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        imageView.setImageBitmap(AbstractC0740Lx.A01(enumC0739Lw));
        imageView.setColorFilter(-1);
    }

    public void setAdDetails(C02391a c02391a, String str, JA ja, MC mc) {
        setOnClickListener(new M8(this, ja, mc, str, c02391a));
    }
