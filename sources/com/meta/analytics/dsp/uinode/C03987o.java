...
public final class C03987o {
    ...
    public final C1061Yk A03 = new C1061Yk(this);
    public final C1062Yl A02 = new C1062Yl(this);
    ...
    static {
        A07();
        StringBuilder sbAppend = new StringBuilder().append(A05(107, 14, 91)).append(C1061Yk.A02.A01);
        ...
        StringBuilder sbAppend4 = sbAppend3.append(strA053).append(C1061Yk.A01.A01).append(strA05);
        String strA054 = A05(136, 6, 111);
        A06 = sbAppend4.append(strA054).append(strA053).append(C1062Yl.A04.A01).append(strA05).append(strA054).append(strA053).append(C1062Yl.A05.A01).append(strA05).append(strA054).append(strA053).append(C1062Yl.A0A.A01).append(strA05).append(strA054).append(strA053).append(C1062Yl.A08.A01).append(strA05).append(strA054).append(strA053).append(C1062Yl.A07.A01).append(strA05).append(strA054).append(strA053).append(C1062Yl.A06.A01).append(strA05).append(strA054).append(strA053).append(C1062Yl.A03.A01).append(strA05).append(strA054).append(strA053).append(C1062Yl.A02.A01).append(A05(11, 6, 42)).append(strA054).append(A05(17, 6, 65)).append(strA052).append(A05(30, 4, 3)).append(strA054).append(strA053).append(C1062Yl.A09.A01).append(A05(0, 3, 78)).append(strA052).append(strA053).append(C1061Yk.A02.A01).append(A05(34, 10, 74)).append(strA054).append(strA053).append(C1062Yl.A08.A01).append(A05(7, 4, 98)).toString();
    ...
    public C03987o(C1063Ym c1063Ym) {
        this.A01 = c1063Ym;
    }

    private synchronized SQLiteDatabase A00() {
        if (this.A00 == null) {
            final C1063Ym c1063Ym = this.A01;
            this.A00 = new SQLiteOpenHelper(c1063Ym, this) { // from class: com.facebook.ads.redexgen.X.7p
                ...
                static {
                    A02();
                    A03 = C03997p.class.getSimpleName();
                }

                {
                    super(c1063Ym, A01(c1063Ym), (SQLiteDatabase.CursorFactory) null, 4);
                    if (this != null) {
                        this.A00 = this;
                        return;
                    }
                ...
                public static String A01(C1063Ym c1063Ym2) {
                    Locale locale = Locale.US;
                    Object[] objArr = {A00(0, 0, 95)};
                    String processName = A00(126, 8, 81);
                    String str = String.format(locale, processName, objArr);
                    if (!C0653Ih.A2C(c1063Ym2)) {
                        return str;
                    }
                    String defaultDbName = c1063Ym2.getPackageName();
                    String processName2 = ProcessUtils.getProcessName(c1063Ym2);
                ...
                public final void onCreate(SQLiteDatabase sQLiteDatabase) {
                    for (AbstractC04017s abstractC04017s : this.A00.A0M()) {
                        abstractC04017s.A07(sQLiteDatabase);
                    }
                }
                ...
                public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i5) {
                    for (AbstractC04017s abstractC04017s : this.A00.A0M()) {
                        abstractC04017s.A08(sQLiteDatabase);
                        abstractC04017s.A07(sQLiteDatabase);
                    }
                }
                ...
                public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i5) {
                    ...
                    if (i <= 3 && i5 >= 4) {
                        C03977m c03977m = C1062Yl.A02;
                        sQLiteDatabase.execSQL(A00(11, 30, 61) + c03977m.A01 + A00(0, 1, 125) + c03977m.A02 + A00(1, 10, 109));
                    }
                }
            };
        }
    ...
    public final int A08(int i) {
        ...
        lock.lock();
        try {
            int iDelete = A0E().delete(A05(136, 6, 111), C1062Yl.A02.A01 + A05(3, 4, 28), new String[]{String.valueOf(i - 1)});
            lock.unlock();
            return iDelete;
        } catch (Throwable th) {
            A08.unlock();
    ...
    public final <T> AsyncTask A0F(final AbstractC04007r<T> abstractC04007r, final AbstractC04278t<T> abstractC04278t) {
        Executor executor = ExecutorC0736Lt.A07;
        final C1063Ym c1063Ym = this.A01;
        return AbstractC0733Lq.A00(executor, new AsyncTask<Void, Void, T>(c1063Ym, abstractC04007r, abstractC04278t) { // from class: com.facebook.ads.redexgen.X.7n
            public static byte[] A04;
            ...
            public C7q A00;
            public final C1063Ym A01;
            public final AbstractC04007r<T> A02;
            public final AbstractC04278t<T> A03;

            public static String A01(int i, int i5, int i8) {
                byte[] bArrCopyOfRange = Arrays.copyOfRange(A04, i, i + i5);
                for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
                    int i11 = (bArrCopyOfRange[i10] - i8) - 116;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.8t != com.facebook.ads.internal.eventstorage.AdEventStorageCallback<T> */
            {
                this.A02 = abstractC04007r;
                this.A03 = abstractC04278t;
                this.A01 = c1063Ym;
            }
    ...
    public final AsyncTask A0G(String str, int i, String str2, double d4, double d5, String str3, Map<String, String> data, AbstractC04278t<String> abstractC04278t) {
        return A0F(new EP(this, str2, str, i, d4, d5, str3, data), abstractC04278t);
    }
    ...
    public final boolean A0L(String str) {
        ...
        try {
            ...
            sb.append(A05(121, 7, 95)).append(A05(136, 6, 111)).append(A05(44, 5, 67)).append(C1062Yl.A02.A01).append(A05(61, 1, 83)).append(C1062Yl.A02.A01).append(A05(56, 2, 49)).append(A05(49, 7, 11)).append(C1062Yl.A04.A01).append(A05(62, 2, 26));
    ...
    public final AbstractC04017s[] A0M() {
        return new AbstractC04017s[]{this.A03, this.A02};
    }
}
