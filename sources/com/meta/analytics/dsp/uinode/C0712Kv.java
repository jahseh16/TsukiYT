...
public final class C0712Kv {
    ...
    private int A00(C1064Yn c1064Yn) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c1064Yn.getPackageManager();
    ...
    public static Intent A02(C1064Yn c1064Yn, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.addCategory(A06(212, 33, 67));
        intentA01.addFlags(268435456);
        intentA01.putExtra(A06(288, 34, 25), c1064Yn.getPackageName());
        intentA01.putExtra(A06(494, 14, 75), false);
        if (C0653Ih.A1b(c1064Yn)) {
    ...
    public static Intent A03(C1064Yn c1064Yn, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.setPackage(A06(322, 19, 20));
        intentA01.putExtra(A06(259, 8, 22), c1064Yn.getPackageName());
        intentA01.putExtra(A06(614, 7, 91), true);
        return intentA01;
    }

    private final EnumC02200g A04(C1064Yn c1064Yn, Uri uri, String str, Map<String, String> extraData) throws C0700Kh {
        boolean zA05 = AbstractC0654Ii.A05(c1064Yn);
        boolean isInAppBrowserEnabled = A0E(uri);
        if (isInAppBrowserEnabled && zA05) {
            A0B(c1064Yn, uri, str, extraData);
            return EnumC02200g.A07;
        }
        c1064Yn.A0E().A8f(zA05);
        A09(c1064Yn, uri);
        return EnumC02200g.A06;
    }

    public static EnumC02200g A05(C0712Kv c0712Kv, C1064Yn c1064Yn, Uri uri, String str, Map<String, String> extraData) throws C0700Kh {
        ...
        if (!isGooglePlayWebLink && !z) {
            return c0712Kv.A04(c1064Yn, uri, str, extraData);
        }
        try {
            c0712Kv.A0A(c1064Yn, uri, str);
            return EnumC02200g.A02;
        } catch (C0710Kt unused) {
            return c0712Kv.A04(c1064Yn, uri, str, extraData);
        }
    }
    ...
    private void A09(C1064Yn c1064Yn, Uri uri) throws C0700Kh {
        C0702Kj.A0C(c1064Yn, A02(c1064Yn, uri));
    }

    private final void A0A(C1064Yn c1064Yn, Uri uri, String str) throws C0710Kt, C0700Kh {
        if (A0G(c1064Yn)) {
            boolean z = (c1064Yn.A0F().A01() && C0653Ih.A1F(c1064Yn)) || (C0653Ih.A1c(c1064Yn) && A0H(c1064Yn));
            if (!z) {
                boolean shouldTryToOpenSplitScreen = C0653Ih.A1y(c1064Yn);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = C0702Kj.A0D(c1064Yn, A03(c1064Yn, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean shouldTryToOpenSplitScreen3 = A0K(c1064Yn, uri, str);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent intentA02 = A02(c1064Yn, uri);
            intentA02.setPackage(A06(322, 19, 20));
            if (Build.VERSION.SDK_INT >= 24 && z) {
                intentA02.addFlags(268472320);
            }
            C0702Kj.A0C(c1064Yn, intentA02);
            return;
        }
        throw new C0710Kt();
    }

    private void A0B(C1064Yn c1064Yn, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent adActivityIntentA04 = C0702Kj.A04(c1064Yn);
        ...
        try {
            C0702Kj.A0A(c1064Yn, adActivityIntentA04);
        } catch (C0700Kh e4) {
            ...
            c1064Yn.A07().A9a(A06(168, 11, 15), C8A.A0D, new C8B(cause2));
            Log.e(A06(149, 17, 66), A06(50, 90, 123), cause2);
        }
    }

    public static void A0C(C0712Kv c0712Kv, C1064Yn c1064Yn, Uri uri, String str) {
        c0712Kv.A0L(c1064Yn, uri, str);
    }

    public static void A0D(C0712Kv c0712Kv, C1064Yn c1064Yn, Uri uri, String str) throws C0700Kh {
        A05(c0712Kv, c1064Yn, uri, str, null);
    }
    ...
    */
    public static boolean A0E(android.net.Uri r5) {
        /*
            ...
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C0712Kv.A01
            r0 = 1
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L61:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0712Kv.A0E(android.net.Uri):boolean");
    }

    private boolean A0F(C1064Yn c1064Yn) {
        if (!C0653Ih.A14(c1064Yn)) {
            return false;
        }
        int iA0D = C0653Ih.A0D(c1064Yn);
        if (A01[7].charAt(2) != 'a') {
            throw new RuntimeException();
        }
        A01[2] = "JMUKVK1n";
        int iA00 = A00(c1064Yn);
        return iA0D != -1 && iA00 != -1 && iA0D <= iA00 && Build.VERSION.SDK_INT >= 28;
    }

    private boolean A0G(C1064Yn c1064Yn) {
        Intent playStoreIntent = new Intent(A06(186, 26, 50), AbstractC0715Ky.A00(A06(548, 34, 87)));
        Iterator<ResolveInfo> it = c1064Yn.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        while (it.hasNext()) {
    ...
    public static boolean A0H(C1064Yn c1064Yn) {
        ...
        c1064Yn.A0E().AA7(zA0I, z, supportsSplitScreenMultiWindow, appResizingSupported, zA0C);
        return z;
    }

    public static boolean A0I(C1064Yn c1064Yn) {
        ...
        try {
            ...
            c1064Yn.A0E().AA5(e4.getMessage());
        }
        return false;
    }

    private boolean A0J(C1064Yn c1064Yn, Uri uri, String str) throws C0700Kh {
        try {
            Activity activityA0D = c1064Yn.A0D();
            String string = uri.toString();
            if (activityA0D != null && !TextUtils.isEmpty(string)) {
                Intent fbIntent = new Intent();
                if (C0653Ih.A15(c1064Yn)) {
                    String strA06 = AbstractC1167b5.A06(str);
                ...
                if (!C0702Kj.A0D(c1064Yn, fbIntent)) {
            ...
            c1064Yn.A0E().A9e(e4.getMessage());
            return false;
        }
    }

    private boolean A0K(C1064Yn c1064Yn, Uri uri, String str) throws C0700Kh {
        return A0F(c1064Yn) && A0J(c1064Yn, uri, str);
    }

    private final boolean A0L(C1064Yn c1064Yn, Uri uri, String str) {
        return C0702Kj.A0H(c1064Yn, uri, str);
    }

    public static boolean A0M(C0712Kv c0712Kv, C1064Yn c1064Yn, Uri uri, String str) {
        try {
            A0D(c0712Kv, c1064Yn, uri, str);
            return true;
        } catch (C0700Kh e4) {
            Throwable cause = e4.getCause();
            C0700Kh cause2 = e4;
            ...
            c1064Yn.A07().A9a(A06(168, 11, 15), C8A.A05, new C8B(cause2));
            return false;
        }
    }
}
