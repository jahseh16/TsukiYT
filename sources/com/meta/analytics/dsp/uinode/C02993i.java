...
public class C02993i {
    ...
    public void A04(ViewParent viewParent, View view, int i, int i5, int i8, int i10) {
        if (0 != 0) {
    ...
    public boolean A07(ViewParent viewParent, View view, float f3, float f4) {
        if (0 != 0) {
    ...
    public boolean A08(ViewParent viewParent, View view, float f3, float f4, boolean z) {
        if (0 != 0) {
