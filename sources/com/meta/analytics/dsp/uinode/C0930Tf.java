...
public final class C0930Tf extends OL implements OE {
    ...
    public C0930Tf(OP op, boolean z) {
        ...
        AbstractC0731Lo.A0R(relativeLayout, getAdContextWrapper());
        ...
        if (op.A0C() && !z) {
            ...
            c0835Po.A02(iA04, iA04);
            AbstractC0731Lo.A0G(1007, c0835Po);
            LinearLayout.LayoutParams layoutParams6 = new LinearLayout.LayoutParams(-1, -2);
            layoutParams6.setMargins(0, OL.A07, 0, 0);
            linearLayout.addView(c0835Po, layoutParams6);
            if (C0653Ih.A0z(op.A05())) {
                c0835Po.setOnClickListener(getCtaButton());
            }
        }
        ...
        View viewA02 = op.A02();
        if (viewA02 != null && (ofA09.A00 || C0653Ih.A16(getAdContextWrapper()))) {
            if (z) {
            ...
            if (ofA09.A00) {
                ...
                AbstractC0780Nl.A00(viewA02, C0653Ih.A17(getAdContextWrapper()), new OK(this));
            }
