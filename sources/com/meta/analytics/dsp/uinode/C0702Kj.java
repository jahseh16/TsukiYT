...
public final class C0702Kj {
    ...
    public static final Set<C1064Yn> A06;
    public static final AtomicReference<InterfaceC0709Ks> A07;
    public static final AtomicReference<InterfaceC0711Ku> A08;
    ...
    static {
        A07();
        Package r4 = C0702Kj.class.getPackage();
        A02 = r4;
        A04 = r4 + A06(40, 22, 38);
        A03 = r4 + A06(0, 19, 81);
    ...
    public static C1064Yn A03(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C1064Yn c1064Yn : A06) {
                String adId = c1064Yn.A0E().getId();
    ...
    public static AdActivityIntent A04(C1064Yn c1064Yn) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c1064Yn.getApplicationContext(), A05());
        adActivityIntent.putExtra(A03, c1064Yn.A0E().getId());
        A06.add(c1064Yn);
    ...
    public static void A08(Activity activity, Intent intent) throws C0700Kh {
        try {
            activity.startActivityForResult(intent, 0);
        } catch (ActivityNotFoundException e4) {
            throw new C0700Kh(e4);
        }
    }
    ...
    public static void A0A(C1064Yn c1064Yn, AdActivityIntent adActivityIntent) throws C0700Kh {
        Context launchContext;
        Context applicationContext = c1064Yn.getApplicationContext();
        if (C0653Ih.A25(c1064Yn) && (launchContext = c1064Yn.A0D()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0J(c1064Yn, adActivityIntent)) {
                    c1064Yn.A0E().AF0();
                    return;
                }
                return;
    ...
    public static boolean A0C(C1064Yn c1064Yn, Intent intent) throws C0700Kh {
        A07.get();
        return A0G(c1064Yn, intent, null);
    }

    public static boolean A0D(C1064Yn c1064Yn, Intent intent) throws C0700Kh {
        A07.get();
        if (0 == 0 || c1064Yn.A0D() == null) {
            return false;
        }
        c1064Yn.A0B();
        try {
            ...
            c1064Yn.A07().A9a(A06(90, 8, 122), C8A.A07, new C8B(e5));
            return false;
        }
    }

    public static boolean A0E(C1064Yn c1064Yn, Intent intent) throws C0700Kh {
        return A0F(c1064Yn, A00(intent), -1);
    }

    public static boolean A0F(C1064Yn c1064Yn, Intent intent, int i) throws C0700Kh {
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c1064Yn.A0D();
            }
            if (currentActivity != null) {
                if (i >= 0) {
    ...
    public static boolean A0G(C1064Yn c1064Yn, Intent intent, InterfaceC0709Ks interfaceC0709Ks) throws C0700Kh {
        if (A0B(intent, C0653Ih.A0V(c1064Yn))) {
            return false;
        }
        Context context = c1064Yn;
        String[] strArr = A01;
        if (strArr[6].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
        A01[1] = "W";
        Context startContext = c1064Yn.A0D();
        if (startContext != null) {
            context = startContext;
        } else {
            intent.addFlags(268435456);
        }
        if (interfaceC0709Ks != null && !A0B(intent, C0653Ih.A0X(c1064Yn))) {
            c1064Yn.A0B();
            try {
                ...
                c1064Yn.A07().A9a(A06(90, 8, 122), C8A.A08, new C8B(e5));
                return false;
            }
        }
        try {
            ...
            throw new C0700Kh(e6);
        }
    }

    public static boolean A0H(C1064Yn c1064Yn, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0I(c1064Yn, uri, str, null);
    }

    public static boolean A0I(C1064Yn c1064Yn, Uri uri, String str, InterfaceC0711Ku interfaceC0711Ku) throws ActivityNotFoundException {
        if (interfaceC0711Ku == null || c1064Yn.A0D() == null) {
            return false;
        }
    ...
    public static boolean A0J(C1064Yn c1064Yn, AdActivityIntent adActivityIntent) throws C0700Kh {
        return A0F(c1064Yn, A00(adActivityIntent), 0);
    }
}
