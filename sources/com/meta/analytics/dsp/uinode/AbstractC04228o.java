...
public abstract class AbstractC04228o {
    ...
    public static String A01(C03927f c03927f) {
        return WebSettings.getDefaultUserAgent(c03927f);
    }

    public static String A02(final C03927f c03927f) {
        FutureTask futureTask = new FutureTask(new Callable<String>() { // from class: com.facebook.ads.redexgen.X.8n
            ...
            public final String call() {
                String browserUserAgent = (String) AbstractC04228o.A04.get();
                if (browserUserAgent != null) {
                    return browserUserAgent;
                }
                WebView webView = new WebView(c03927f.getApplicationContext());
                ...
                if (userAgentString != null) {
                    AbstractC04228o.A04.set(userAgentString);
                }
                return userAgentString;
            }
        });
        for (int i = 0; i < 3; i++) {
            ExecutorC0725Li.A00(futureTask);
            try {
    ...
    public static String A03(C03927f c03927f, C8K c8k) {
        ...
        if (TextUtils.isEmpty(strA07)) {
            ...
            if (!andSet) {
                AnonymousClass89 anonymousClass89A07 = c03927f.A07();
                int i = C8A.A1Z;
    ...
    public static String A04(C03927f c03927f, boolean z) {
        if (c03927f == null) {
            return A00;
        }
        if (z) {
        ...
        long jA01 = AbstractC0652Ig.A01(c03927f);
        String strA00 = A00(143, 23, 90);
        String strA002 = A00(133, 10, 64);
        String userAgentString = A00(88, 28, 104);
        if (jA01 > 0) {
            SharedPreferences sharedPreferences = c03927f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c03927f), 0);
        ...
        if (jA01 > 0) {
            SharedPreferences sharedPreferences2 = c03927f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c03927f), 0);
    ...
    public static String A05(C8K c8k, C03927f c03927f) {
        if (AbstractC0652Ig.A04(c03927f)) {
            return A00(63, 5, 117) + A03(c03927f, c8k) + A00(39, 6, 127) + c8k.A06() + A00(45, 6, 121) + c8k.A04() + A00(38, 1, 111);
        }
        return A00(0, 0, 40);
    }

    public static String A06(C8K c8k, C03927f c03927f, boolean z) {
        return A04(c03927f, z) + A00(0, 38, 127) + c03927f.A04().A8H() + A00(57, 6, 54) + C8K.A04 + A00(38, 1, 111) + A05(c8k, c03927f) + A00(68, 5, 69) + c03927f.A04().A8I() + A00(51, 6, 77) + Locale.getDefault().toString() + A00(87, 1, 79);
    }

    public static void A09(C03927f c03927f, Throwable th) {
        c03927f.A07().A9a(A00(166, 8, 84), C8A.A2g, new C8B(th));
    }
}
