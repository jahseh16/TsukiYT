...
public final class SH extends FrameLayout implements QB {
    ...
    public SH(C1064Yn c1064Yn, NativeAd nativeAd, JR jr2, JS js, O3 o32, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1064Yn);
        ArrayList<View> arrayList = new ArrayList<>();
        this.A07 = arrayList;
        this.A05 = nativeAd;
        this.A04 = mediaView;
        QC qc = new QC(c1064Yn, nativeAd, jr2, o32, adOptionsView);
        this.A06 = qc;
        int i = A0C;
    ...
    */
    ...
    private void A02(int i) {
        AbstractC0731Lo.A0N(this.A04, i > A0B ? 0 : 8);
        AbstractC0731Lo.A0N(this.A03, i > A0A ? 0 : 8);
        AbstractC0731Lo.A0N(this.A00, i <= A09 ? 8 : 0);
    }

    public static void A03(int i, int i5, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            if (textView != null && textView.getVisibility() == 0) {
                int iA04 = AbstractC0731Lo.A04(textView, i5);
                ...
                i5 -= textView.getLineHeight() * iA04;
            }
        }
    }

    private void A04(JR jr2) {
    ...
    public final void onLayout(boolean z, int i, int i5, int i8, int i10) {
        ...
        if (textView3 != null) {
            ...
            if (top9 == 0) {
                ...
                textView4.layout(i, i12, i8, top10 + i12);
            }
        }
        ...
        if (textView5 != null) {
            ...
            textView5.layout(i + i13, (i10 - top11) - i13, i8 - i13, i10 - i13);
        }
    }
    ...
    public final void onMeasure(int i, int i5) {
        int emptySpace;
        A02(View.MeasureSpec.getSize(i5));
        A01();
        ...
        if (emptySpace2 == 0) {
            ...
            if (emptySpace3 == 0 || ((ZH) this.A04.getMediaViewApi()).A0N()) {
                ...
                float f3 = emptySpace4;
                int emptySpace5 = this.A04.getMediaWidth();
                float aspectRatio = f3 / emptySpace5;
