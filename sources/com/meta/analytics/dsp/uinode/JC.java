...
public abstract class JC {
    ...
    public static void A05(C1064Yn c1064Yn, String str, long j) {
        J2 adEventManager = c1064Yn.A09();
        JA ja = new JA(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 47), C0722Lf.A06(j));
        map.put(A00(12, 12, 118), C0722Lf.A04(j));
        ja.A04(J9.A0D, map);
    }

    public static void A06(C1064Yn c1064Yn, JSONObject jSONObject, long j, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c1064Yn, jSONObjectOptJSONObject, A02(c1064Yn, jSONArrayOptJSONArray), j, null);
        } else {
            ...
            A07(c1064Yn, jSONObjectOptJSONObject, map.get(str), j, str);
        }
    }

    public static void A07(C1064Yn c1064Yn, JSONObject jSONObject, List<String> list, long j, String str) {
        String strA00 = A00(0, 2, 62);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1064Yn, clientToken, j);
        }
    }
