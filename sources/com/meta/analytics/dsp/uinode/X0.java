...
public final class X0 implements InterfaceC0528Cy {
    ...
    public final C0645Hz A0C = new C0645Hz();
    ...
    public static Format A00(String str, D4 d4, D4 d42, D4 d43) {
        ...
        I0 i02 = new I0(d42.A01, 0, d42.A00);
        i02.A07(44);
        ...
        i02.A04();
        int iA044 = i02.A04();
        for (int i8 = i02.A0A() ? 0 : maxSubLayersMinus1; i8 <= maxSubLayersMinus1; i8++) {
            i02.A04();
            i02.A04();
            i02.A04();
        }
        ...
        if (i02.A0A() && i02.A0A()) {
            ...
            if (picWidthInLumaSamples == 255) {
                ...
                float[] fArr = AbstractC0641Hv.A04;
                String[] strArr2 = A0F;
                ...
                if (picWidthInLumaSamples < fArr.length) {
                    f3 = AbstractC0641Hv.A04[picWidthInLumaSamples];
                } else {
        ...
        if (A0F[3].length() != 6) {
            ...
            return Format.A03(str, strA01, null, -1, -1, picHeightInLumaSamples, confWinLeftOffset, -1.0f, listSingletonList, -1, f3, null);
        }
        String[] strArr5 = A0F;
    ...
    private void A03(long j, int i, int i5, long j4) {
        if (this.A05) {
            this.A03.A02(j, i);
        } else {
            this.A0A.A04(i5);
        ...
        if (this.A07.A04(i5)) {
            ...
            A0F[3] = "Yba7mj";
            this.A0C.A0b(this.A07.A01, AbstractC0641Hv.A02(d4.A01, this.A07.A00));
            this.A0C.A0Z(5);
            this.A0B.A02(j4, this.A0C);
        }
        if (this.A09.A04(i5)) {
            this.A0C.A0b(this.A09.A01, AbstractC0641Hv.A02(this.A09.A01, this.A09.A00));
            this.A0C.A0Z(5);
            this.A0B.A02(j4, this.A0C);
        }
    }

    private void A04(long j, int i, int i5, long j4) {
        if (this.A05) {
            this.A03.A03(j, i, i5, j4);
        } else {
            this.A0A.A01(i5);
            this.A08.A01(i5);
            this.A06.A01(i5);
    ...
    public final void A4R(C0645Hz c0645Hz) {
        while (true) {
            ...
            if (iA04 > 0) {
                ...
                long j = this.A01;
                int offset = c0645Hz.A04();
                this.A01 = j + ((long) offset);
                C4 c4 = this.A02;
                int offset2 = c0645Hz.A04();
                c4.AFR(c0645Hz, offset2);
                while (limit < iA07) {
                    int iA042 = AbstractC0641Hv.A04(bArr, limit, iA07, this.A0D);
                    if (iA042 == iA07) {
                        A07(bArr, limit, iA07);
                        return;
                    }
                    int bytesWrittenPastPosition = AbstractC0641Hv.A00(bArr, iA042);
                    int i = iA042 - limit;
                    if (i > 0) {
                        A07(bArr, limit, iA042);
                    }
                    int i5 = iA07 - iA042;
                    long j4 = this.A01 - ((long) i5);
                    int offset3 = i < 0 ? -i : 0;
    ...
    public final void A4p(InterfaceC0504Bu interfaceC0504Bu, DC dc) {
        dc.A05();
        this.A04 = dc.A04();
        C4 c4AGi = interfaceC0504Bu.AGi(dc.A03(), 2);
        this.A02 = c4AGi;
        this.A03 = new D3(c4AGi);
        this.A0B.A03(interfaceC0504Bu, dc);
    }
