...
public final class C03856x implements InterfaceC0629Hj, InterfaceC0887Ro {
    ...
    public final InterfaceC04047w A01;
    public final RK A02;
    public final InterfaceC0888Rp A03;
    public final C0896Rx A04;
    public final InterfaceC0897Ry A05;
    public final String A06;
    public final Map<EnumC0883Rk, C0642Hw> A09 = new HashMap();
    public final Map<EnumC0883Rk, AnonymousClass74> A08 = new HashMap();
    ...
    private void A04() throws Throwable {
        ...
        synchronized (this) {
            for (C0642Hw c0642Hw : this.A09.values()) {
                if (c0642Hw.A9C()) {
                    map.put(c0642Hw, S5.A04);
                } else {
                    map.put(c0642Hw, S5.A03);
                }
            }
            new AtomicReference();
            new AtomicReference();
            ...
            while (it.hasNext()) {
                it.next();
                InterfaceC0882Rj interfaceC0882Rj = null;
                if (interfaceC0882Rj.A9C()) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0629Hj
    public final synchronized InterfaceC0882Rj A4i(EnumC0883Rk enumC0883Rk) {
        if (enumC0883Rk.A02() != EnumC0885Rm.A03) {
            throw new IllegalArgumentException(A01(47, 59, 118));
        }
        if (this.A09.containsKey(enumC0883Rk)) {
            return this.A09.get(enumC0883Rk);
        }
        C0642Hw c0642Hw = new C0642Hw(enumC0883Rk);
        this.A09.put(enumC0883Rk, c0642Hw);
        Iterator<S2> it = this.A07.iterator();
        if (it.hasNext()) {
            it.next();
            throw new NullPointerException(A01(377, 24, 105));
        }
        String.format(Locale.US, A01(153, 35, 82), enumC0883Rk);
        return c0642Hw;
    }
    ...
    public C03856x(C03927f c03927f, InterfaceC04047w interfaceC04047w, RK rk, String str, InterfaceC0897Ry interfaceC0897Ry, C0896Rx c0896Rx, InterfaceC0886Rn interfaceC0886Rn) {
        this.A00 = c03927f;
        this.A01 = interfaceC04047w;
        this.A02 = rk;
        this.A06 = str;
        this.A05 = interfaceC0897Ry;
        this.A04 = c0896Rx;
        this.A03 = interfaceC0886Rn.A4V(this);
    }
    ...
    private Set<S1> A02(JSONObject jSONObject) throws JSONException {
        ...
        for (final C0642Hw c0642Hw : this.A09.values()) {
            switch (S0.A01[S6.A00(jSONObject2.getString(c0642Hw.A7A().A03())).ordinal()]) {
                case 1:
                    final JSONObject data = jSONObject3.getJSONObject(c0642Hw.A7A().A03()).getJSONObject(A01(312, 4, 17));
                    final JSONObject responseObject = jSONObject3.getJSONObject(c0642Hw.A7A().A03()).optJSONObject(A01(316, 11, 48));
                    hashSet.add(new HN(c0642Hw, data, responseObject) { // from class: com.facebook.ads.redexgen.X.70
                        ...
                        public final void A3Z(Map<InterfaceC0882Rj, S6> map, Map<SyncModifiableBundle, EnumC0892Rt> map2) {
                    ...
                    break;
                case 2:
                    hashSet.add(new HN(c0642Hw) { // from class: com.facebook.ads.redexgen.X.6z
                        {
                            S6 s62 = S6.A04;
                        }
                    });
        ...
        while (it.hasNext()) {
            ...
            switch (S0.A00[EnumC0892Rt.A00(jSONObject2.getString(anonymousClass74.A7A().A03())).ordinal()]) {
                case 1:
                    hashSet.add(new HT(anonymousClass74) { // from class: com.facebook.ads.redexgen.X.73
                        {
                            EnumC0892Rt enumC0892Rt = EnumC0892Rt.A04;
                        }
                    });
                    break;
                case 2:
                    hashSet.add(new HT(anonymousClass74) { // from class: com.facebook.ads.redexgen.X.6y
                        ...
                        {
                            EnumC0892Rt enumC0892Rt = EnumC0892Rt.A05;
                        }
    ...
    private JSONObject A03(Map<InterfaceC0882Rj, S5> map, Map<SyncModifiableBundle, EnumC0891Rs> map2, Map<SyncModifiableBundle, JSONObject> clientBundleData, Map<SyncModifiableBundle, JSONObject> clientBundleFingerprint) throws JSONException {
        String strA01;
        JSONObject jSONObject = new JSONObject();
        for (Map.Entry<InterfaceC0882Rj, S5> entry : map.entrySet()) {
            jSONObject.put(entry.getKey().A7A().A03(), entry.getValue().A02());
        }
        for (Map.Entry<SyncModifiableBundle, EnumC0891Rs> entry2 : map2.entrySet()) {
            entry2.getKey();
            InterfaceC0882Rj interfaceC0882Rj = null;
            jSONObject.put(interfaceC0882Rj.A7A().A03(), entry2.getValue().A02());
        }
        JSONObject jSONObject2 = new JSONObject();
        Iterator<Map.Entry<InterfaceC0882Rj, S5>> it = map.entrySet().iterator();
        while (true) {
            ...
            Map.Entry<InterfaceC0882Rj, S5> next = it.next();
            if (next.getValue() == S5.A04) {
                JSONObject bundles = new JSONObject();
                InterfaceC0882Rj key = next.getKey();
        ...
        for (Map.Entry<SyncModifiableBundle, EnumC0891Rs> entry3 : map2.entrySet()) {
            JSONObject updateData = new JSONObject();
            InterfaceC0882Rj key2 = entry3.getKey();
            JSONObject request2 = clientBundleFingerprint.get(entry3.getKey());
            updateData.put(strA01, request2);
            if (entry3.getValue() == EnumC0891Rs.A05) {
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0629Hj, com.meta.analytics.dsp.uinode.InterfaceC03967l
    public final void A5m() {
        this.A03.A5l();
    }

    @Override // com.meta.analytics.dsp.uinode.InterfaceC0887Ro
    public final void AFP() {
        ...
        try {
            if (!C0653Ih.A1e(this.A00) || this.A00.A03().A94()) {
                A04();
                return;
            }
