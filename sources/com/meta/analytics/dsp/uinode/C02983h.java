...
public class C02983h extends ViewGroup {
    public static byte[] A0s;
    public static String[] A0t = {"Pb5dMBpLoD8olSqqN3M1wt71s6WfJWWx", "mawes8eGWKEfT5kg0DwbKE", "yCX0UAcI", "nBGVAWTalDrx8Q3Q0HTp4hPpqgaJoZ5h", FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, "gKpLqM1fc4CgqUT7jB7tIrf4xsKdVFyY", "wKHjR3FqXT8StRIGs0zAAfuJmbbhub4H"};
    public static final int[] A0u;
    public static final Interpolator A0v;
    public static final C02973g A0w;
    ...
    public static String A08(int i, int i5, int i8) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0s, i, i + i5);
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    private final void A0J(int i, int i5, int i8) {
        int scrollX;
        int iAbs;
        if (getChildCount() == 0) {
        ...
        if (iAbs2 > 0) {
            ...
            strArr[5] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
            iAbs = Math.round(Math.abs(f3) * 1000.0f) * 4;
        } else {
            iAbs = (int) ((1.0f + (Math.abs(i10) / (this.A0M + (clientWidth * this.A01.A00(this.A00))))) * 100.0f);
        }
        ...
        while (true) {
            if (i11 >= childCount) {
                ...
                for (int i12 = 0; i12 < childCount2; i12++) {
                    ...
                    if (childAt.getVisibility() != 8 && ((c02913a = (C02913a) childAt.getLayoutParams()) == null || !c02913a.A05)) {
                        float f3 = paddingLeft;
                        String[] strArr = A0t;
                        if (strArr[4].length() == strArr[5].length()) {
                            A0t[1] = "11cm9STM7FlxGR3";
                            childAt.measure(View.MeasureSpec.makeMeasureSpec((int) (f3 * c02913a.A00), 1073741824), this.A0A);
                        }
                    }
                }
                return;
            ...
            if (childAt2.getVisibility() != 8) {
                C02913a c02913a2 = (C02913a) childAt2.getLayoutParams();
                if (A0t[1].length() == 12) {
                    break;
                }
                String[] strArr2 = A0t;
                strArr2[4] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                strArr2[5] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                if (c02913a2 != null && c02913a2.A05) {
                    int i13 = c02913a2.A04 & 7;
                    int i14 = c02913a2.A04 & 112;
                    int i15 = Integer.MIN_VALUE;
                    int i16 = Integer.MIN_VALUE;
                    boolean z = i14 == 48 || i14 == 80;
                    boolean z5 = i13 == 3 || i13 == 5;
                    if (z) {
                        i15 = 1073741824;
                    } else if (z5) {
                        i16 = 1073741824;
                    ...
                    if (c02913a2.width != -2) {
                        i15 = 1073741824;
                        i8 = c02913a2.width != -1 ? c02913a2.width : paddingLeft;
                    } else {
                        i8 = paddingLeft;
                    }
                    if (c02913a2.height != -2) {
                        i16 = 1073741824;
                        if (c02913a2.height != -1) {
                            i10 = c02913a2.height;
                            if (A0t[1].length() != 12) {
                    ...
                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i8, i15), View.MeasureSpec.makeMeasureSpec(i10, i16));
                    if (z) {
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    static {
        ...
        A0w = new Comparator<View>() { // from class: com.facebook.ads.redexgen.X.3g
            ...
            public final int compare(View view, View view2) {
                C02913a c02913a = (C02913a) view.getLayoutParams();
                C02913a c02913a2 = (C02913a) view2.getLayoutParams();
                if (c02913a.A05 != c02913a2.A05) {
                    return c02913a.A05 ? 1 : -1;
                }
                return c02913a.A02 - c02913a2.A02;
            }
        };
    }

    public C02983h(Context context) {
        super(context);
    ...
    private final float A00(float f3) {
        return (float) Math.sin((f3 - 0.5f) * 0.47123894f);
    }

    private int A01(int i, float f3, int i5, int i8) {
        if (Math.abs(i8) > this.A0H && Math.abs(i5) > this.A0K) {
            if (i5 <= 0) {
                i++;
            }
        } else {
        ...
        if (targetPage2 > 0) {
            ...
            return Math.max(i10, Math.min(i, targetPage4));
        }
        return i;
    }
    ...
    */
    private final com.meta.analytics.dsp.uinode.C3Z A04(int r4) {
        ...
        L19:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.A04(int):com.facebook.ads.redexgen.X.3Z");
    }
    ...
    */
    private final com.meta.analytics.dsp.uinode.C3Z A07(android.view.View r5) {
        ...
        L1f:
            r3 = 0
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C02983h.A0t
            r0 = 4
            r1 = r2[r0]
            r0 = 5
            r0 = r2[r0]
        ...
        L38:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.A07(android.view.View):com.facebook.ads.redexgen.X.3Z");
    }
    ...
    */
    private void A0A() {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.3a r0 = (com.meta.analytics.dsp.uinode.C02913a) r0
            boolean r0 = r0.A05
            if (r0 != 0) goto L1a
            r2.removeViewAt(r1)
            int r1 = r1 + (-1)
        ...
        L1d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.A0A():void");
    }
    ...
    private final void A0D() {
        ...
        this.A0K = (int) (400.0f * f3);
        this.A0J = viewConfiguration.getScaledMaximumFlingVelocity();
        this.A0V = new EdgeEffect(context);
        this.A0W = new EdgeEffect(context);
        this.A0H = (int) (25.0f * f3);
        this.A0C = (int) (2.0f * f3);
        this.A0E = (int) (16.0f * f3);
        C3T.A0B(this, new C1100Zz(this));
        if (C3T.A00(this) == 0) {
            C3T.A09(this, 1);
        }
        C3T.A0C(this, new C1101a0(this));
    }

    private void A0E(int i) {
        List<InterfaceC02933c> list = this.A0d;
        if (list != null) {
            int i5 = list.size();
    ...
    */
    private final void A0G(int r17) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.A0G(int):void");
    }

    private void A0H(int i, float f3, int i5) {
        List<InterfaceC02933c> list = this.A0d;
        if (list != null) {
            int i8 = list.size();
    ...
    private final void A0I(int childLeft, float f3, int i) {
        int iMax;
        if (this.A0D > 0) {
            ...
            if (A0t[1].length() != 12) {
                ...
                for (int childCount = 0; childCount < scrollX; childCount++) {
                    ...
                    C02913a c02913a = (C02913a) childAt.getLayoutParams();
                    if (c02913a.A05) {
                        int paddingRight2 = c02913a.A04;
                        ...
                        int i5 = (iMax + hgrav) - paddingRight7;
                        if (i5 != 0) {
        ...
        if (0 != 0) {
            ...
            for (int i8 = 0; i8 < childCount2; i8++) {
                ...
                if (!((C02913a) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
    ...
    private void A0K(int i, int i5, int i8, int i10) {
        if (i5 > 0) {
            ArrayList<C3Z> arrayList = this.A0r;
            String[] strArr = A0t;
            if (strArr[7].charAt(10) != strArr[0].charAt(10)) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                int paddingLeft = ((i - getPaddingLeft()) - getPaddingRight()) + i8;
                int widthWithMargin = getPaddingLeft();
                int i11 = i5 - widthWithMargin;
    ...
    private void A0M(int i, boolean z, int i5, boolean z5) {
        C3Z c3zA04 = A04(i);
        int clientWidth = 0;
        if (c3zA04 != null) {
    ...
    private final void A0N(int i, boolean z, boolean z5) {
        A0O(i, z, z5, 0);
    }
    ...
    */
    private final void A0O(int r7, boolean r8, boolean r9, int r10) {
        ...
        L91:
            ...
            goto L90
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.A0O(int, boolean, boolean, int):void");
    }
    ...
    */
    private void A0Q(com.meta.analytics.dsp.uinode.C3Z r13, int r14, com.meta.analytics.dsp.uinode.C3Z r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.A0Q(com.facebook.ads.redexgen.X.3Z, int, com.facebook.ads.redexgen.X.3Z):void");
    }

    private void A0R(boolean z) {
        boolean z5 = this.A0P == 2;
        if (z5) {
            setScrollingCacheEnabled(false);
    ...
    private boolean A0X(float f3) {
        boolean z = false;
        float f4 = this.A05 - f3;
        this.A05 = f3;
        float scrollX = getScrollX() + f4;
        int clientWidth = getClientWidth();
        float f5 = clientWidth * this.A02;
        ...
        if (scrollX < f5) {
            if (rightAbsolute) {
                this.A0V.onPull(Math.abs(f5 - scrollX) / clientWidth);
                z = true;
            }
            scrollX = f5;
    ...
    private final boolean A0Y(float f3, float f4) {
        if (f3 >= this.A0I || f4 <= 0.0f) {
            if (f3 > getWidth() - this.A0I) {
                if (A0t[2].length() == 14) {
                    throw new RuntimeException();
                }
                String[] strArr = A0t;
    ...
    private boolean A0Z(int i) {
        ...
        int i8 = c3zA03.A02;
        float f3 = ((i / clientWidth) - c3zA03.A00) / (c3zA03.A01 + (i5 / clientWidth));
        this.A0e = false;
        A0I(i8, f3, (int) (currentPage * f3));
        if (this.A0e) {
            return true;
        }
        throw new IllegalStateException(strA08);
    ...
    private final boolean A0d(View view, boolean z, int i, int i5, int i8) {
        if (view instanceof ViewGroup) {
            ViewGroup viewGroup = (ViewGroup) view;
            int i10 = view.getScrollX();
            int count = view.getScrollY();
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                View childAt = viewGroup.getChildAt(childCount);
                if (i5 + i10 >= childAt.getLeft() && i5 + i10 < childAt.getRight() && i8 + count >= childAt.getTop() && i8 + count < childAt.getBottom()) {
                    int left = (i5 + i10) - childAt.getLeft();
                    int i11 = i8 + count;
                    if (A0t[1].length() == 12) {
                        throw new RuntimeException();
                    }
                    ...
                    strArr[4] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                    strArr[5] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                    if (A0d(childAt, true, i, left, i11 - childAt.getTop())) {
                        return true;
                    }
                }
            }
    ...
    */
    public final void A0e() {
        ...
        L7d:
            ...
            java.util.Comparator<com.facebook.ads.redexgen.X.3Z> r0 = com.meta.analytics.dsp.uinode.C02983h.A0x
        ...
        L8b:
            ...
            com.facebook.ads.redexgen.X.3a r1 = (com.meta.analytics.dsp.uinode.C02913a) r1
            boolean r0 = r1.A05
            if (r0 != 0) goto L9e
            r0 = 0
            r1.A00 = r0
        ...
        La1:
            r11.A0N(r6, r4, r5)
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C02983h.A0t
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 14
        ...
        Lbc:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.A0e():void");
    }
    ...
    */
    public final void addFocusables(java.util.ArrayList<android.view.View> r7, int r8, int r9) {
        ...
        L57:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.addFocusables(java.util.ArrayList, int, int):void");
    }
    ...
    public final void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        C02913a c02913a = (C02913a) layoutParams;
        c02913a.A05 |= A0c(view);
        if (this.A0h) {
            if (c02913a == null || !c02913a.A05) {
                c02913a.A03 = true;
                if (A0t[2].length() == 14) {
                    throw new RuntimeException();
                }
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C02913a) && super.checkLayoutParams(layoutParams);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.draw(android.graphics.Canvas):void");
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C02913a(getContext(), attributeSet);
    }
    ...
    public final int getChildDrawingOrder(int i, int i5) {
        ...
        int index = ((C02913a) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            ...
            loop0: for (int itemIndex = c3z.A02; itemIndex < i5; itemIndex++) {
                ...
                if (itemIndex == c3z.A02) {
                    f3 = (c3z.A00 + c3z.A01) * firstPos;
                    f5 = c3z.A00 + c3z.A01 + f4;
                } else {
                    float fA00 = this.A01.A00(itemIndex);
                    f3 = (f5 + fA00) * firstPos;
                    f5 += fA00 + f4;
                }
                if (this.A0M + f3 > lastPos) {
                    Drawable drawable = this.A0S;
                    int iRound = Math.round(f3);
                    int i8 = this.A0Q;
                    int scrollX2 = Math.round(this.A0M + f3);
                    drawable.setBounds(iRound, i8, scrollX2, this.A09);
                    ...
                    if (scrollX3 != str4.charAt(10)) {
                        A0t[1] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                        drawable2.draw(canvas);
                    } else {
                        String[] strArr3 = A0t;
                        strArr3[4] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                        strArr3[5] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                        drawable2.draw(canvas);
                    }
                }
                int i10 = lastPos + firstPos;
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (i != -1) {
                    ...
                    float f4 = x5 - this.A05;
                    float fAbs = Math.abs(f4);
                    float y3 = motionEvent.getY(iFindPointerIndex);
                    float y4 = Math.abs(y3 - this.A04);
                    if (f4 != 0.0f && !A0Y(this.A05, f4) && A0d(this, false, (int) f4, (int) x5, (int) y3)) {
                        this.A05 = x5;
                        this.A06 = y3;
                        this.A0k = true;
                        return false;
                    ...
                    int i5 = this.A0R;
                    if (fAbs > i5 && 0.5f * fAbs > y4) {
                        this.A0i = true;
                        A0T(true);
                        setScrollState(1);
                        if (f4 <= 0.0f) {
                            f3 = this.A03 - this.A0R;
                        } else {
                            float f5 = this.A03;
                            int i8 = this.A0R;
                            String[] strArr2 = A0t;
            ...
            if (count2 == str2.length()) {
                ...
                if (i12 < paddingLeft) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        C02913a c02913a = (C02913a) childAt.getLayoutParams();
                        if (c02913a.A05) {
                            int count3 = c02913a.A04 & 7;
                            int childTop = c02913a.A04 & 112;
                            switch (count3) {
                                case 1:
                                ...
                                case 3:
                                    ...
                                    break;
                                case 5:
                                    int i14 = paddingRight - childLeft;
                            ...
                            switch (childTop) {
                                case 16:
                                    count = Math.max((i11 - childAt.getMeasuredHeight()) / 2, decorCount);
                                    break;
                                case 48:
                                    count = decorCount;
                            ...
                            int i15 = iMax + hgrav;
                            int width = i15 + childAt.getMeasuredWidth();
                            childAt.layout(i15, count, width, childAt.getMeasuredHeight() + count);
                            paddingBottom2++;
                        } else {
                            continue;
                        }
                    ...
                    int i16 = 0;
                    while (i16 < paddingLeft) {
                        View childAt2 = getChildAt(i16);
                        if (childAt2.getVisibility() != i13) {
                            C02913a c02913a2 = (C02913a) childAt2.getLayoutParams();
                            if (!c02913a2.A05 && (c3zA07 = A07(childAt2)) != null) {
                                int childWidth = scrollX + ((int) (paddingRight2 * c3zA07.A00));
                                if (c02913a2.A03) {
                                    c02913a2.A03 = false;
                                    int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (paddingRight2 * c02913a2.A00), 1073741824);
                                    childAt2.measure(widthSpec, View.MeasureSpec.makeMeasureSpec((i11 - decorCount) - paddingBottom, 1073741824));
                                }
                                int heightSpec = childAt2.getMeasuredWidth();
                                int widthSpec2 = childAt2.getMeasuredHeight();
                                int i17 = decorCount;
                                childAt2.layout(childWidth, i17, heightSpec + childWidth, widthSpec2 + i17);
                            }
                        }
                        i16++;
                        i13 = 8;
                    ...
                    if (this.A0g) {
                        ...
                        String[] strArr4 = A0t;
                        strArr4[4] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                        strArr4[5] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                        A0M(i18, false, 0, false);
                    } else {
                        z5 = false;
                    }
                    this.A0g = z5;
    ...
    */
    public void setAdapter(com.meta.analytics.dsp.uinode.C3E r7) {
        ...
        L9c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C02983h.setAdapter(com.facebook.ads.redexgen.X.3E):void");
    }
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC02933c interfaceC02933c) {
        this.A0Y = interfaceC02933c;
    }
    ...
    public void setPageMarginDrawable(int i) {
        setPageMarginDrawable(AbstractC02752k.A00(getContext(), i));
    }
