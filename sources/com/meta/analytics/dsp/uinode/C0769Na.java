...
public class C0769Na {
    ...
    public final String A00 = C0769Na.class.getSimpleName();
    ...
    public final WeakReference<C0943Ts> A06;

    public C0769Na(C0943Ts c0943Ts, InterfaceC0770Nb interfaceC0770Nb, RE re, AtomicBoolean atomicBoolean, AtomicBoolean atomicBoolean2, C1064Yn c1064Yn) {
        this.A06 = new WeakReference<>(c0943Ts);
        this.A04 = new WeakReference<>(interfaceC0770Nb);
        this.A05 = new WeakReference<>(re);
        this.A01 = new WeakReference<>(atomicBoolean);
        this.A02 = new WeakReference<>(atomicBoolean2);
        this.A03 = new WeakReference<>(c1064Yn.A0E());
    }
    ...
    public void onMainAssetLoaded() {
        ...
        if (z) {
            ...
            if (this.A06.get().isShown()) {
                A00().AH2();
                new Handler(Looper.getMainLooper()).post(new C0945Tu(this.A05));
            }
            InterfaceC0770Nb interfaceC0770Nb = this.A04.get();
            if (interfaceC0770Nb != null) {
                new Handler(Looper.getMainLooper()).post(new NZ(this, interfaceC0770Nb));
            }
        }
    }
    ...
    public void onPageInitialized() {
        C0943Ts webView = this.A06.get();
        if (webView == null || webView.A06()) {
            A00().AH3(true);
            return;
        }
        InterfaceC0770Nb listener = this.A04.get();
        if (listener == null) {
            A00().AH3(true);
        } else {
            A00().AH3(false);
