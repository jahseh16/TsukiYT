...
public final class C0716Kz {
    ...
    public static int A00(C1064Yn c1064Yn, int i) {
        return KE.A00(c1064Yn).getInt(A01(0, 21, 2), i);
    }

    public static String A02(C1064Yn c1064Yn, String str) {
        int iA00 = A00(c1064Yn, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C1064Yn c1064Yn, String str, String str2) {
        if (c1064Yn == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1064Yn, str);
    ...
    public final RewardedVideoAd A07(C1064Yn c1064Yn, String str, String str2) {
        if (c1064Yn == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1064Yn, str);
    ...
    public final void A08(C1064Yn c1064Yn, boolean z) {
        int i = 0;
        String strA01 = A01(0, 21, 2);
        if (!z) {
            int lastNonChainedAds = KE.A00(c1064Yn).getInt(strA01, 0);
            i = lastNonChainedAds + 1;
        }
        KE.A00(c1064Yn).edit().putInt(strA01, i).apply();
    }

    public final boolean A09(C1064Yn c1064Yn, String str, int i) {
        if (i <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c1064Yn, i - 1);
