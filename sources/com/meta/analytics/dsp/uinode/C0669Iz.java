...
public final class C0669Iz {
    ...
    public C0669Iz(C03927f c03927f, String str, double d4, String str2, Map<String, String> map, J4 j4, J5 j52, boolean z) {
        this.A05 = str;
        this.A00 = d4;
        this.A04 = str2;
        this.A02 = j4;
        ...
        if (!TextUtils.isEmpty(strA01) && (z || j52 == J5.A0C)) {
            map2.put(A00(6, 21, 61), strA01);
        }
        if (A0B()) {
            Map<String, String> extraData = c03927f.A03().A61();
