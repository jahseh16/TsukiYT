...
public final class C1018Wt implements DD {
    ...
    public boolean A03;
    public final D6 A04;
    public final C0645Hz A05 = new C0645Hz(32);

    public C1018Wt(D6 d6) {
        this.A04 = d6;
    }

    @Override // com.meta.analytics.dsp.uinode.DD
    public final void A4S(C0645Hz c0645Hz, boolean z) {
        int i = -1;
        if (z) {
        ...
        while (c0645Hz.A04() > 0) {
            ...
            if (payloadStartPosition < 3) {
                if (payloadStartPosition == 0) {
                    ...
                    c0645Hz.A0Y(c0645Hz.A06() - 1);
                    if (tableId == 255) {
                        this.A03 = true;
                        return;
                    }
                }
                int tableId2 = c0645Hz.A04();
                int iMin = Math.min(tableId2, 3 - this.A00);
                c0645Hz.A0c(this.A05.A00, this.A00, iMin);
                ...
                if (payloadStartPosition2 == 3) {
                    ...
                    if (headerBytesToRead2 < this.A01) {
                        ...
                        C0645Hz c0645Hz2 = this.A05;
                        int headerBytesToRead3 = this.A01;
                        c0645Hz2.A0W(Math.min(4098, Math.max(headerBytesToRead3, bArr.length * 2)));
                ...
                c0645Hz.A0c(this.A05.A00, this.A00, iMin2);
    ...
    public final void A8q(IB ib, InterfaceC0504Bu interfaceC0504Bu, DC dc) {
        this.A04.A8q(ib, interfaceC0504Bu, dc);
        this.A03 = true;
    }
