...
public final class VE extends C03415a implements DefaultMediaViewVideoRendererApi {
    ...
    private void A09() {
        C0484Ba c0484Ba = this.A04;
        if (c0484Ba != null) {
            QJ qj2 = (QJ) c0484Ba.getVideoView();
            if (A0G[3].length() != 24) {
    ...
    private void A0A() {
        C0484Ba c0484Ba = this.A04;
        if (c0484Ba != null) {
            c0484Ba.getVideoView().setOnTouchListener(new JJ(this));
        }
    }
    ...
    private void A0C() {
        ...
        C0484Ba c0484Ba = this.A04;
        if (c0484Ba != null && c0484Ba.getState() == RB.A05) {
            this.A0B = true;
        }
        this.A08.A0V();
    }
    ...
    */
    ...
    public final void onPrepared() {
        boolean zA0n = C0653Ih.A0n(this.A01);
