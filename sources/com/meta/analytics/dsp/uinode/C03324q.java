...
public final class C03324q extends C5 implements Comparable<C03324q> {
    ...
    public final int compareTo(C03324q c03324q) {
        if (A04() != c03324q.A04()) {
            return A04() ? 1 : -1;
        }
        long j = ((C1042Xr) this).A00 - ((C1042Xr) c03324q).A00;
        if (j == 0) {
            long j4 = this.A00;
            long j7 = c03324q.A00;
