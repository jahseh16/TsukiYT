...
public final class C0875Rc {
    ...
    public static RK A00(C03927f c03927f) {
        return A03(true, c03927f);
    }

    public static RK A01(C03927f c03927f) {
        return A02(true, c03927f);
    }

    public static RK A02(boolean z, C03927f c03927f) {
        RO ro2 = new RO();
        RR rrA04 = A04(c03927f);
        if (!A0B(c03927f)) {
            ro2.A02(A04);
            ro2.A01(A03);
        }
        ...
        C0687Jt c0687JtA00 = RM.A00();
        RO networkModuleConfigurationBuilder = ro2.A00(rrA04.A09());
        return c0687JtA00.A00(networkModuleConfigurationBuilder.A03(z).A04(c03927f.A04().A8z()).A05(), c03927f.A07(), ExecutorC0736Lt.A01());
    }

    public static RK A03(boolean z, C03927f c03927f) {
        return RM.A00().A00(new RO().A03(z).A00(A04(c03927f).A09()).A04(c03927f.A04().A8z()).A05(), c03927f.A07(), ExecutorC0736Lt.A01());
    }

    public static RR A04(C03927f c03927f) {
        A08(c03927f);
        RR rr = new RR();
        if (A0B(c03927f) || L0.A04()) {
            rr.A02(360000).A04(120000);
        } else {
            rr.A02(C0653Ih.A08(c03927f)).A04(C0653Ih.A0A(c03927f));
        }
        rr.A03(C0653Ih.A09(c03927f)).A05(C0653Ih.A0B(c03927f)).A06(C0653Ih.A0C(c03927f));
        synchronized (C0875Rc.class) {
            RI ri = A00;
    ...
    public static void A08(C03927f c03927f) {
        if (!A05.get()) {
            c03927f.A07().A9a(A05(161, 7, 81), C8A.A21, new C8B(A05(93, 23, 29)));
        }
    }
    ...
    public static boolean A0A(C03927f c03927f) {
        ...
        if (i < 17) {
            return Settings.System.getInt(c03927f.getContentResolver(), strA05, 0) != 0;
        }
        int i5 = Settings.Global.getInt(c03927f.getContentResolver(), strA05, 0);
        if (A02[0].length() != 1) {
            throw new RuntimeException();
        }
        String[] strArr = A02;
