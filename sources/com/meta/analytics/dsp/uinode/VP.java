...
public final class VP implements J0 {
    ...
    public VP(C1063Ym c1063Ym, YH yh) {
        this.A00 = c1063Ym;
        this.A01 = yh;
    }

    public static JSONArray A01(C1063Ym c1063Ym, JSONArray jSONArray, JSONArray jSONArray2) {
        int i = 0;
        if (jSONArray != null) {
        ...
        return A02(c1063Ym, jSONArray, jSONArray2, i);
    }
    ...
    */
    public static org.json.JSONArray A02(com.meta.analytics.dsp.uinode.C1063Ym r19, org.json.JSONArray r20, org.json.JSONArray r21, int r22) {
        /*
    ...
    private JSONObject A03() {
        ...
        if (Ij.A0P(this.A00) && (jSONArrayA03 = C8C.A03(this.A00)) != null && jSONArrayA03.length() > 0) {
            ...
            jSONArrayA5y = A01(c1063Ym, jSONArrayA03, jSONArrayA5y);
        }
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                if (A00(393, 26, 8).equals(string)) {
                    C0653Ih.A0R(this.A00).A2X(jSONObject.getString(A00(419, 14, 47)));
                    this.A00.A03().AAL();
                } else {
                    ...
                    if (i5 == 1) {
                        ...
                        if (i5 >= 1000 && i5 < 2000) {
                            if (this.A00.A04().A8z()) {
                                Log.e(A04, A00(236, 37, 17) + i5 + strA002 + string + strA00);
                            }
                            A06(string);
                            z = false;
                        } else if (i5 >= 2000 && i5 < 3000) {
                            if (this.A00.A04().A8z()) {
                                Log.e(A04, A00(195, 41, 9) + i5 + strA002 + string + strA00);
                            }
                            if (!this.A01.A53(string) && zA0P) {
                                C8C.A0D(string);
                            }
                ...
                if (this.A00.A04().A8z()) {
                    Log.e(A04, A00(331, 44, 82) + i + strA00, e4);
                }
                z = false;
            }
        }
