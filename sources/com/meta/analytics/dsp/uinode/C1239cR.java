...
public final class C1239cR {
    ...
    public final SU A05;
    public final InterfaceC1249cc A06;
    public final C1241cT A07;
    public final HB A08;
    public final Runnable A09;
    public final List<Rect> A0A;
    public final List<DspViewableNode> A0B;

    public C1239cR(InterfaceC1249cc interfaceC1249cc, SU su, HB hb, C1241cT c1241cT, Handler handler) {
        this(interfaceC1249cc, su, hb, c1241cT, handler, 100);
    }

    public C1239cR(InterfaceC1249cc interfaceC1249cc, SU su, HB hb, C1241cT c1241cT, Handler handler, int i) {
        this.A03 = new Rect();
        this.A02 = new Rect();
        this.A0B = new ArrayList();
        this.A0A = new ArrayList();
        this.A01 = false;
        this.A06 = interfaceC1249cc;
        this.A05 = su;
        this.A08 = hb;
        this.A07 = c1241cT;
        this.A04 = handler;
        this.A09 = new RunnableC1240cS(this, i, new Exception());
    }
        ...
        if (this.A0B.isEmpty()) {
            ...
            loop0: while (true) {
                if (it.hasNext()) {
                    ...
                    C1247ca c1247caA00 = this.A07.A00(next);
                    Iterator<Rect> it2 = this.A0A.iterator();
                    while (it2.hasNext()) {
                        if (next.A8N(this.A03, this.A02, it2.next()) && c1247caA00 != C1247ca.A08) {
                            HB hb = this.A08;
                            ...
                            hb.A3V(c1247caA00, containerRect, rect);
                        }
                    }
                } else {
                    this.A08.A5Z();
                    InterfaceC1243cV interfaceC1243cV = this.A00;
                    if (interfaceC1243cV != null) {
                        interfaceC1243cV.AD2();
                    }
                    this.A0B.clear();
                    String[] strArr = A0C;
    ...
    public final void A0A(InterfaceC1243cV interfaceC1243cV) {
        this.A00 = interfaceC1243cV;
    }
}
