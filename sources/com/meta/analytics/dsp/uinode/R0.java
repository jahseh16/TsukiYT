...
public final class R0 {
    ...
    public File A02;
    public boolean A03;
    public final C1063Ym A06;
    public final E9 A07;
    public final Handler A04 = new Handler(Looper.getMainLooper());
    public final SparseArray<C0871Qy> A05 = new SparseArray<>();
    public final Runnable A08 = new RunnableC0870Qx(this);
    ...
    public R0(C1063Ym c1063Ym, EG eg) {
        C0690Jw c0690Jw = new C0690Jw(this);
        this.A07 = c0690Jw;
        this.A06 = c1063Ym;
        if (eg != null) {
            this.A00 = eg;
    ...
    private final synchronized HK A03() {
        if (this.A01 == null) {
            this.A01 = new C0982Vg(new File(A06(), A07(64, 14, 16)), new C0494Bk(C0653Ih.A0P(this.A06)));
        }
        return this.A01;
    }

    public static C0985Vj A04(C1001Vz c1001Vz, HK hk2) {
        return new C0985Vj(hk2, c1001Vz, new C0997Vv(), null, 2, null);
    }

    public static synchronized R0 A05(C1063Ym c1063Ym) {
        if (A09 == null) {
            A09 = new R0(c1063Ym, null);
        }
        return A09;
    }
    ...
    public static String A08(C1063Ym c1063Ym, Uri uri) {
        try {
            if (!C0653Ih.A1T(c1063Ym)) {
                return null;
            }
            return new URI(uri.getScheme(), uri.getAuthority(), uri.getPath(), null, uri.getFragment()).toString();
        } catch (URISyntaxException e4) {
            c1063Ym.A07().A9a(A07(81, 5, 14), C8A.A0u, new C8B(e4));
            return null;
        }
    }
    ...
    public void A09() {
        for (EF ef : A01().A0S()) {
            int taskId = ef.A02;
            C0871Qy c0871Qy = this.A05.get(taskId);
            if (c0871Qy != null) {
                int i = ef.A01;
                if (i == 2 || ef.A03 > c0871Qy.A00) {
                    String str = A07(15, 19, 61) + i + A07(0, 8, 18) + ef.A03;
                    c0871Qy.A01.ABL(c0871Qy.A02);
                    this.A05.remove(taskId);
                } else if (i == 4 || i == 3) {
                    String str2 = A07(34, 14, 111) + i;
                    c0871Qy.A01.ABT(ef.A05);
                    this.A05.remove(taskId);
                }
            }
    ...
    public final C0985Vj A0F(Context context) {
        return A04(new C1001Vz(context, (HG<? super InterfaceC0615Gu>) null, A02()), A03());
    }

    public final void A0G(Uri uri, InterfaceC0872Qz interfaceC0872Qz, long j) {
        String strA08 = A08(this.A06, uri);
        if (strA08 == null) {
            strA08 = uri.toString();
        }
        boolean zA0H = A0H(strA08);
        this.A05.put(A01().A0O(new WY(uri, false, null, strA08)), new C0871Qy(interfaceC0872Qz, j, zA0H, null));
        A0A();
    }
