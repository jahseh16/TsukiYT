...
public class C0570Ey extends C1099Zx {
    ...
    @Override // com.meta.analytics.dsp.uinode.C02993i
    ...
    @Override // com.meta.analytics.dsp.uinode.C02993i
    public final void A04(ViewParent viewParent, View view, int i, int i5, int i8, int i10) {
        try {
            viewParent.onNestedScroll(view, i, i5, i8, i10);
        } catch (AbstractMethodError e4) {
    ...
    @Override // com.meta.analytics.dsp.uinode.C02993i
    public final boolean A07(ViewParent viewParent, View view, float f3, float f4) {
        try {
    ...
    @Override // com.meta.analytics.dsp.uinode.C02993i
    public final boolean A08(ViewParent viewParent, View view, float f3, float f4, boolean z) {
        try {
