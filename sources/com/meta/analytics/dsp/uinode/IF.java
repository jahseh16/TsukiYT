...
public abstract class IF {
    ...
    public static float A00(float f3, float f4, float f5) {
    ...
    public static int A06(int i, int i5, int i8) {
        return Math.max(i5, Math.min(i, i8));
    }

    public static int A07(long j, long j4) {
        if (j < j4) {
            return -1;
        }
        return j == j4 ? 0 : 1;
    ...
    public static int A09(byte[] bArr, int i, int i5, int i8) {
        while (i < i5) {
            int[] iArr = A0A;
            int i10 = bArr[i];
            i8 = (i8 << 8) ^ iArr[((i8 >>> 24) ^ (i10 & 255)) & 255];
            i++;
        }
        return i8;
    }

    public static int A0A(long[] jArr, long j, boolean z, boolean z5) {
    ...
    public static int A0B(long[] jArr, long j, boolean z, boolean z5) {
        int iBinarySearch = Arrays.binarySearch(jArr, j);
        if (iBinarySearch < 0) {
        ...
        return z5 ? Math.max(0, iBinarySearch) : iBinarySearch;
    }

    public static long A0C(long j, float f3) {
        if (f3 == 1.0f) {
            return j;
        }
        double d4 = j * ((double) f3);
        String[] strArr = A01;
    ...
    public static long A0D(long j, float f3) {
        if (f3 == 1.0f) {
            return j;
        }
        return Math.round(j / ((double) f3));
    }

    public static long A0E(long j, long j4, long j7) {
        return Math.max(j4, Math.min(j, j7));
    }

    public static long A0F(long j, long j4, long j7) {
        if (j7 >= j4 && j7 % j4 == 0) {
            return j / (j7 / j4);
        }
        if (j7 < j4 && j4 % j7 == 0) {
    ...
    public static long A0G(long j, long j4, long j7) {
        long j8 = j + j4;
        if (((j ^ j8) & (j4 ^ j8)) < 0) {
            return j7;
        }
    ...
    public static long A0H(long j, long j4, long j7) {
        long j8 = j - j4;
        if (((j ^ j4) & (j ^ j8)) < 0) {
            return j7;
        }
    ...
    */
    ...
    public static void A0W(InterfaceC0615Gu interfaceC0615Gu) {
    ...
    public static void A0a(long[] jArr, long j, long j4) {
        if (j4 >= j) {
            long j7 = j4 % j;
            String[] strArr = A01;
        ...
        if (j4 < j && j % j4 == 0) {
            ...
            for (int i5 = 0; i5 < jArr.length; i5++) {
                long multiplicationFactor = jArr[i5];
                jArr[i5] = multiplicationFactor * j9;
            }
            return;
        }
        double d4 = j / j4;
        ...
        while (true) {
            ...
            double multiplicationFactor2 = (long) (jArr[i8] * d4);
    ...
    public static byte[] A0h(String str) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            int i5 = i * 2;
            int i8 = Character.digit(str.charAt(i5), 16) << 4;
            bArr[i] = (byte) (i8 + Character.digit(str.charAt(i5 + 1), 16));
        }
        return bArr;
    }
    ...
    public static <T> T[] A0k(T[] tArr, int i) {
        AbstractC0620Ha.A03(i <= tArr.length);
