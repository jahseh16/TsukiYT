...
public class ViewOnClickListenerC0851Qe implements View.OnClickListener {
    public final /* synthetic */ C7C A00;

    public ViewOnClickListenerC0851Qe(C7C c7c) {
        this.A00 = c7c;
    }
    ...
    public final void onClick(View view) throws Throwable {
        ...
        try {
            if (this.A00.getVideoView() != null) {
                ...
                switch (C0852Qf.A00[this.A00.getVideoView().getState().ordinal()]) {
                    case 1:
                    case 2:
                    case 3:
                    case 4:
