...
public class C1090Zo extends AbstractC03304o implements AnonymousClass50 {
    ...
    public static String A0T(int i, int i5, int i8) {
    ...
    public C1090Zo(Context context) {
        this(context, 1, false);
    }

    public C1090Zo(Context context, int i, boolean z) {
        this.A0A = false;
        this.A05 = false;
        this.A0C = false;
        this.A0B = true;
    ...
    private final int A04(int i, C03374w c03374w, AnonymousClass53 anonymousClass53) {
        if (A0W() == 0 || i == 0) {
            return 0;
        }
        this.A07.A0B = true;
        ...
        int i5 = this.A07.A07;
        int layoutDirection = A08(c03374w, this.A07, anonymousClass53, false);
        int i8 = i5 + layoutDirection;
        if (i8 < 0) {
            return 0;
        }
        int absDy2 = consumed > i8 ? absDy * i8 : i;
    ...
    private int A05(int i, C03374w c03374w, AnonymousClass53 anonymousClass53, boolean z) {
        int gap = this.A04.A07() - i;
        if (gap > 0) {
            int i5 = -A04(-gap, c03374w, anonymousClass53);
            int i8 = i + i5;
            if (z) {
    ...
    private int A06(int i, C03374w c03374w, AnonymousClass53 anonymousClass53, boolean z) {
        int iA0A;
        int gap = i - this.A04.A0A();
        if (gap > 0) {
            int i5 = -A04(gap, c03374w, anonymousClass53);
            int i8 = i + i5;
            if (z && (iA0A = i8 - this.A04.A0A()) > 0) {
                this.A04.A0J(-iA0A);
                return i5 - iA0A;
            }
            return i5;
    ...
    */
    private final int A08(com.meta.analytics.dsp.uinode.C03374w r10, com.meta.analytics.dsp.uinode.C4T r11, com.meta.analytics.dsp.uinode.AnonymousClass53 r12, boolean r13) {
        /*
            r9 = this;
            int r6 = r11.A00
            int r0 = r11.A07
        ...
        L5b:
            ...
            int r8 = r11.A07
            int r7 = r11.A00
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C1090Zo.A0G
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 7
            if (r1 == r0) goto La1
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C1090Zo.A0G
        ...
        La1:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1090Zo.A08(com.facebook.ads.redexgen.X.4w, com.facebook.ads.redexgen.X.4T, com.facebook.ads.redexgen.X.53, boolean):int");
    }
    ...
    private final View A0J(int i, int i5, boolean z, boolean z5) {
        int i8;
        A29();
        int i10 = 0;
        if (z) {
        ...
        if (i11 == 0) {
            return super.A04.A00(i, i5, i8, i10);
        }
        return super.A05.A00(i, i5, i8, i10);
    }

    private View A0K(C03374w c03374w, AnonymousClass53 anonymousClass53) {
        return A28(c03374w, anonymousClass53, 0, A0W(), anonymousClass53.A03());
    }

    private View A0L(C03374w c03374w, AnonymousClass53 anonymousClass53) {
        return A28(c03374w, anonymousClass53, A0W() - 1, -1, anonymousClass53.A03());
    }

    private View A0M(C03374w c03374w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0D() : A0E();
    }

    private View A0N(C03374w c03374w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0E() : A0D();
    }

    private View A0O(C03374w c03374w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0K(c03374w, anonymousClass53) : A0L(c03374w, anonymousClass53);
    }

    private View A0P(C03374w c03374w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0L(c03374w, anonymousClass53) : A0K(c03374w, anonymousClass53);
    }

    private View A0Q(boolean z, boolean z5) {
        if (this.A05) {
            return A0J(0, A0W(), z, z5);
        }
        return A0J(A0W() - 1, -1, z, z5);
    }

    private View A0R(boolean z, boolean z5) {
        if (this.A05) {
            return A0J(A0W() - 1, -1, z, z5);
        }
        return A0J(0, A0W(), z, z5);
    ...
    private void A0Y(int i, int i5, boolean z, AnonymousClass53 anonymousClass53) {
        int iA0A;
        this.A07.A09 = A0i();
    ...
    private void A0b(C03374w c03374w, int i) {
        int iA0W = A0W();
        if (i < 0) {
            return;
        }
        ...
        for (int i8 = iA0W - 1; i8 >= 0; i8--) {
            View viewA0t2 = A0t(i8);
            ...
            A0d(c03374w, childCount5, i8);
            return;
        }
    }

    private void A0c(C03374w c03374w, int i) {
        if (i < 0) {
            return;
        }
        String[] strArr = A0G;
        ...
        if (this.A05) {
            for (int i5 = iA0W - 1; i5 >= 0; i5--) {
                ...
                int limit5 = iA0W - 1;
                A0d(c03374w, limit5, i5);
                return;
            }
            return;
        }
        for (int i8 = 0; i8 < iA0W; i8++) {
            View viewA0t2 = A0t(i8);
    ...
    private void A0d(C03374w c03374w, int i, int i5) {
        if (i == i5) {
            return;
        }
        if (i5 > i) {
    ...
    private void A0e(C03374w c03374w, C4T c4t) {
        if (!c4t.A0B || c4t.A09) {
            return;
        }
        int i = c4t.A05;
    ...
    private void A0f(C03374w c03374w, AnonymousClass53 anonymousClass53, int scrapExtraEnd, int scrapExtraEnd2) {
        if (!anonymousClass53.A08() || A0W() == 0 || anonymousClass53.A07() || !A22()) {
            return;
        }
        int iA0D = 0;
        int scrapExtraStart = 0;
        List<AnonymousClass56> listA0J = c03374w.A0J();
        int i = listA0J.size();
        int iA0p = A0p(A0t(0));
        ...
        if (iA0D > 0) {
            ...
            this.A07.A00 = 0;
            this.A07.A04();
            A08(c03374w, this.A07, anonymousClass53, false);
        }
    ...
    private void A0g(C03374w c03374w, AnonymousClass53 anonymousClass53, C4R c4r) {
        if (A0k(anonymousClass53, c4r)) {
            return;
        }
        boolean zA0j = A0j(c03374w, anonymousClass53, c4r);
        String[] strArr = A0G;
        if (strArr[2].charAt(4) == strArr[4].charAt(4)) {
            throw new RuntimeException();
        }
    ...
    private boolean A0j(C03374w c03374w, AnonymousClass53 anonymousClass53, C4R c4r) {
        View viewA0P;
        int iA0A;
        if (A0W() == 0) {
            return false;
        ...
        if (c4r.A02) {
            viewA0P = A0O(c03374w, anonymousClass53);
        } else {
            viewA0P = A0P(c03374w, anonymousClass53);
        }
        if (viewA0P == null) {
            return false;
        }
    ...
    public int A1d(int i, C03374w c03374w, AnonymousClass53 anonymousClass53) {
        if (this.A00 == 1) {
            return 0;
        }
        return A04(i, c03374w, anonymousClass53);
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC03304o
    public int A1e(int i, C03374w c03374w, AnonymousClass53 anonymousClass53) {
        if (this.A00 == 0) {
            return 0;
        }
        int iA04 = A04(i, c03374w, anonymousClass53);
        String[] strArr = A0G;
        if (strArr[6].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC03304o
    public View A1n(View view, int i, C03374w c03374w, AnonymousClass53 anonymousClass53) {
        int iA27;
        View viewA0M;
        View nextCandidate;
        A0U();
        ...
        this.A07.A07 = Integer.MIN_VALUE;
        this.A07.A0B = false;
        A08(c03374w, this.A07, anonymousClass53, true);
        if (iA27 == -1) {
            viewA0M = A0N(c03374w, anonymousClass53);
        } else {
            viewA0M = A0M(c03374w, anonymousClass53);
        }
        if (iA27 == -1) {
            nextCandidate = A0G();
        } else {
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC03304o
    public final void A1q(int i, int i5, AnonymousClass53 anonymousClass53, InterfaceC03284m interfaceC03284m) {
        if (this.A00 != 0) {
            i = i5;
        }
        int delta = A0W();
        ...
        A0Y(i8, delta2, true, anonymousClass53);
        A2E(anonymousClass53, this.A07, interfaceC03284m);
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC03304o
    public final void A1r(int i, InterfaceC03284m interfaceC03284m) {
        boolean z;
        int direction;
        LinearLayoutManager$SavedState linearLayoutManager$SavedState = this.A03;
        if (linearLayoutManager$SavedState != null && linearLayoutManager$SavedState.A01()) {
        ...
        for (int i10 = 0; i10 < this.A06 && direction >= 0 && direction < i; i10++) {
            interfaceC03284m.A3S(direction, 0);
            direction += i8;
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void A1u(com.meta.analytics.dsp.uinode.C03374w r10, com.meta.analytics.dsp.uinode.AnonymousClass53 r11) {
        /*
            Method dump skipped, instruction units count: 621
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1090Zo.A1u(com.facebook.ads.redexgen.X.4w, com.facebook.ads.redexgen.X.53):void");
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC03304o
    public final void A1w(C0547Eb c0547Eb, C03374w c03374w) {
        super.A1w(c0547Eb, c03374w);
        if (this.A09) {
            A1I(c03374w);
            c03374w.A0P();
        }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC03304o
    public void A1x(C0547Eb c0547Eb, AnonymousClass53 anonymousClass53, int i) {
        C1089Zn linearSmoothScroller = new C1089Zn(c0547Eb.getContext());
    ...
    */
    public final int A27(int r8) {
        ...
        L75:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1090Zo.A27(int):int");
    }

    public View A28(C03374w c03374w, AnonymousClass53 anonymousClass53, int i, int i5, int i8) {
        A29();
        View view = null;
        View view2 = null;
        ...
        while (i != i5) {
            ...
            if (iA0p >= 0 && iA0p < i8) {
                if (((C03314p) outOfBoundsMatch.getLayoutParams()).A02()) {
                    if (view == null) {
    ...
    public void A2C(C03374w c03374w, AnonymousClass53 anonymousClass53, C4R c4r, int i) {
    }

    public void A2D(C03374w c03374w, AnonymousClass53 anonymousClass53, C4T c4t, C4S c4s) {
        int iA0g;
        int right;
        int iA0e;
        int iA0E;
        View viewA03 = c4t.A03(c03374w);
        if (viewA03 == null) {
            c4s.A01 = true;
            return;
        }
        C03314p c03314p = (C03314p) viewA03.getLayoutParams();
        if (c4t.A08 == null) {
        ...
        if (c03314p.A02() || c03314p.A01()) {
            c4s.A03 = true;
        }
        c4s.A02 = viewA03.hasFocusable();
    }

    public void A2E(AnonymousClass53 anonymousClass53, C4T c4t, InterfaceC03284m interfaceC03284m) {
        int i = c4t.A01;
        if (i >= 0) {
            int pos = anonymousClass53.A03();
            if (i < pos) {
                int pos2 = c4t.A07;
                interfaceC03284m.A3S(i, Math.max(0, pos2));
            }
        }
    }
    ...
    public final PointF A4O(int i) {
        ...
        int i5 = (i < A0p(A0t(0))) != this.A05 ? -1 : 1;
        int i8 = this.A00;
