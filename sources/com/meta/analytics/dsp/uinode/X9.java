...
public final class X9 implements InterfaceC0528Cy {
    ...
    public X9(String str) {
        C0644Hy c0644Hy = new C0644Hy(new byte[128]);
        this.A09 = c0644Hy;
        this.A0A = new C0645Hz(c0644Hy.A00);
        this.A02 = 0;
        this.A0B = str;
    }
    ...
    */
            ...
            if (iA04 > 0) {
                switch (this.A02) {
                    case 0:
                        ...
                        break;
                    case 1:
                        if (A02(c0645Hz, this.A0A.A00, 128)) {
                            A00();
                            this.A0A.A0Y(0);
    ...
    public final void A4p(InterfaceC0504Bu interfaceC0504Bu, DC dc) {
        dc.A05();
        this.A07 = dc.A04();
        this.A06 = interfaceC0504Bu.AGi(dc.A03(), 1);
    }
