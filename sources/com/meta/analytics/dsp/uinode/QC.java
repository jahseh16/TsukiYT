...
public final class QC extends LinearLayout {
    ...
    public QC(C1064Yn c1064Yn, NativeAd nativeAd, JR jr2, O3 o32, AdOptionsView adOptionsView) {
        super(c1064Yn);
        setOrientation(0);
        ...
        TextView sponsoredTextView = new TextView(c1064Yn);
        jr2.A06(sponsoredTextView);
