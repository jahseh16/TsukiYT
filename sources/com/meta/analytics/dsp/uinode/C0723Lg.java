...
public final class C0723Lg {
    ...
    static {
        A02();
        A0K = C0723Lg.class.getSimpleName();
    }
    ...
    */
    public final java.util.Map<java.lang.String, java.lang.String> A04() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0723Lg.A04():java.util.Map");
    }
    ...
    public final void A06(C1064Yn c1064Yn, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c1064Yn.A0E().AGu();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                float f3 = this.A00;
                float f4 = f3 - (f3 / this.A09);
                this.A00 = f4;
                float pressure = motionEvent.getPressure();
                int i = this.A09;
                this.A00 = f4 + (pressure / i);
                float f5 = this.A02;
                float f7 = f5 - (f5 / i);
                this.A02 = f7;
