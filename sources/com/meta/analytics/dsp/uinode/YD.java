...
public final class YD implements C8w {
    ...
    public final AnonymousClass97<C0669Iz> A01;
    public final AnonymousClass97<C0669Iz> A02;
    ...
    */
    ...
    public YD(C1063Ym c1063Ym) throws IOException {
        this.A00 = c1063Ym;
        this.A01 = new YA(AnonymousClass94.A00(A00(11, 28, 31), c1063Ym), new YF(this));
        this.A02 = new YA(AnonymousClass94.A00(A00(322, 37, 102), c1063Ym), new YE(this));
    }
    ...
    public static byte[] A07(C03927f c03927f, String str, C0669Iz c0669Iz) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(A00(423, 2, 0), str);
            jSONObject.put(A00(466, 5, 3), c0669Iz.A08());
            jSONObject.put(A00(471, 4, 106), c0669Iz.A06().toString());
            jSONObject.put(A00(462, 4, 86), C0722Lf.A02(c0669Iz.A04()));
            jSONObject.put(A00(450, 12, 27), C0722Lf.A02(c0669Iz.A03()));
            jSONObject.put(A00(440, 10, 116), c0669Iz.A07());
            jSONObject.put(A00(419, 4, 62), new JSONObject(c0669Iz.A09()));
    ...
    */
    ...
    @Override // com.meta.analytics.dsp.uinode.C8w
    public final void AHE(final C0669Iz c0669Iz, final AbstractC04278t<String> abstractC04278t) {
        Executor executor = ExecutorC0736Lt.A07;
        final AnonymousClass97<C0669Iz> anonymousClass97 = this.A01;
        final C1063Ym c1063Ym = this.A00;
        AbstractC0733Lq.A00(executor, new AsyncTask<Void, Void, String>(c0669Iz, abstractC04278t, anonymousClass97, c1063Ym) { // from class: com.facebook.ads.redexgen.X.8x
            ...
            public final AbstractC04278t<String> A02;
            public final AnonymousClass97<C0669Iz> A03;
            public final C0669Iz A04;
