...
public final class BQ extends C0900Sb {
    ...
    public BQ(C03083r c03083r, int i, List<C0836Pp> list, RE re, Bundle bundle) {
        super(c03083r, i, list, re, bundle);
        c03083r.A1f(this);
    ...
    @Override // com.meta.analytics.dsp.uinode.C0900Sb, com.meta.analytics.dsp.uinode.AbstractC03354t
    ...
    @Override // com.meta.analytics.dsp.uinode.C0900Sb
    ...
    public final void A0d(List<C0836Pp> list) {
        this.A05 = list;
    }
}
