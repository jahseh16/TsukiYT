...
public final class C03485h implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0808On A0B = new EW(this);
    public final AbstractC0749Mg A0E = new EV(this);
    public final AbstractC0841Pu A09 = new EU(this);
    public final MV A0F = new ET(this);
    public final AbstractC0839Ps A0A = new ES(this);
    public C03415a A02 = new C03415a();

    public static String A01(int i, int i5, int i8) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0G, i, i + i5);
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1064Yn c1064YnA11 = ((V2) nativeAd.getInternalNativeAd()).A11();
        C1064Yn adObjectContext = this.A03;
        adObjectContext.A0K(c1064YnA11);
        C03495i c03495i = (C03495i) nativeAd.getNativeAdApi();
        this.A05.setClientToken(V2.A0L(nativeAd.getInternalNativeAd()).A1B());
        this.A05.setVideoMPD(c03495i.A01());
        this.A05.setVideoURI(c03495i.A02());
        C1182bK c1182bKA0y = V2.A0L(nativeAd.getInternalNativeAd()).A0y();
        if (c1182bKA0y != null) {
            this.A05.setVideoProgressReportIntervalMs(c1182bKA0y.A0B());
        }
        this.A05.setVideoCTA(nativeAd.getAdCallToAction());
        this.A05.setNativeAd(nativeAd);
        this.A01 = c03495i.getVideoAutoplayBehavior();
        JM jm = this.A04;
        if (jm != null) {
            jm.AG8(nativeAd);
        }
    ...
    public final void disengageSeek(VideoStartReason videoStartReason) {
        ...
        this.A06 = false;
        if (this.A07) {
            this.A05.A0b(AbstractC0727Lk.A00(videoStartReason), 3);
        }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1064Yn) {
            c1064YnA03 = (C1064Yn) context;
        } else {
            c1064YnA03 = C03435c.A03(context);
        }
        this.A03 = c1064YnA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C0484Ba(c1064YnA03);
                break;
            case 1:
                this.A05 = new C0484Ba(c1064YnA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C0484Ba(c1064YnA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C0484Ba(c1064YnA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
    ...
    public final void play(VideoStartReason videoStartReason) {
        this.A05.A0b(AbstractC0727Lk.A00(videoStartReason), 2);
    }
    ...
    public final void setVolume(float f3) {
        this.A05.setVolume(f3);
    }

    public final boolean shouldAutoplay() {
        C0484Ba c0484Ba = this.A05;
        if (c0484Ba == null || c0484Ba.getState() == RB.A06) {
            return false;
        }
