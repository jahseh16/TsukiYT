...
public final class CE {
     ...
     */
    public static Pair<String, List<byte[]>> A00(C0645Hz c0645Hz) throws C04539v {
        try {
            c0645Hz.A0Z(16);
            ...
            for (int iA06 = c0645Hz.A06() + 20; iA06 < bArr.length - 4; iA06++) {
            ...
            throw new C04539v(A01(238, 45, 91));
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw new C04539v(A01(137, 33, 14));
        }
    }
    ...
    public static List<byte[]> A03(byte[] bArr) throws C04539v {
        ...
        try {
            if (bArr[0] == 2) {
                ...
                if (bArr[offset] == 1) {
                    ...
                    System.arraycopy(bArr, offset, bArr2, 0, i10);
                    int offset2 = offset + i10;
                    if (bArr[offset2] == 3) {
                        int offset3 = offset2 + i12;
                        if (bArr[offset3] == 5) {
    ...
    public static boolean A05(C0645Hz c0645Hz) throws C04539v {
        try {
            ...
            if (jA0L == mostSignificantBits) {
                if (c0645Hz.A0L() == XX.A0s.getLeastSignificantBits()) {
                    return true;
                }
            }
            return false;
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw new C04539v(A01(170, 34, 16));
        }
    }
    ...
    */
    public final void A09(com.meta.analytics.dsp.uinode.InterfaceC0504Bu r30, int r31) throws com.meta.analytics.dsp.uinode.C04539v {
        /*
