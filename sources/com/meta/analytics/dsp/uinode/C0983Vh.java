...
public final class C0983Vh implements HU {
    ...
    public static final C0983Vh A04;
    public int A00;
    ...
    static {
        A03();
        A04 = new C0983Vh(Collections.emptyMap());
    }

    public C0983Vh(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static C0983Vh A00(DataInputStream dataInputStream) throws IOException {
    ...
    */
    public static void A04(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0983Vh.A04(java.util.HashMap, java.util.List):void");
    }
    ...
    public final C0983Vh A08(HW hw2) {
        Map<String, byte[]> mapA02 = A02(this.A01, hw2);
        if (A06(mapA02)) {
            return this;
        }
        return new C0983Vh(mapA02);
    }
