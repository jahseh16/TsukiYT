...
public final class C03224g extends C8 {
    ...
    public C03224g(List<byte[]> list) {
        super(A02(182, 10, 38));
        if (list != null && !list.isEmpty()) {
            this.A04 = true;
            String strA0Q = IF.A0Q(list.get(0));
            String formatLine = A02(47, 8, 49);
            AbstractC0620Ha.A03(strA0Q.startsWith(formatLine));
            A06(strA0Q);
            A04(new C0645Hz(list.get(1)));
            return;
        }
        this.A04 = false;
    }
    ...
    public final WF A0b(byte[] bArr, int i, boolean z) {
        ...
        C0635Hp c0635Hp = new C0635Hp();
        C0645Hz c0645Hz = new C0645Hz(bArr, i);
        if (!this.A04) {
            A04(c0645Hz);
        }
        A05(c0645Hz, arrayList, c0635Hp);
        C0583Fn[] c0583FnArr = new C0583Fn[arrayList.size()];
        arrayList.toArray(c0583FnArr);
        return new WF(c0583FnArr, c0635Hp.A05());
    }

    private void A04(C0645Hz c0645Hz) {
        String strA0P;
        do {
            strA0P = c0645Hz.A0P();
            if (strA0P == null) {
    ...
    private void A05(C0645Hz c0645Hz, List<C0583Fn> list, C0635Hp c0635Hp) {
        while (true) {
    ...
    */
    private void A06(java.lang.String r9) {
        ...
        L90:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C03224g.A06(java.lang.String):void");
    }

    private void A07(String str, List<C0583Fn> list, C0635Hp c0635Hp) {
        int i = this.A01;
        ...
        list.add(new C0583Fn(endTimeString.replaceAll(strA023, strA024).replaceAll(A02(203, 3, 50), strA024)));
        c0635Hp.A04(startTimeUs);
        if (jA00 != -9223372036854775807L) {
            list.add(null);
            String[] strArr = A06;
