...
public abstract class AbstractC02401b {
    ...
    public static C02451g A01(JSONObject jSONObject) {
        return new C02441f().A06(A0A(jSONObject)).A07(A0B(jSONObject)).A05(A05(jSONObject)).A04(A04(jSONObject)).A08();
    }
