...
public abstract class C2L {
    ...
    public static Bundle A00(C03927f c03927f) {
        Bundle bundle = new Bundle();
        A08(bundle, c03927f);
        String strA06 = A06(123, 19, 18);
        Bundle data = A01(c03927f);
        bundle.putBundle(strA06, data);
        return bundle;
    }

    public static Bundle A01(C03927f c03927f) {
        Bundle bundle = new Bundle();
        ...
        bundle.putBoolean(A06(54, 13, 110), LE.A05(c03927f));
        return bundle;
    }
    ...
    public static AnonymousClass26 A04(C1064Yn c1064Yn, Bundle bundle, String str) {
        ...
        AnonymousClass26 anonymousClass26 = new AnonymousClass26(c1064Yn, null, string, new C1121aL(str, string4, bundle2));
    ...
    public static C2F A05(C1064Yn c1064Yn, Bundle bundle, String str) {
        String string = bundle.getString(A06(437, 17, 103));
        ...
        C2F c2f = new C2F(c1064Yn, string, null, new C1121aL(str, string4, bundle2));
    ...
    public static void A08(Bundle bundle, C03927f c03927f) {
        bundle.putString(A06(330, 22, 8), A06(0, 6, 63));
        bundle.putBoolean(A06(33, 21, 59), AnonymousClass84.A0I(c03927f));
        if (AbstractC0655Ik.A0B(c03927f)) {
            String strA03 = new C6S().A03(c03927f);
