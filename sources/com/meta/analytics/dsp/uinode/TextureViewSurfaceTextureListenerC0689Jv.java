...
public final class TextureViewSurfaceTextureListenerC0689Jv extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC0866Qt, R9, InterfaceC0868Qv {
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C0653Ih.A1X(this.A0A) && this.A0D != RB.A08) {
            if (!this.A0L) {
                this.A0L = true;
                this.A0A.A0E().AFY();
            }
    ...
    static {
        A07();
        A0Q = TextureViewSurfaceTextureListenerC0689Jv.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC0689Jv(C1064Yn c1064Yn) {
        super(c1064Yn);
        this.A0D = RB.A04;
        this.A0E = RB.A04;
        this.A0M = false;
    ...
    public TextureViewSurfaceTextureListenerC0689Jv(C1064Yn c1064Yn, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC0689Jv(C1064Yn c1064Yn, AttributeSet attributeSet, int i) {
    ...
    */
    private void A04() {
        /*
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC0689Jv.A0P
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            ...
            throw r0
        L38:
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC0689Jv.A0P
        ...
        Lbc:
            ...
            goto L65
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC0689Jv.A04():void");
    }

    private void A05() {
        C0869Qw c0869Qw = this.A0C;
        if (c0869Qw == null) {
            return;
        }
        C0867Qu c0867QuA08 = c0869Qw.A08();
        String[] strArr = A0P;
        ...
        if (c0867QuA08 != null) {
            A08(c0867QuA08.A01, c0867QuA08.A00);
        }
    }
    ...
    public final boolean A8b() {
        C0869Qw c0869Qw = this.A0C;
        return c0869Qw != null && c0869Qw.A0K();
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0866Qt
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0868Qv
    ...
    public final void onAttachedToWindow() {
        ...
        if (C0653Ih.A2D(getContext()) && !isHardwareAccelerated()) {
            setVideoState(RB.A03);
            AGZ(8);
        }
    }
    ...
    public final void onWindowFocusChanged(boolean z) {
        ...
        if (!z) {
            if (this.A0D != RB.A05) {
                if ((this.A0A.A0F().A01() || C0653Ih.A1c(this.A0A)) && Build.VERSION.SDK_INT >= 24) {
