...
public class SD extends KT {
    ...
    public final void A06() {
        ...
        if (rb2 == rb3) {
            ...
            C04258r c04258r = this.A02.A0B;
            int i = this.A01;
            c04258r.A02(new C9H(i, i));
            this.A02.A0K(this.A01);
            return;
        }
        if (this.A03 == RB.A0A) {
            if (C0653Ih.A1W(this.A02.A0A)) {
        ...
        if (this.A03 == RB.A05) {
            ...
            C04258r c04258r2 = this.A02.A0B;
            final int i5 = this.A00;
            c04258r2.A02(new AbstractC0842Pv(i5) { // from class: com.facebook.ads.redexgen.X.98
            });
            this.A02.A07.removeCallbacksAndMessages(null);
            this.A02.A0K(this.A00);
            return;
