...
public final class Y9 implements InterfaceC04499r {
    ...
    @Deprecated
    public Y9(W2 w22, int i, int i5, int i8, int i10, int i11, boolean z) {
        this(w22, i, i5, i8, i10, i11, z, null);
    }

    @Deprecated
    public Y9(W2 w22, int i, int i5, int i8, int i10, int i11, boolean z, I3 i32) {
        String strA01 = A01(54, 19, 78);
        String strA012 = A01(21, 1, 70);
        A03(i8, 0, strA01, strA012);
        String strA013 = A01(22, 32, 48);
        A03(i10, 0, strA013, strA012);
        String strA014 = A01(84, 11, 0);
        A03(i, i8, strA014, strA01);
        A03(i, i10, strA014, strA013);
        A03(i5, i, A01(73, 11, 89), strA014);
        this.A07 = w22;
        this.A06 = ((long) i) * 1000;
        this.A05 = ((long) i5) * 1000;
        this.A04 = ((long) i8) * 1000;
        this.A03 = ((long) i10) * 1000;
        this.A02 = i11;
        this.A09 = z;
        this.A08 = i32;
    }
    ...
    */
    private final int A00(com.meta.analytics.dsp.uinode.Y5[] r4, com.meta.analytics.dsp.uinode.C0602Gh r5) {
        /*
            r3 = this;
            r2 = 0
            r1 = 0
    ...
    public static void A03(int i, int i5, String str, String str2) {
        AbstractC0620Ha.A05(i >= i5, str + A01(0, 21, 44) + str2);
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC04499r
    public final W2 A60() {
        return this.A07;
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC04499r
    public final void ADN(Y5[] y5Arr, TrackGroupArray trackGroupArray, C0602Gh c0602Gh) {
        int iA00 = this.A02;
        if (iA00 == -1) {
            iA00 = A00(y5Arr, c0602Gh);
        }
        this.A00 = iA00;
        this.A07.A04(iA00);
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC04499r
    public final boolean AGI(long j, float f3) {
        boolean targetBufferSizeReached;
        boolean z = true;
        boolean z5 = this.A07.A02() >= this.A00;
        boolean z7 = this.A01;
        long jMin = this.A06;
        if (f3 > 1.0f) {
            jMin = Math.min(IF.A0C(jMin, f3), this.A05);
        }
        if (j < jMin) {
            if (!this.A09 && z5) {
                z = false;
        ...
        if (i32 != null && (targetBufferSizeReached = this.A01) != z7) {
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC04499r
    public final boolean AGL(long j, float f3, boolean z) {
        long jA0D = IF.A0D(j, f3);
        long j4 = z ? this.A03 : this.A04;
        return j4 <= 0 || jA0D >= j4 || (!this.A09 && this.A07.A02() >= this.A00);
    }
