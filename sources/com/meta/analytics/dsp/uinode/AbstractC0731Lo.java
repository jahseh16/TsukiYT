...
public abstract class AbstractC0731Lo {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static Drawable A09(int i, int i5, int i8, int i10) {
        return Build.VERSION.SDK_INT >= 21 ? new RippleDrawable(ColorStateList.valueOf(i5), A06(i, i10), A07(i8, i10)) : A0A(i, i5, i10);
    }
    ...
    static {
        A0E();
        A03 = AbstractC02802p.A01(-1, 0);
        A02 = AbstractC02802p.A01(-16777216, 115);
    ...
    public static int A02(int i) {
        if (A0b(i)) {
            return AbstractC02802p.A02(i, -1, 0.4f);
        }
        return AbstractC02802p.A02(i, -16777216, 0.2f);
    }
    ...
    public static Drawable A08(int i, int i5, int i8) {
        return A09(i, i5, i, i8);
    }

    public static StateListDrawable A0A(int i, int i5, int i8) {
        return A0B(new int[][]{new int[]{R.attr.state_pressed}, new int[0]}, new int[]{i5, i}, i8);
    }
    ...
    */
    public static android.widget.TextView A0C(android.view.ViewGroup r3) {
        ...
        L1e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0731Lo.A0C(android.view.ViewGroup):android.widget.TextView");
    }
    ...
    public static void A0F(int i, View view) {
        ...
        scaleAnimation.setAnimationListener(new C0953Uc(view, scaleAnimation2));
    ...
    public static void A0P(View view, int i, int i5, int i8) {
        GradientDrawable gradientDrawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{A03, A02});
        gradientDrawable.setCornerRadius(i);
        gradientDrawable.setStroke(i5, i8);
        A0S(view, gradientDrawable);
    }

    public static void A0Q(View view, int i, int i5, int i8) {
        A0S(view, A09(i, A02(i), i5, i8));
    }
    ...
    public static void A0Y(Toast toast, String str, int i, int i5, int i8) {
        if (toast == null) {
            return;
        }
        toast.setGravity(i, i5, i8);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0Z(java.util.Map<java.lang.String, java.lang.String> r5, com.meta.analytics.dsp.uinode.AbstractC1167b5 r6) {
        /*
            Method dump skipped, instruction units count: 252
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0731Lo.A0Z(java.util.Map, com.facebook.ads.redexgen.X.b5):void");
    }
    ...
    public static boolean A0b(int i) {
        return AbstractC02802p.A00(i) < 0.5d;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean A0c(com.meta.analytics.dsp.uinode.EnumC02200g r5, java.util.Map<java.lang.String, java.lang.String> r6) {
        /*
            r2 = 10
            r1 = 12
            r0 = 91
            ...
            r1 = 1
        L24:
            com.facebook.ads.redexgen.X.0g r0 = com.meta.analytics.dsp.uinode.EnumC02200g.A07
            if (r5 == r0) goto L30
            r0 = 1
        L29:
            if (r1 == 0) goto L2e
        ...
        L32:
            ...
            goto L24
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0731Lo.A0c(com.facebook.ads.redexgen.X.0g, java.util.Map):boolean");
    }

    public static boolean A0d(C1064Yn c1064Yn, EnumC02200g enumC02200g) {
        return enumC02200g == EnumC02200g.A07 && C0653Ih.A2N(c1064Yn);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean A0e(com.meta.analytics.dsp.uinode.C1064Yn r5, com.meta.analytics.dsp.uinode.EnumC02200g r6, java.util.Map<java.lang.String, java.lang.String> r7) {
        /*
            r2 = 57
            r1 = 21
            r0 = 97
        ...
        L20:
            ...
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.AbstractC0731Lo.A01
            r0 = 6
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        L53:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0731Lo.A0e(com.facebook.ads.redexgen.X.Yn, com.facebook.ads.redexgen.X.0g, java.util.Map):boolean");
    }
}
