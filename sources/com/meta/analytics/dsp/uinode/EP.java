...
public class EP extends AbstractC1060Yj<String> {
    ...
    public final /* synthetic */ C03987o A03;
    ...
    public EP(C03987o c03987o, String str, String str2, int i, double d4, double d5, String str3, Map map) {
        this.A03 = c03987o;
        this.A06 = str;
        this.A05 = str2;
        this.A02 = i;
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC04007r
    ...
    public final String A03() {
        ...
        try {
            ...
            A01(C7q.A06);
            this.A03.A01.A07().A9a(eventId, C8A.A0y, new C8B(e6));
            if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                try {
                    if (sQLiteDatabaseA0E.inTransaction()) {
                        sQLiteDatabaseA0E.endTransaction();
                    ...
                    this.A03.A01.A07().A9a(eventId, C8A.A0z, new C8B(e8));
                }
            }
            C03987o.A08.unlock();
            return null;
