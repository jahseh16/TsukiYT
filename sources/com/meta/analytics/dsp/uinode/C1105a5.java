...
public final class C1105a5<K, V> extends AnonymousClass31<K, V> implements Map<K, V> {
    public AbstractC02892y<K, V> A00;
    ...
    private AbstractC02892y<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C1106a6(this);
        }
        return this.A00;
    }
