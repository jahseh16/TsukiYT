...
public final class C03505j implements NativeAdScrollViewApi {
    ...
    public C03505j(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i5) {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i > 0) {
                this.A06 = C03435c.A03(context);
    ...
    public final void setInset(int i) {
        if (i > 0) {
            float f3 = LD.A02;
            float density = i;
            int insetDp = Math.round(density * f3);
            this.A05.setPadding(insetDp, 0, insetDp, 0);
            float density2 = i / 2;
            this.A05.setPageMargin(Math.round(density2 * f3));
