...
public final class BI extends AbstractC0931Tg {
    ...
    public static String A03(int i, int i5, int i8) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            bArrCopyOfRange[i10] = (byte) ((bArrCopyOfRange[i10] - i8) - 13);
        }
    ...
    public BI(OP op) {
        ...
        C0929Te c0929Te = new C0929Te(this);
        this.A0A = c0929Te;
        this.A0B = new O1(op, getAdDataBundle(), saA01, kpA02, getAdDetailsView(), mcA09, c0929Te);
        ...
        if (supported.A00) {
            ...
            if (!C0653Ih.A18(getAdContextWrapper())) {
                return;
            }
            AbstractC0780Nl.A00(saA01.getVideoImplView(), C0653Ih.A19(getAdContextWrapper()), new OT(this));
        }
    }
    ...
    private SA A01(OP op) {
        ...
        int i = AbstractC0931Tg.A0F;
        int i5 = AbstractC0931Tg.A0F;
        int toolbarHeight = AbstractC0931Tg.A0F;
        imageView.setPadding(i, i5, toolbarHeight, AbstractC0931Tg.A0F);
        int toolbarHeight2 = AbstractC0931Tg.A0G;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC0931Tg.A0G);
        int toolbarHeight3 = AbstractC0931Tg.A0E;
    ...
    private KP A02(OP op) {
        KP kpA0A = op.A0A();
        kpA0A.A06(-1, AbstractC0931Tg.A0B);
        kpA0A.setPadding(AbstractC0931Tg.A0J, AbstractC0931Tg.A0J, AbstractC0931Tg.A0J, AbstractC0931Tg.A0J);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0931Tg.A0I);
    ...
    private void A06() {
        ...
        AbstractC0731Lo.A0H(this.A0C);
        AbstractC0731Lo.A0a(this.A0C, this.A0D, this.A0B, this.A00);
        AbstractC0731Lo.A0L(this.A04);
        Q5 q52 = this.A05;
        ...
        switch (OU.A00[((Q4) pairA03.first).ordinal()]) {
            case 1:
                ...
                break;
            case 2:
                AbstractC0731Lo.A0a(getAdDetailsView());
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC0931Tg.A0H, AbstractC0931Tg.A0H, AbstractC0931Tg.A0H, AbstractC0931Tg.A0H);
        ...
        if (getAdInfo().A0G().A00() >= 0) {
            ...
            L9 l9 = new L9((int) getAdInfo().A0G().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C0928Td(this));
            this.A03 = l9;
            l9.A07();
        }
    }
    ...
    */
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0931Tg
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0931Tg, com.meta.analytics.dsp.uinode.OL, android.view.View
