...
public final class C5A extends AbstractC0500Bq {
    public static byte[] A0C;
    public static String[] A0D = {FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, "UOqHcTLtEs7RiTmy1QusyMeFEB23VRO4", "RTk1kBX5PmCwF3vSKDHM5RpxSToEVllh", "JV0f3puRHBuDT0TwlUq0wFp", "x2su64Hvd39hRMCT3aa5nJ2s0reV8jFq", "Uq5EuILG8kpYquwld9Hd2RiG7wrTKtDW", "n7d5UKOeFpSokQbO2p0B5", "QmvZ7EzKQdyrN87iPZyE0qt0G2nn9i3V"};
    ...
    public int A02;
    public int A03;
    public List<C0583Fn> A05;
    public List<C0583Fn> A06;
    public boolean A07;
    public final int A08;
    public final int A09;
    public final C0645Hz A0A = new C0645Hz();
    public final ArrayList<C0590Fu> A0B = new ArrayList<>();
    public C0590Fu A04 = new C0590Fu(0, 4);
    ...
    private List<C0583Fn> A05() {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < this.A0B.size(); i++) {
            C0583Fn c0583FnA05 = this.A0B.get(i).A05();
            if (c0583FnA05 != null) {
                arrayList.add(c0583FnA05);
            }
        }
        return arrayList;
    }
    ...
    private void A0A(byte b4, byte b6) {
        int i = A0G[b4 & 7];
        int row = b6 & 32;
        int row2 = row != 0 ? 1 : 0;
        if (row2 != 0) {
        ...
        if (i != row3) {
            ...
            if (row4 != 1 && !this.A04.A0F()) {
                int i5 = this.A02;
                int row5 = this.A03;
                C0590Fu c0590Fu = new C0590Fu(i5, row5);
                this.A04 = c0590Fu;
                this.A0B.add(c0590Fu);
            }
            this.A04.A0C(i);
        }
        int cursorOrStyle = (b6 & 16) == 16 ? 1 : 0;
        int row6 = b6 & 1;
        boolean isCursor = row6 == 1;
        int row7 = b6 >> 1;
        int i8 = row7 & 7;
        C0590Fu c0590Fu2 = this.A04;
        int row8 = cursorOrStyle != 0 ? 8 : i8;
        c0590Fu2.A0E(row8, isCursor);
        if (cursorOrStyle != 0) {
            C0590Fu c0590Fu3 = this.A04;
            int row9 = A0F[i8];
            c0590Fu3.A0B(row9);
        }
    }
    ...
    */
    ...
    public static boolean A0F(byte b4, byte b6) {
        return (b4 & 247) == 17 && (b6 & 240) == 32;
    }

    public static boolean A0G(byte b4, byte b6) {
        return (b4 & 247) == 20 && (b6 & 240) == 32;
    }

    public static boolean A0H(byte b4, byte b6) {
        return (b4 & 240) == 16 && (b6 & 192) == 64;
    }

    public static boolean A0I(byte b4, byte b6) {
        return (b4 & 247) == 23 && b6 >= 33 && b6 <= 35;
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0500Bq
    /* JADX INFO: renamed from: A0L */
    public final /* bridge */ /* synthetic */ C5 A54() throws C0585Fp {
        return super.A54();
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0500Bq
    /* JADX INFO: renamed from: A0M */
    public final /* bridge */ /* synthetic */ AbstractC0501Br A55() throws C0585Fp {
        return super.A55();
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0500Bq
    public final WI A0N() {
        List<C0583Fn> list = this.A05;
        this.A06 = list;
        return new WI(list);
    }
    ...
    public final /* bridge */ /* synthetic */ void AEG(C5 c52) throws C0585Fp {
        super.AEG(c52);
    }
                    ...
                    if (i != 2 || (ccData2 & 1) == 1) {
                        if (bA0E != 0 || ccDataHeader != 0) {
                            ...
                            if ((bA0E & 246) == 18 && (ccDataHeader & 224) == 32) {
                                C0590Fu c0590Fu = this.A04;
                                if (A0D[3].length() == 21) {
                                    break;
                                }
                                String[] strArr = A0D;
                                strArr[6] = "seUeLqtTdSBoap5Vmsj4c";
                                strArr[0] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
                                c0590Fu.A06();
                                if ((bA0E & 1) == 0) {
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0500Bq, com.meta.analytics.dsp.uinode.BB
    public final void AEV() {
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0500Bq, com.meta.analytics.dsp.uinode.WL
