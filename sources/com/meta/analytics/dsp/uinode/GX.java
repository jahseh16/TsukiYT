...
public final class GX implements Comparable<GX> {
    ...
    public GX(Format format, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters, int i) {
        ...
        this.A05 = C0498Bo.A0H(i, false) ? 1 : 0;
        this.A03 = C0498Bo.A0K(format, defaultTrackSelector$Parameters.A07) ? 1 : 0;
    ...
    public final int compareTo(GX gx) {
        ...
        int i5 = gx.A05;
        if (i != i5) {
            return C0498Bo.A01(i, i5);
        }
        int i8 = this.A03;
        int i10 = gx.A03;
        if (i8 != i10) {
            return C0498Bo.A01(i8, i10);
        }
        int i11 = this.A02;
        int i12 = gx.A02;
        if (i11 != i12) {
            return C0498Bo.A01(i11, i12);
        }
        if (this.A06.A0D) {
            return C0498Bo.A01(gx.A00, this.A00);
        }
        int i13 = this.A05 != 1 ? -1 : 1;
        int i14 = this.A01;
        int resultSign = gx.A01;
        if (i14 != resultSign) {
            int iA01 = C0498Bo.A01(i14, resultSign) * i13;
            String[] strArr = A07;
        ...
        return i15 != resultSign2 ? C0498Bo.A01(i15, resultSign2) * i13 : C0498Bo.A01(this.A00, gx.A00) * i13;
    }
