...
public class C0772Nd extends WebViewClient {
    ...
    public final WeakReference<C0943Ts> A03;
    public final WeakReference<InterfaceC0770Nb> A04;
    public final WeakReference<AtomicBoolean> A05;
    public final WeakReference<C0723Lg> A06;
    ...
    public C0772Nd(C1064Yn c1064Yn, WeakReference<InterfaceC0770Nb> weakReference, WeakReference<RE> weakReference2, WeakReference<C0723Lg> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C0943Ts> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z) {
        this.A02 = c1064Yn;
    ...
    private void A07(String str, String str2) {
        ...
        if (c1064Yn != null) {
            c1064Yn.A07().A9a(A01(306, 8, 32), C8A.A2a, new C8B(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
        }
    }
    ...
    */
    private boolean A08(android.net.Uri r8) {
        /*
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C0772Nd.A0C
            r0 = 4
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 8
            if (r1 == r0) goto Lac
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C0772Nd.A0C
        ...
        L4f:
            ...
            java.util.List r5 = com.meta.analytics.dsp.uinode.C03696c.A09(r0)
            ...
            r0.toString()
        L7b:
            java.lang.String r3 = com.meta.analytics.dsp.uinode.C0943Ts.A03()
        ...
        Lac:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0772Nd.A08(android.net.Uri):boolean");
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0E().AH8();
        this.A00 = new Date();
        new Handler().postDelayed(new C0944Tt(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean zA0u = C0653Ih.A0u(this.A02);
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        NY.A02(C8A.A2Z);
        InterfaceC0770Nb adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().AB4(str, new C0777Ni().A03(this.A07.get()).A02(this.A06.get()).A05());
            return true;
        }
        return true;
    }
