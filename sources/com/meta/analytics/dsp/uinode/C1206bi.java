...
public final class C1206bi implements C0K {
    ...
    public static String A01(int i, int i5, int i8) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            byte b4 = (byte) ((bArrCopyOfRange[i10] - i8) - 93);
    ...
    static {
        A04();
        A07 = C1206bi.class.getSimpleName();
    }

    public C1206bi(String str) {
        this(str, C0I.A01(str));
    }

    public C1206bi(String str, int i) {
        this(str);
        this.A00 = i;
    }

    public C1206bi(String str, String str2) {
    ...
    private HttpURLConnection A02(int i, int i5) throws IOException, C1208bk {
        ...
        do {
            ...
            if (i8 > 5) {
                String url2 = A01(293, 20, 106) + i8;
                throw new C1208bk(url2);
            }
        } while (code != 0);
        return httpURLConnection;
    }

    private void A03() throws C1208bk {
        String[] strArr;
    ...
    private final void A05(int i, int i5) throws C1208bk {
        try {
            HttpURLConnection httpURLConnectionA02 = A02(i, i5);
            ...
            throw new C1208bk(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e4);
        }
    }
    ...
    public final void close() throws C1208bk {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C1208bk(A01(92, 37, 93), e4);
            }
        }
    }

    @Override // com.meta.analytics.dsp.uinode.C0K
    public final synchronized int length() throws C1208bk {
    ...
    public final int read(byte[] bArr) throws C1208bk {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new C1208bk(strA01 + this.A03, e5);
            }
        }
        throw new C1208bk(strA01 + this.A03 + A01(51, 23, 21));
    }
