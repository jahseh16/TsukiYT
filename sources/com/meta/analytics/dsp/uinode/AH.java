...
public abstract class AH {
    ...
    public int A02(int i, int i5, boolean z) {
        switch (i5) {
            case 0:
                if (i == A06(z)) {
                    return -1;
    ...
    public final int A03(int i, AF af, AG ag, int i5, boolean z) {
        int i8 = A09(i, af).A00;
        int windowIndex = A0B(i8, ag).A01;
        if (windowIndex == i) {
            int iA02 = A02(i8, i5, z);
    ...
    public final Pair<Integer, Long> A08(AG ag, AF af, int i, long j, long j4) {
        AbstractC0620Ha.A00(i, 0, A01());
        A0D(i, ag, false, j4);
        ...
        return Pair.create(Integer.valueOf(i5), Long.valueOf(jA03));
    }
    ...
    public final boolean A0F(int i, AF af, AG ag, int i5, boolean z) {
        return A03(i, af, ag, i5, z) == -1;
    }
}
