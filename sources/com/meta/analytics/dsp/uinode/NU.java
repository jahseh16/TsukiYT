...
public class NU extends WebChromeClient {
    ...
    public final WeakReference<C1064Yn> A00;
    ...
    public static String A00(int i, int i5, int i8) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            int i11 = (bArrCopyOfRange[i10] - i8) - 79;
    ...
    public NU(WeakReference<C1064Yn> weakReference, WeakReference<NS> weakReference2, WeakReference<NO> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        C1064Yn c1064Yn = this.A00.get();
        if (c1064Yn == null || c1064Yn.A0D() == null || !U1.A09) {
            return false;
        }
        if (U1.A08 != null) {
        ...
        try {
            ...
            c1064Yn.A0D().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 112)), 1001);
            return true;
        } catch (Exception e4) {
            c1064Yn.A07().A9b(A00(80, 8, 70), C8A.A2b, new C8B(e4));
