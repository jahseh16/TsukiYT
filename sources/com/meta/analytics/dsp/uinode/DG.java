...
public final class DG {
    ...
    public DG(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z5, boolean z7) {
        this.A02 = (String) AbstractC0620Ha.A01(str);
        this.A01 = str2;
        this.A00 = codecCapabilities;
        this.A04 = z;
        boolean z8 = true;
        this.A03 = (z5 || codecCapabilities == null || !A07(codecCapabilities)) ? false : true;
        this.A06 = codecCapabilities != null && A0B(codecCapabilities);
        if (!z7 && (codecCapabilities == null || !A09(codecCapabilities))) {
            z8 = false;
        }
        this.A05 = z8;
    }
    ...
    public static int A00(String str, String str2, int i) {
        ...
        Log.w(A03(54, 14, 111), A03(9, 29, 122) + str + A03(6, 3, 52) + i + A03(0, 4, 49) + i5 + A03(79, 1, 119));
        return i5;
    }
    ...
    public static DG A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z5) {
        return new DG(str, str2, codecCapabilities, false, z, z5);
    }
    ...
    public static boolean A0D(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i5, double d4) {
        if (d4 == -1.0d || d4 <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            return videoCapabilities.isSizeSupported(i, i5);
        }
        return videoCapabilities.areSizeAndRateSupported(i, i5, d4);
    }
    ...
    public final boolean A0H(int i, int i5, double d4) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            A06(A03(421, 16, 101));
            return false;
        ...
        if (!A0D(videoCapabilities, i, i5, d4)) {
            String strA03 = A03(513, 1, 73);
            if (i >= i5 || !A0D(videoCapabilities, i5, i, d4)) {
                A06(A03(458, 21, 100) + i + strA03 + i5 + strA03 + d4);
                return false;
            }
            A05(A03(437, 21, 29) + i + strA03 + i5 + strA03 + d4);
            return true;
        }
        return true;
    }
    ...
    public final boolean A0I(String str) {
        ...
        String strA05 = AbstractC0638Hs.A05(str);
        if (A08[4].charAt(25) != 'Z') {
            String[] strArr = A08;
