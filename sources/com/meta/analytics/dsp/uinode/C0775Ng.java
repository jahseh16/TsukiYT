...
public final class C0775Ng extends Drawable {
    ...
    public static void A04() {
        A0G = new byte[]{65, 73, 21, 42, 38, 52, 121, 99, 24, 87, 94, 24, 81, 93, 49, 18, 28, 25, 24, 25, 93, 117, 109, 114, 116, 109, 115, 55, 21, 6, 16, 84, 86, 113, 118, 107, 118, 126, 115, 118, 101, 118, 113, 120, 49, 49, 49, 60, 11, 4, 79, 68, 127, 122, 127, 126, 102, 127, 108, 83, 95, 77, 91, 88, 83, 86, 83, 78, 67, 26, 121, 82, 95, 89, 81, 95, 72, 26, 84, 85, 78, 26, 73, 95, 78, 32, 104, 48, 125, 51, 96, 33, 39, 47};
    }
    ...
    public void A03() {
        ...
        if (i <= 0) {
            ...
            if (this.A03 > 0) {
                ...
                int i5 = (int) (jMax / 3600000);
                long j = jMax % 3600000;
                int minutes = (int) (j / 60000);
                int i8 = (int) ((j % 60000) / 1000);
                if (i5 > 0) {
                    sb.append(i5);
    ...
    public final void draw(Canvas canvas) {
        ...
        float canvasMiddleY = f3 - width2;
        float textMiddleX = f4 - height2;
        float textMiddleY = f3 + width2;
        canvas.drawRect(canvasMiddleY - 40.0f, textMiddleX - 40.0f, textMiddleY + 40.0f, f4 + height2 + 40.0f, this.A0B);
        canvas.save();
        canvas.translate(f3 - width2, f4 - height2);
