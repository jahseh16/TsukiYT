...
public final class C0591Fv {
    ...
    public final WJ A05() {
        ...
        float f7 = (0.9f * f4) + 0.05f;
        int i5 = this.A00;
        int i8 = i5 % 3 == 0 ? 0 : i5 % 3 == 1 ? 1 : 2;
        int i10 = i5 / 3 == 0 ? 0 : i5 / 3 == 1 ? 1 : 2;
        int i11 = this.A0E;
        return new WJ(spannableStringBuilder, alignment, f7, 0, i8, f5, i10, Float.MIN_VALUE, i11 != A0O, i11, this.A09);
    }
    ...
    public static int A00(int i, int i5, int i8) {
        return A01(i, i5, i8, 0);
    }

    public static int A01(int i, int i5, int i8, int i10) {
        int i11;
        AbstractC0620Ha.A00(i, 0, 4);
        AbstractC0620Ha.A00(i5, 0, 4);
        AbstractC0620Ha.A00(i8, 0, 4);
        AbstractC0620Ha.A00(i10, 0, 4);
        switch (i10) {
            case 0:
            case 1:
                i11 = 255;
        ...
        int alpha = i > 1 ? 255 : 0;
        return Color.argb(i11, alpha, i5 > 1 ? 255 : 0, i8 > 1 ? 255 : 0);
    }
    ...
    */
    public final void A09(char r7) {
        ...
        L2c:
            ...
            int r5 = r0.size()
            int r3 = r6.A0B
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C0591Fv.A0N
            r0 = 3
            r1 = r1[r0]
            r0 = 10
            ...
            throw r0
        L4d:
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C0591Fv.A0N
        ...
        L6b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0591Fv.A09(char):void");
    }
    ...
    public final void A0B(int i, int i5, int i8) {
    ...
    public final void A0C(int i, int i5, int i8, boolean z, boolean z5, int i10, int i11) {
        if (this.A06 != -1) {
            if (!z) {
    ...
    public final void A0D(int i, int i5, boolean z, int i8, int i10, int i11, int i12) {
        this.A0E = i;
        this.A07 = i12;
    }
    ...
    public final void A0F(boolean z, boolean z5, boolean z7, int i, boolean z8, int i5, int i8, int i10, int i11, int i12, int i13, int i14) {
        this.A0G = true;
        this.A0J = z;
        this.A0I = z5;
        this.A09 = i;
        ...
        if (this.A0B != i10 + 1) {
            ...
            this.A0B = i15;
            while (true) {
                if ((!z5 || this.A0L.size() < this.A0B) && this.A0L.size() < 15) {
                    break;
                } else {
                    this.A0L.remove(0);
                }
        ...
        if (i13 != 0 && this.A0F != i13) {
            this.A0F = i13;
            int i16 = i13 - 1;
            A0D(A0U[i16], A0Q, A0Y[i16], 0, A0W[i16], A0X[i16], A0V[i16]);
        }
        if (i14 != 0 && this.A08 != i14) {
            this.A08 = i14;
            int i17 = i14 - 1;
            A0C(0, 1, 1, false, false, A0S[i17], A0T[i17]);
            A0B(A0P, A0R[i17], A0O);
        }
    }
