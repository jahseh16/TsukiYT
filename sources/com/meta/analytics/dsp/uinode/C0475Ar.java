...
public final class C0475Ar {
    ...
    public long A03;
    public long A04;
    public final C0473Ap A05;

    public C0475Ar(AudioTrack audioTrack) {
        if (IF.A02 >= 19) {
            this.A05 = new C0473Ap(audioTrack);
            A05();
        } else {
            this.A05 = null;
            A00(3);
    ...
    public final boolean A08(long j) {
        C0473Ap c0473Ap = this.A05;
        if (c0473Ap == null || j - this.A03 < this.A04) {
            return false;
        }
        this.A03 = j;
        boolean zA02 = c0473Ap.A02();
        switch (this.A00) {
            case 0:
                if (!zA02) {
