...
public final class X3 implements InterfaceC0528Cy {
    ...
    private boolean A02(C0645Hz c0645Hz, int i) {
        if (c0645Hz.A04() == 0) {
            return false;
        }
        if (c0645Hz.A0E() != i) {
    ...
    public final void A4R(C0645Hz c0645Hz) {
        if (this.A03) {
            if (this.A00 == 2 && !A02(c0645Hz, 32)) {
                return;
            }
            if (this.A00 == 1 && !A02(c0645Hz, 0)) {
                return;
            }
            ...
            int bytesAvailable = c0645Hz.A04();
            for (C4 c4 : this.A05) {
                c0645Hz.A0Y(iA06);
                c4.AFR(c0645Hz, bytesAvailable);
            }
    ...
    */
    public final void A4p(com.meta.analytics.dsp.uinode.InterfaceC0504Bu r15, com.meta.analytics.dsp.uinode.DC r16) {
        /*
            r14 = this;
            r2 = 0
        L1:
