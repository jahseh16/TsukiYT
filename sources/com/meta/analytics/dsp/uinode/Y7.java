...
public final class Y7 implements AC {
    ...
    public final InterfaceC0486Bc<FrameworkMediaCrypto> A03;
    ...
    @Deprecated
    public Y7(Context context, InterfaceC0486Bc<FrameworkMediaCrypto> interfaceC0486Bc, int i, long j) {
        this.A02 = context;
        this.A00 = i;
        this.A01 = j;
        this.A03 = interfaceC0486Bc;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bc != com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> */
    private final void A02(Context context, InterfaceC0486Bc<FrameworkMediaCrypto> interfaceC0486Bc, long j, Handler handler, InterfaceC0649Id interfaceC0649Id, int extensionRendererIndex, ArrayList<Y5> arrayList) throws Exception {
        Class<?> cls;
        Class<?> clazz;
        Class<?> clazz2;
        Class<?> clazz3;
        arrayList.add(new C3F(context, DM.A00, j, interfaceC0486Bc, false, handler, interfaceC0649Id, 50));
        ...
        try {
            ...
            try {
                arrayList.add(size, (Y5) cls.getConstructor(clazz, clazz2, Handler.class, InterfaceC0649Id.class, clazz3).newInstance(true, Long.valueOf(j), handler, interfaceC0649Id, 50));
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bc != com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> */
    private final void A03(Context context, InterfaceC0486Bc<FrameworkMediaCrypto> interfaceC0486Bc, InterfaceC0459Ab[] interfaceC0459AbArr, Handler handler, InterfaceC0467Aj interfaceC0467Aj, int i, ArrayList<Y5> arrayList) throws Exception {
        int extensionRendererIndex;
        int i5;
        String strA00 = A00(0, 23, 97);
        arrayList.add(new C3G(context, DM.A00, interfaceC0486Bc, false, handler, interfaceC0467Aj, AU.A00(context), interfaceC0459AbArr));
        if (i == 0) {
            return;
        }
        int size = arrayList.size();
        ...
        try {
            ...
            try {
                arrayList.add(size, (Y5) Class.forName(A00(403, 66, 96)).getConstructor(Handler.class, InterfaceC0467Aj.class, InterfaceC0459Ab[].class).newInstance(handler, interfaceC0467Aj, interfaceC0459AbArr));
        ...
        try {
            arrayList.add(extensionRendererIndex, (Y5) Class.forName(A00(337, 66, 99)).getConstructor(Handler.class, InterfaceC0467Aj.class, InterfaceC0459Ab[].class).newInstance(handler, interfaceC0467Aj, interfaceC0459AbArr));
        ...
        try {
            try {
                try {
                    arrayList.add(i5, (Y5) Class.forName(A00(270, 67, 124)).getConstructor(Handler.class, InterfaceC0467Aj.class, InterfaceC0459Ab[].class).newInstance(handler, interfaceC0467Aj, interfaceC0459AbArr));
    ...
    private final void A05(Context context, InterfaceC0587Fr interfaceC0587Fr, Looper looper, int i, ArrayList<Y5> arrayList) {
        arrayList.add(new AnonymousClass63(interfaceC0587Fr, looper));
    }

    private final InterfaceC0459Ab[] A06() {
        return new InterfaceC0459Ab[0];
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bc != com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> */
    @Override // com.meta.analytics.dsp.uinode.AC
    public final Y5[] A4l(Handler handler, InterfaceC0649Id interfaceC0649Id, InterfaceC0467Aj interfaceC0467Aj, InterfaceC0587Fr interfaceC0587Fr, DZ dz, InterfaceC0486Bc<FrameworkMediaCrypto> interfaceC0486Bc) throws Exception {
        InterfaceC0486Bc<FrameworkMediaCrypto> interfaceC0486Bc2 = interfaceC0486Bc;
        if (interfaceC0486Bc2 == null) {
            interfaceC0486Bc2 = null;
        }
        ArrayList<Y5> arrayList = new ArrayList<>();
        A02(this.A02, interfaceC0486Bc2, this.A01, handler, interfaceC0649Id, this.A00, arrayList);
        A03(this.A02, interfaceC0486Bc2, A06(), handler, interfaceC0467Aj, this.A00, arrayList);
        A05(this.A02, interfaceC0587Fr, handler.getLooper(), this.A00, arrayList);
