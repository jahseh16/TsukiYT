...
public abstract class AnonymousClass57 {
    ...
    public static int A00(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC03304o abstractC03304o, boolean z) {
        if (abstractC03304o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z) {
            return Math.abs(abstractC03304o.A0p(view) - abstractC03304o.A0p(view2)) + 1;
        }
    ...
    public static int A01(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC03304o abstractC03304o, boolean z) {
        if (abstractC03304o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z) {
        ...
        int iA0p = abstractC03304o.A0p(view);
        int laidOutArea = abstractC03304o.A0p(view2);
        float fAbs = iA0C / (Math.abs(iA0p - laidOutArea) + 1);
        int laidOutArea2 = anonymousClass53.A03();
        return (int) (fAbs * laidOutArea2);
    }

    public static int A02(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC03304o abstractC03304o, boolean z, boolean z5) {
        int laidOutArea;
        if (abstractC03304o.A0W() != 0) {
            ...
            if (iA03 != 0 && view != null && view2 != null) {
                int maxPosition = Math.min(abstractC03304o.A0p(view), abstractC03304o.A0p(view2));
                int iA0p = abstractC03304o.A0p(view);
                int minPosition = abstractC03304o.A0p(view2);
                ...
                int itemsBefore2 = abstractC03304o.A0p(view);
                int minPosition4 = abstractC03304o.A0p(view2);
