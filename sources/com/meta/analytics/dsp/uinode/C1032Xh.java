...
public final class C1032Xh implements InterfaceC0502Bs {
    ...
    public static final InterfaceC0505Bv A09;
    ...
    public static String A03(int i, int i5, int i8) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            byte b4 = (byte) ((bArrCopyOfRange[i10] - i8) - 104);
            String[] strArr = A08;
    ...
    private int A00(int i) throws C04539v {
        String strA03;
        if (!A07(i)) {
            ...
            throw new C04539v(sbAppend.append(strA03).append(A03(0, 12, 31)).append(i).toString());
        }
        if (this.A05) {
            return A0E[i];
        }
    ...
    private int A01(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        interfaceC0503Bt.AFM();
        interfaceC0503Bt.ADv(this.A06, 0, 1);
        byte b4 = this.A06[0];
        if ((b4 & 131) <= 0) {
            return A00((b4 >> 3) & 15);
        }
        throw new C04539v(A03(65, 38, 115) + ((int) b4));
    }

    private int A02(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        if (this.A00 == 0) {
            try {
                int iA01 = A01(interfaceC0503Bt);
                this.A01 = iA01;
                this.A00 = iA01;
        ...
        int iAFQ = this.A03.AFQ(interfaceC0503Bt, this.A00, true);
        if (iAFQ == -1) {
            return -1;
        }
    ...
    private void A04() {
        if (!this.A04) {
            this.A04 = true;
            boolean z = this.A05;
            this.A03.A5n(Format.A06(null, z ? A03(117, 12, 52) : A03(107, 10, 122), null, -1, A0A, 1, z ? 16000 : 8000, -1, null, null, 0, null));
        }
    }
    ...
    private boolean A09(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        byte[] bArr = A0B;
        if (A0A(interfaceC0503Bt, bArr)) {
            this.A05 = false;
            interfaceC0503Bt.AGP(bArr.length);
            return true;
        }
        byte[] bArr2 = A0C;
        if (!A0A(interfaceC0503Bt, bArr2)) {
            return false;
        }
        this.A05 = true;
        interfaceC0503Bt.AGP(bArr2.length);
        return true;
    }

    private boolean A0A(InterfaceC0503Bt interfaceC0503Bt, byte[] bArr) throws InterruptedException, IOException {
        interfaceC0503Bt.AFM();
        byte[] bArr2 = new byte[bArr.length];
        interfaceC0503Bt.ADv(bArr2, 0, bArr.length);
    ...
    public final int AEH(InterfaceC0503Bt interfaceC0503Bt, C0507Bz c0507Bz) throws InterruptedException, IOException {
        if (interfaceC0503Bt.A7i() != 0 || A09(interfaceC0503Bt)) {
            A04();
            return A02(interfaceC0503Bt);
        }
        throw new C04539v(A03(27, 26, 99));
    }
