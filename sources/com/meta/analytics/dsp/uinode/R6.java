...
public class R6 implements MediaController.MediaPlayerControl {
    ...
    public R6(TextureViewSurfaceTextureListenerC0688Ju textureViewSurfaceTextureListenerC0688Ju) {
    ...
    public final boolean isPlaying() {
        if (this.A00.A06 != null) {
            TextureViewSurfaceTextureListenerC0688Ju textureViewSurfaceTextureListenerC0688Ju = this.A00;
            if (A01[3].length() == 27) {
                throw new RuntimeException();
            }
            A01[1] = "lkPRs4KbLtabABAzVL2ijXaoS745wM0q";
            if (textureViewSurfaceTextureListenerC0688Ju.A06.isPlaying()) {
                return true;
            }
        }
        return false;
