...
public abstract class L6 {
    ...
    public static String[] A02 = {"W5GQ1A2ylrhjGcW6pMhO2KpBuuMbjdB5", "Zx6aawmOn04orHuEArp9Y", "DMoITyb3L57ZarlqFv80uTh", "nsJ3", "1RYBeERStpTg7BOn5NhEUzstvZKMnlwS", "VuYSQW8JaBTDlxPB8JxFHKy", FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, "NX"};
    ...
    */
    ...
    public static void A09(Context context) {
        ...
        A04 = L5.A03;
        Executors.newSingleThreadExecutor().execute(new C0961Uk(context));
    }

    public static void A0A(C03927f c03927f, Throwable th) {
        c03927f.A07().A9a(A06(38, 7, 69), C8A.A1c, new C8B(th));
    }
    ...
    public static boolean A0C(C03927f c03927f) {
        ...
        boolean z = true;
        try {
            xmlResourceParserOpenXmlResourceParser = c03927f.getAssets().openXmlResourceParser(A06(0, 19, 71));
            loop0: while (true) {
