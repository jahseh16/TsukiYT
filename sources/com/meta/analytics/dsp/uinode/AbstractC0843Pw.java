...
public abstract class AbstractC0843Pw {
    ...
    public static BitmapDrawable A00(C1064Yn c1064Yn, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1064Yn, overlayBm))) {
                ...
                Resources resources = c1064Yn.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c1064Yn, A02(0, 23, 116));
                    }
                } else {
                    A04(c1064Yn, A02(23, 18, 112));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th) {
            c1064Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(th));
            return null;
        }
    }

    public static C0844Px A01(C1064Yn c1064Yn, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c1064Yn, str)) == null) {
                return null;
            }
            C0844Px overlayView = new C0844Px(c1064Yn);
    ...
    public static void A04(C1064Yn c1064Yn, String str) {
        c1064Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(str));
    }
    ...
    */
    public static boolean A05(com.meta.analytics.dsp.uinode.C1064Yn r5, android.graphics.Bitmap r6) {
        /*
            r3 = 0
        L1:
            int r4 = r6.getWidth()
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.AbstractC0843Pw.A02
            r0 = 2
            r1 = r1[r0]
            r0 = 4
            ...
            if (r1 == r0) goto L4d
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.AbstractC0843Pw.A02
        ...
        L4d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0843Pw.A05(com.facebook.ads.redexgen.X.Yn, android.graphics.Bitmap):boolean");
    }
}
