...
public final class C1025Xa implements CA {
    ...
    private double A00(InterfaceC0503Bt interfaceC0503Bt, int i) throws InterruptedException, IOException {
        long jA02 = A02(interfaceC0503Bt, i);
        if (i == 4) {
    ...
    private long A01(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        interfaceC0503Bt.AFM();
        while (true) {
            interfaceC0503Bt.ADv(this.A06, 0, 4);
            int iA00 = CH.A00(this.A06[0]);
            if (iA00 != -1 && iA00 <= 4) {
                int iA01 = (int) CH.A01(this.A06, iA00, false);
                if (this.A03.A96(iA01)) {
                    interfaceC0503Bt.AGP(iA00);
                    return iA01;
                }
            }
    ...
    private long A02(InterfaceC0503Bt interfaceC0503Bt, int i) throws InterruptedException, IOException {
        interfaceC0503Bt.readFully(this.A06, 0, i);
        long j = 0;
    ...
    private String A04(InterfaceC0503Bt interfaceC0503Bt, int i) throws InterruptedException, IOException {
        if (i == 0) {
            return A03(0, 0, 103);
        }
        byte[] bArr = new byte[i];
        interfaceC0503Bt.readFully(bArr, 0, i);
    ...
    @Override // com.meta.analytics.dsp.uinode.CA
    public final boolean AEJ(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        ...
        while (true) {
            ...
            if (this.A01 == 0) {
                long jA05 = this.A04.A05(interfaceC0503Bt, true, false, 4);
                if (jA05 == -2) {
                    jA05 = A01(interfaceC0503Bt);
                }
                if (jA05 == -1) {
                    return false;
                }
            ...
            if (this.A01 == 1) {
                this.A02 = this.A04.A05(interfaceC0503Bt, false, true, 8);
                this.A01 = 2;
            }
            ...
            switch (iA6s) {
                ...
                case 2:
                    long j = this.A02;
                    if (j <= 8) {
                        this.A03.A8t(this.A00, A02(interfaceC0503Bt, (int) j));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C04539v(A03(41, 22, 116) + this.A02);
                case 3:
                    long j4 = this.A02;
                    if (j4 <= 2147483647L) {
                        this.A03.AGc(this.A00, A04(interfaceC0503Bt, (int) j4));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C04539v(A03(63, 21, 6) + this.A02);
                case 4:
                    this.A03.A42(this.A00, (int) this.A02, interfaceC0503Bt);
                    if (A08[7].charAt(2) != 'S') {
                ...
                case 5:
                    long j7 = this.A02;
                    if (j7 == 4 || j7 == 8) {
                        this.A03.A5j(this.A00, A00(interfaceC0503Bt, (int) j7));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C04539v(A03(21, 20, 43) + this.A02);
                default:
                    throw new C04539v(A03(0, 21, 11) + iA6s);
            }
        }
    }
