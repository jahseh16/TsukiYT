...
public final class E4 implements XV {
     ...
     */
    public static E4 A01(long j, long j4, By by, C0645Hz c0645Hz) {
        int iA0H;
        int i = by.A04;
        int i5 = by.A03;
        int iA08 = c0645Hz.A08();
        if ((iA08 & 1) != 1 || (iA0H = c0645Hz.A0H()) == 0) {
            return null;
        }
        long jA0F = IF.A0F(iA0H, ((long) i) * 1000000, i5);
        if ((iA08 & 6) != 6) {
            return new E4(j4, by.A02, jA0F);
        }
        long jA0H = c0645Hz.A0H();
        long[] jArr = new long[100];
        for (int i8 = 0; i8 < 100; i8++) {
            jArr[i8] = c0645Hz.A0E();
        }
        if (j != -1 && j != j4 + jA0H) {
            Log.w(A02(27, 10, 25), A02(2, 25, 119) + j + A02(0, 2, 77) + (j4 + jA0H));
        }
        return new E4(j4, by.A02, jA0F, jA0H, jArr);
    }
    ...
    public final long A88(long j) {
        ...
        double d4 = (j4 * 256.0d) / this.A01;
        int iA0B = IF.A0B(this.A04, (long) d4, true, true);
        long jA00 = A00(iA0B);
        long j7 = this.A04[iA0B];
        long jA002 = A00(iA0B + 1);
        return Math.round((jA002 - jA00) * (j7 == (iA0B == 99 ? 256L : this.A04[iA0B + 1]) ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : (d4 - j7) / (r9 - j7))) + jA00;
    }
    ...
    public E4(long j, int i, long j4) {
        this(j, i, j4, -1L, null);
    }

    public E4(long j, int i, long j4, long j7, long[] jArr) {
        this.A02 = j;
        this.A00 = i;
        this.A03 = j4;
        this.A01 = j7;
    ...
    public final C0 A7t(long j) {
        ...
        if (!A9I()) {
            return new C0(new C2(0L, this.A02 + ((long) this.A00)));
        }
        long jA0E = IF.A0E(j, 0L, this.A03);
        double d4 = (jA0E * 100.0d) / this.A03;
        if (d4 <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            ...
            scaledPosition = ((d5 - prevScaledPosition) * (d4 - d6)) + prevScaledPosition;
        }
