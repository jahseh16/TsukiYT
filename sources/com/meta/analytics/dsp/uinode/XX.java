...
public final class XX implements InterfaceC0502Bs {
    ...
    public static final InterfaceC0505Bv A0r;
    ...
    public final C0645Hz A0j;
    public final C0645Hz A0k;
    public final C0645Hz A0l;
    public final C0645Hz A0m;
    public final C0645Hz A0n;
    public final boolean A0o;

    public static String A03(int i, int i5, int i8) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0p, i, i + i5);
    ...
    */
    private void A08(com.meta.analytics.dsp.uinode.InterfaceC0503Bt r11, com.meta.analytics.dsp.uinode.CE r12, int r13) throws java.lang.InterruptedException, java.io.IOException {
        /*
    ...
    public XX(CA ca, int i) {
        ...
        this.A0k = new C0645Hz(4);
        this.A0n = new C0645Hz(ByteBuffer.allocate(4).putInt(-1).array());
        this.A0l = new C0645Hz(4);
        this.A0i = new C0645Hz(AbstractC0641Hv.A03);
        this.A0h = new C0645Hz(4);
        this.A0j = new C0645Hz();
        this.A0m = new C0645Hz();
        this.A0f = new C0645Hz(8);
        this.A0g = new C0645Hz();
    }

    private int A00(InterfaceC0503Bt interfaceC0503Bt, C4 c4, int i) throws InterruptedException, IOException {
        int bytesRead;
        ...
        if (strippedBytesLeft > 0) {
            ...
            bytesRead = c4.AFQ(interfaceC0503Bt, i, false);
        }
        this.A07 += bytesRead;
        this.A08 += bytesRead;
        return bytesRead;
    ...
    private long A01(long j) throws C04539v {
        long j4 = this.A0M;
        if (j4 != -9223372036854775807L) {
            return IF.A0F(j, j4, 1000L);
        }
        throw new C04539v(A03(189, 54, 68));
    }
    ...
    */
    ...
    private void A07(InterfaceC0503Bt interfaceC0503Bt, int i) throws InterruptedException, IOException {
        if (this.A0k.A07() >= i) {
            return;
        }
        if (this.A0k.A05() < i) {
            C0645Hz c0645Hz = this.A0k;
            c0645Hz.A0b(Arrays.copyOf(c0645Hz.A00, Math.max(this.A0k.A00.length * 2, i)), this.A0k.A07());
        }
        ...
        interfaceC0503Bt.readFully(bArr, iA07, i - this.A0k.A07());
        this.A0k.A0X(i);
    }

    private void A09(InterfaceC0503Bt interfaceC0503Bt, byte[] bArr, int i) throws InterruptedException, IOException {
        ...
        interfaceC0503Bt.readFully(bArr2, sizeWithPrefix3, i);
        this.A0m.A0W(length);
    }

    private void A0A(InterfaceC0503Bt interfaceC0503Bt, byte[] bArr, int i, int i5) throws InterruptedException, IOException {
        int iMin = Math.min(i5, this.A0j.A04());
        int pendingStrippedBytes = i5 - iMin;
        interfaceC0503Bt.readFully(bArr, i + iMin, pendingStrippedBytes);
        if (iMin > 0) {
    ...
    private void A0C(CE ce, String str, int i, long j, byte[] bArr) {
        ...
        C4 c4 = ce.A0W;
        C0645Hz c0645Hz = this.A0m;
        c4.AFR(c0645Hz, c0645Hz.A07());
        this.A08 += this.A0m.A07();
    }

    public static void A0D(byte[] bArr, long j, String str, int i, long j4, byte[] bArr2) {
        byte[] timeCodeData;
        if (j == -9223372036854775807L) {
            timeCodeData = bArr2;
        } else {
            int i5 = (int) (j / 3600000000L);
            long j7 = j - (((long) (i5 * 3600)) * 1000000);
            int i8 = (int) (j7 / 60000000);
            int minutes = i8 * 60;
            long j8 = j7 - (((long) minutes) * 1000000);
            int lastValue = (int) (j8 / 1000000);
            int seconds = (int) ((j8 - (((long) lastValue) * 1000000)) / j4);
            timeCodeData = IF.A0i(String.format(Locale.US, str, Integer.valueOf(i5), Integer.valueOf(i8), Integer.valueOf(lastValue), Integer.valueOf(seconds)));
        }
        System.arraycopy(timeCodeData, 0, bArr, i, bArr2.length);
    }

    private boolean A0E(C0507Bz c0507Bz, long j) {
        if (this.A0Y) {
            this.A0J = j;
            c0507Bz.A00 = this.A0F;
            this.A0Y = false;
            return true;
        }
        boolean z = this.A0a;
    ...
    public final void A0I(int i) throws C04539v {
        switch (i) {
            case 160:
                if (this.A04 != 2) {
                    return;
            ...
            case 19899:
                ...
                throw new C04539v(A03(667, 50, 26));
            case 25152:
                if (!this.A0O.A0c) {
                    return;
                }
                if (this.A0O.A0V != null) {
                    this.A0O.A0U = new DrmInitData(new DrmInitData.SchemeData(C9W.A04, A03(UserMetadata.MAX_ATTRIBUTE_SIZE, 10, 63), this.A0O.A0V.A03));
                    return;
                }
                throw new C04539v(A03(449, 55, 115));
            case 28032:
                if (!this.A0O.A0c || this.A0O.A0f == null) {
                    return;
                } else {
                    throw new C04539v(A03(243, 53, 10));
                }
            case 357149030:
            ...
            case 374648427:
                ...
                throw new C04539v(A03(756, 26, 64));
            case 475249515:
                if (this.A0a) {
                    return;
                }
    ...
    public final void A0J(int i, double d4) {
        switch (i) {
            case 181:
                this.A0O.A0O = (int) d4;
                break;
            case 17545:
                ...
                break;
            case 21969:
                this.A0O.A06 = (float) d4;
                break;
            case 21970:
                this.A0O.A07 = (float) d4;
                break;
            case 21971:
                this.A0O.A04 = (float) d4;
                break;
            case 21972:
                this.A0O.A05 = (float) d4;
                break;
            case 21973:
                this.A0O.A02 = (float) d4;
                break;
            case 21974:
                this.A0O.A03 = (float) d4;
                break;
            case 21975:
                this.A0O.A08 = (float) d4;
                break;
            case 21976:
                this.A0O.A09 = (float) d4;
                break;
            case 21977:
                this.A0O.A00 = (float) d4;
                break;
            case 21978:
                this.A0O.A01 = (float) d4;
                break;
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0K(int r20, int r21, com.meta.analytics.dsp.uinode.InterfaceC0503Bt r22) throws java.lang.InterruptedException, java.io.IOException {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0L(int r11, long r12) throws com.meta.analytics.dsp.uinode.C04539v {
        /*
    ...
    public final void A0M(int i, long j, long j4) throws C04539v {
        switch (i) {
            case 160:
                this.A0W = false;
                return;
            ...
            case 408125543:
                ...
                throw new C04539v(A03(717, 39, 113));
            case 475249515:
                this.A0Q = new C0635Hp();
                this.A0P = new C0635Hp();
                return;
            case 524531317:
                if (this.A0a) {
                    return;
                ...
                if (this.A0o && this.A0F != -1) {
                    ...
                    this.A0N.AFi(new C1034Xj(this.A0H));
                    this.A0a = true;
                    return;
                }
        }
    ...
    public final void A0N(int i, String str) throws C04539v {
        switch (i) {
            case 134:
                this.A0O.A0Y = str;
                return;
            case 17026:
                if (A03(1034, 4, 113).equals(str) || A03(1016, 8, 122).equals(str)) {
                    ...
                    throw new C04539v(A03(369, 8, 117) + str + A03(0, 14, 21));
                }
            case 2274716:
                this.A0O.A0g = str;
                return;
    ...
    public final int AEH(InterfaceC0503Bt interfaceC0503Bt, C0507Bz c0507Bz) throws InterruptedException, IOException {
        ...
        boolean zAEJ = true;
        while (zAEJ && !this.A0V) {
            zAEJ = this.A0d.AEJ(interfaceC0503Bt);
            if (zAEJ && A0E(c0507Bz, interfaceC0503Bt.A7i())) {
                return 1;
            }
        }
        if (zAEJ) {
    ...
    */
    ...
    public final boolean AGR(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        return new CG().A01(interfaceC0503Bt);
    }
}
