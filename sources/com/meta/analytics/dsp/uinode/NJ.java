...
public final class NJ extends LinearLayout {
    ...
    public static String A06(int i, int i5, int i8) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            byte b4 = (byte) ((bArrCopyOfRange[i10] ^ i8) ^ 39);
            String[] strArr = A0F;
    ...
    static {
        ...
        A0I = AbstractC0715Ky.A00(A06(90, 23, 31));
        A0J = new ND();
        A0H = Color.argb(34, 0, 0, 0);
    }

    public NJ(C1064Yn c1064Yn, WebView webView) {
        this(c1064Yn, webView, false);
    }

    public NJ(C1064Yn c1064Yn, WebView webView, boolean z) {
        super(c1064Yn);
        this.A09 = getResources().getDisplayMetrics().density;
        this.A0C = new U3(this);
        this.A0A = webView;
        this.A0B = c1064Yn;
        this.A08 = AbstractC0654Ii.A06(c1064Yn);
        this.A0D = z;
        A08();
    }
    ...
    private void A08() {
        ...
        this.A01.setImageBitmap(AbstractC0740Lx.A01(EnumC0739Lw.BROWSER_CLOSE));
        ImageView imageView2 = this.A01;
        View.OnTouchListener onTouchListener = A0J;
        imageView2.setOnTouchListener(onTouchListener);
        this.A01.setOnClickListener(new NE(this));
        addView(this.A01, layoutParams);
        if (this.A08 && !C0653Ih.A2N(this.A0B)) {
        ...
        if (C0653Ih.A2N(this.A0B) && !this.A0D) {
            LinearLayout linearLayout = new LinearLayout(this.A0B);
            this.A04 = linearLayout;
            linearLayout.setOrientation(1);
            LinearLayout linearLayout2 = this.A04;
            float f3 = this.A09;
            int buttonSizePx2 = (int) (f3 * 2.0f);
            linearLayout2.setPadding(0, (int) (f3 * 2.0f), 0, buttonSizePx2);
            layoutParams2.setMarginStart(0);
            addView(this.A04, layoutParams2);
            ImageView imageView4 = new ImageView(this.A0B);
            imageView4.setScaleType(ImageView.ScaleType.CENTER);
            imageView4.setImageBitmap(AbstractC0740Lx.A01(EnumC0739Lw.HANDLER));
            float f4 = this.A09;
            int buttonSizePx3 = (int) (f4 * 4.0f);
            imageView4.setPadding(0, (int) (f4 * 4.0f), 0, buttonSizePx3);
        ...
        if (this.A08 && !C0653Ih.A2N(this.A0B)) {
            ...
            this.A02.setImageBitmap(AbstractC0740Lx.A02(EnumC0739Lw.BACK_ARROW));
    ...
    */
    private void A09() {
        ...
        L2e:
            com.facebook.ads.redexgen.X.Yn r0 = r6.A0B
            boolean r0 = com.meta.analytics.dsp.uinode.C0653Ih.A2N(r0)
            if (r0 == 0) goto L41
            android.widget.ImageView r0 = r6.A03
            r0.setVisibility(r4)
            com.facebook.ads.redexgen.X.Lw r0 = com.meta.analytics.dsp.uinode.EnumC0739Lw.BROWSER_LAUNCH_NATIVE
            android.graphics.Bitmap r5 = com.meta.analytics.dsp.uinode.AbstractC0740Lx.A01(r0)
        L41:
        ...
        L5b:
            ...
            if (r0 == 0) goto L8d
            com.facebook.ads.redexgen.X.Lw r0 = com.meta.analytics.dsp.uinode.EnumC0739Lw.BROWSER_LAUNCH_CHROME
            android.graphics.Bitmap r5 = com.meta.analytics.dsp.uinode.AbstractC0740Lx.A01(r0)
            goto L2e
        L8d:
            com.facebook.ads.redexgen.X.Lw r0 = com.meta.analytics.dsp.uinode.EnumC0739Lw.BROWSER_LAUNCH_NATIVE
