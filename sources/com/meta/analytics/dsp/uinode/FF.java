...
public final class FF extends AbstractC1136aa {
    ...
    public static final AnonymousClass27 A03 = new C1124aO();
    public C1129aT A00;
    ...
    public final void A09() {
        C1129aT c1129aT = new C1129aT(this.A01, this, A04());
        this.A00 = c1129aT;
        c1129aT.A0G(this.A01.A0B(), this.A01.A07());
    }
    ...
    public final void A0D(InterstitialAd interstitialAd, EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        C1129aT c1129aT = this.A00;
        if (c1129aT != null) {
            c1129aT.A0G(cacheFlags, str);
            return;
        }
        this.A01.A0K(cacheFlags);
        this.A01.A0H(str);
        if (AbstractC0655Ik.A07(this.A02) && AbstractC0655Ik.A08(this.A02)) {
            A05();
        } else {
            A09();
        }
    ...
    public final boolean A0H(InterstitialAd interstitialAd, InterstitialAd.InterstitialShowAdConfig interstitialShowAdConfig) {
        ...
        C1129aT c1129aT2 = new C1129aT(this.A01, this, A04());
        this.A00 = c1129aT2;
        c1129aT2.A0J();
        return false;
    }
