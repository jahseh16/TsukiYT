...
public abstract class C1F implements Serializable {
    ...
    public static String A01(int i, int i5, int i8) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0T, i, i + i5);
    ...
    public static C1F A00(JSONObject jSONObject, C1064Yn c1064Yn) {
        ...
        if (zHas) {
            try {
                c1fA02 = C1165b3.A02(jSONObject, c1064Yn);
        ...
        if (c1fA02 == null) {
            zHas = false;
            c1fA02 = FS.A02(jSONObject, c1064Yn);
        }
        c1fA02.A0e(zHas);
        c1fA02.A0B(z);
        return c1fA02;
