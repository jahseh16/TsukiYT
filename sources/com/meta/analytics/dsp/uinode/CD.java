...
public final class CD implements WP, InterfaceC0504Bu, H6<WT>, H9, FA {
    ...
    public final C0556Ek A0S;
    public final InterfaceC0557El A0T;
    public final F1 A0U;
    public final InterfaceC0607Gm A0V;
    public final InterfaceC0615Gu A0W;
    public final String A0b;
    public final C0992Vq A0X = new C0992Vq(A07(0, 27, 27));
    public final C0626Hg A0Y = new C0626Hg();
    public final Runnable A0Z = new RunnableC0554Ei(this);
    public final Runnable A0a = new RunnableC0555Ej(this);
    ...
    public final long AFm(InterfaceC0601Gg[] interfaceC0601GgArr, boolean[] zArr, FB[] fbArr, boolean[] zArr2, long j) {
        AbstractC0620Ha.A04(this.A0F);
        int i = this.A01;
        int i5 = 0;
        while (true) {
            int i8 = 0;
            if (i5 >= interfaceC0601GgArr.length) {
                boolean z = !this.A0I ? j == 0 : i != 0;
                for (int i10 = 0; i10 < interfaceC0601GgArr.length; i10++) {
                    if (fbArr[i10] == null && interfaceC0601GgArr[i10] != null) {
                        InterfaceC0601Gg interfaceC0601Gg = interfaceC0601GgArr[i10];
                        AbstractC0620Ha.A04(interfaceC0601Gg.length() == 1);
                        AbstractC0620Ha.A04(interfaceC0601Gg.A7C(0) == 0);
                        int iA00 = this.A09.A00(interfaceC0601Gg.A8A());
                        AbstractC0620Ha.A04(!this.A0L[iA00]);
                        this.A01++;
                        this.A0L[iA00] = true;
                        fbArr[i10] = new WS(this, iA00);
                        zArr2[i10] = true;
                        if (!z) {
                            WO wo = this.A0K[iA00];
                            wo.A0J();
            ...
            if (fb2 != null && (interfaceC0601GgArr[i5] == null || !zArr[i5])) {
                int i12 = ((WS) fbArr[i5]).A00;
                AbstractC0620Ha.A04(this.A0L[i12]);
                this.A01--;
                this.A0L[i12] = false;
                fbArr[i5] = null;
            }
    ...
    public CD(Uri uri, InterfaceC0615Gu interfaceC0615Gu, InterfaceC0502Bs[] interfaceC0502BsArr, int i, F1 f1, InterfaceC0557El interfaceC0557El, InterfaceC0607Gm interfaceC0607Gm, String str, int i5) {
        this.A0Q = uri;
        this.A0W = interfaceC0615Gu;
        this.A0O = i;
        this.A0U = f1;
        this.A0T = interfaceC0557El;
        this.A0V = interfaceC0607Gm;
        this.A0b = str;
        this.A0P = i5;
        this.A0S = new C0556Ek(interfaceC0502BsArr, this);
        this.A00 = i == -1 ? 3 : i;
        f1.A03();
    }
    ...
    public final int AC2(WT wt, long j, long j4, IOException iOException) {
        boolean isErrorFatal = A0N(iOException);
        this.A0U.A0H(wt.A03, 1, -1, null, 0, null, wt.A02, this.A03, j, j4, wt.A00, iOException, isErrorFatal);
        A0E(wt);
        if (isErrorFatal) {
            return 3;
        }
    ...
    public void A09() {
        ...
        while (true) {
            ...
            if (!AbstractC0638Hs.A0B(str) && !AbstractC0638Hs.A09(str)) {
                isAudioVideo = false;
            }
    ...
    private void A0C(int i) {
        if (!this.A0M[i]) {
            ...
            this.A0U.A06(AbstractC0638Hs.A01(formatA01.A0O), formatA01, 0, null, this.A04);
    ...
    public final void AC1(WT wt, long j, long j4) {
        long j7;
        if (this.A03 == -9223372036854775807L) {
            ...
            this.A03 = j7;
            this.A0T.AD9(j7, this.A07.A9I());
        }
        this.A0U.A0G(wt.A03, 1, -1, null, 0, null, wt.A02, this.A03, j, j4, wt.A00);
        A0E(wt);
        this.A0B = true;
        this.A08.ABC(this);
    }
    ...
    public final void ABz(WT wt, long j, long j4, boolean z) {
        this.A0U.A0F(wt.A03, 1, -1, null, 0, null, wt.A02, this.A03, j, j4, wt.A00);
        if (!z) {
            A0E(wt);
            for (WO wo : this.A0K) {
                wo.A0I();
    ...
    public final int A0P(int i, C04479p c04479p, C1042Xr c1042Xr, boolean z) {
        if (A0J()) {
            return -3;
        }
        int iA0E = this.A0K[i].A0E(c04479p, c1042Xr, z, this.A0B, this.A04);
        if (iA0E == -4) {
            A0C(i);
        } else if (iA0E == -3) {
            A0D(i);
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0504Bu
    ...
    @Override // com.meta.analytics.dsp.uinode.WP
    public final long A5x(long j, AD ad2) {
        if (!this.A07.A9I()) {
            return 0L;
        }
        C0 c0A7t = this.A07.A7t(j);
        return IF.A0I(j, ad2, c0A7t.A00.A01, c0A7t.A01.A01);
    }
    ...
    public final long A6D() {
        ...
        if (this.A0A) {
            ...
            for (int i5 = 0; i5 < i; i5++) {
                if (this.A0N[i5]) {
                    jA02 = Math.min(jA02, this.A0K[i5].A0F());
                }
            }
        } else {
            jA02 = A02();
    ...
    public final long AEL() {
        ...
        if (strArr[6].length() != strArr[0].length()) {
            A0d[2] = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING;
