...
public final class Q0 extends FrameLayout {
    ...
    public final C02411c A04;
    public final C1064Yn A05;
    public final J2 A06;
    public final InterfaceC0770Nb A07;
    public final C0943Ts A08;
    public final InterfaceC0845Py A09;
    ...
    public static String A06(int i, int i5, int i8) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            ...
            bArrCopyOfRange[i10] = (byte) (i11 ^ 37);
        }
    ...
    public Q0(C1064Yn c1064Yn, AbstractC1167b5 abstractC1167b5, C02411c c02411c, J2 j22, InterfaceC0845Py interfaceC0845Py, Map<String, String> playableMetricsData) {
        super(c1064Yn);
        this.A0A = new AtomicBoolean(false);
        this.A0B = new AtomicBoolean(false);
        this.A01 = -1L;
        this.A00 = 0;
        this.A07 = new AbstractC0946Tv() { // from class: com.facebook.ads.redexgen.X.9O
        ...
        this.A04 = c02411c;
        this.A06 = j22;
        this.A09 = interfaceC0845Py;
        this.A02 = playableMetricsData;
        C0943Ts c0943TsA04 = A04();
        this.A08 = c0943TsA04;
        if (C0653Ih.A1W(c1064Yn)) {
            c1064Yn.A0A().AGv(c0943TsA04, abstractC1167b5.A12(), false);
        }
        addView(c0943TsA04, A0F);
    }
    ...
    private C0943Ts A04() {
        C0943Ts c0943Ts = new C0943Ts(this.A05, (WeakReference<InterfaceC0770Nb>) new WeakReference(this.A07), 10, C0653Ih.A1f(this.A05));
        c0943Ts.setCornerRadius(A0E);
        c0943Ts.setLogMultipleImpressions(false);
        c0943Ts.setCheckAssetsByJavascriptBridge(false);
        c0943Ts.setWebViewTimeoutInMillis(this.A04.A08());
        c0943Ts.setRequestId(this.A03.A0S());
        c0943Ts.setOnTouchListener(new ViewOnTouchListenerC0846Pz(this));
        WebSettings settings = c0943Ts.getSettings();
        ...
        if (Build.VERSION.SDK_INT > 16) {
            c0943Ts.addJavascriptInterface(new Q1(this.A05, this, this.A06, this.A02, this.A03.A12()), A06(0, 12, 104));
        }
        return c0943Ts;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x00b8, code lost:
        ...
        if (r3 <= com.meta.analytics.dsp.uinode.C0653Ih.A0H(r8)) goto L14;
     */
    ...
    */
    ...
    public final void A0B() {
        ...
        if (this.A04.A0J()) {
            ...
            if (C0653Ih.A0m(this.A05) && AbstractC0720Ld.A00(this.A05) == EnumC0719Lc.A07) {
        ...
        try {
            ...
            c0943Ts.loadUrl(strA0E);
        } catch (Exception e5) {
            this.A05.A07().A9a(A06(192, 8, 57), C8A.A2d, new C8B(e5));
        }
    }

    public final void A0C() {
        if (C0653Ih.A1W(this.A05)) {
            C1064Yn c1064Yn = this.A05;
            if (A0D[2].length() == 31) {
                throw new RuntimeException();
            }
            A0D[1] = "2a9geg5CZy9bcTekyOeVTlcxLNQduX9G";
            c1064Yn.A0A().AGk(this.A08);
        }
