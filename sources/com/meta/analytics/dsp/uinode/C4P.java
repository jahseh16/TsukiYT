...
public final class C4P implements Runnable {
    ...
    public long A00;
    public long A01;
    public ArrayList<C0547Eb> A02 = new ArrayList<>();
    ...
    private AnonymousClass56 A00(C0547Eb c0547Eb, int i, long j) {
        if (A08(c0547Eb, i)) {
            return null;
        }
        C03374w c03374w = c0547Eb.A0r;
        try {
            c0547Eb.A1K();
            AnonymousClass56 anonymousClass56A0I = c03374w.A0I(i, false, j);
            if (anonymousClass56A0I != null) {
                if (anonymousClass56A0I.A0Y() && !anonymousClass56A0I.A0Z()) {
                    c03374w.A0T(anonymousClass56A0I.A0H);
                } else {
                    c03374w.A0Z(anonymousClass56A0I, false);
                }
            }
    ...
    */
    private void A02() {
        ...
        L8:
            ...
            com.facebook.ads.redexgen.X.Eb r1 = (com.meta.analytics.dsp.uinode.C0547Eb) r1
        ...
        L51:
            ...
            com.facebook.ads.redexgen.X.Eb r9 = (com.meta.analytics.dsp.uinode.C0547Eb) r9
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void A07(com.meta.analytics.dsp.uinode.C0547Eb r7, long r8) {
        /*
            r6 = this;
            if (r7 != 0) goto L3
            return
        ...
        L26:
            ...
            com.meta.analytics.dsp.uinode.AbstractC02812q.A01(r0)     // Catch: java.lang.Throwable -> L6e
    ...
    public static boolean A08(C0547Eb c0547Eb, int i) {
        int iA06 = c0547Eb.A01.A06();
        for (int i5 = 0; i5 < iA06; i5++) {
            AnonymousClass56 anonymousClass56A0F = C0547Eb.A0F(c0547Eb.A01.A0A(i5));
    ...
    public final void A09(C0547Eb c0547Eb) {
        this.A02.add(c0547Eb);
    }

    public final void A0A(C0547Eb c0547Eb) {
        this.A02.remove(c0547Eb);
    }

    public final void A0B(C0547Eb c0547Eb, int i, int i5) {
        if (c0547Eb.isAttachedToWindow() && this.A01 == 0) {
            this.A01 = c0547Eb.getNanoTime();
            c0547Eb.post(this);
        }
        c0547Eb.A02.A03(i, i5);
    }

    @Override // java.lang.Runnable
    public final void run() {
        try {
            AbstractC02812q.A01(A01(18, 11, 2));
            if (this.A02.isEmpty()) {
                return;
            }
            ...
            for (int i = 0; i < size; i++) {
                C0547Eb c0547Eb = this.A02.get(i);
                if (c0547Eb.getWindowVisibility() == 0) {
                    jMax = Math.max(c0547Eb.getDrawingTime(), jMax);
                }
            }
            if (jMax == 0) {
                this.A01 = 0L;
