...
public final class AnonymousClass84 {
    ...
    public static int A00(String str, int i, C03927f c03927f) {
    ...
    public static void A05(C03927f c03927f, int i, int i5) {
        c03927f.A07().A9a(A01(435, 10, 113), C8A.A2X, new C8B(A01(338, 33, 80) + i, A01(87, 9, 13) + i5));
    }

    @Deprecated
    public static void A06(C03927f c03927f, String str, int i, C8B c8b) {
        if (c03927f == null) {
            A0F(new RuntimeException(A01(48, 39, 84)));
            return;
        }
        AbstractC03917e.A01(c03927f.A01());
        if (A02 && c8b.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 70) + str + A01(31, 16, 8) + i, c8b));
        }
        try {
            if (A0J(c03927f, str, i, Math.random(), c8b)) {
                A09(c03927f, str, i, c8b);
            }
        } catch (Throwable t3) {
            A0F(t3);
        }
    ...
    @Deprecated
    public static void A07(C03927f c03927f, String str, int i, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A0A(false);
            c8b.A06(1);
    ...
    @Deprecated
    public static void A08(C03927f c03927f, String str, int i, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A08(false);
            A06(c03927f, str, i, c8b);
    ...
    public static void A09(C03927f c03927f, String str, int i, C8B c8b) {
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                int iA01 = Ij.A01(c03927f);
                ...
                A0A(c03927f, str, i, c8b, true);
            }
        }
    }

    public static void A0A(C03927f c03927f, String str, int i, C8B c8b, boolean z) throws Throwable {
        AnonymousClass83 anonymousClass83 = A0B.get();
        boolean z5 = anonymousClass83 != null && anonymousClass83.A9G();
        if (A08.get() || z5) {
            int iA01 = c8b.A01();
            String strA01 = A01(289, 17, 46);
            String strA012 = A01(31, 16, 8);
            if (iA01 == 0) {
                Log.e(strA01, A01(182, 37, 40) + str + strA012 + i, c8b);
            } else {
                Log.i(strA01, A01(306, 32, 116) + str + strA012 + i + A01(19, 12, 63) + c8b.getMessage() + A01(0, 19, 80) + c8b.A03());
            }
        }
        C1055Ye c1055Ye = new C1055Ye(c03927f, str, i, c8b, anonymousClass83);
        if (z) {
            A01.execute(c1055Ye);
        } else {
            c1055Ye.run();
    ...
    public static void A0C(C1063Ym c1063Ym, AnonymousClass83 anonymousClass83, AnonymousClass82 anonymousClass82, boolean z) {
        ...
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1056Yf(c1063Ym));
            }
        }
    }
    ...
    public static boolean A0H(C03927f c03927f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        return (shouldSkipFunnelEventsForSession == null || !shouldSkipFunnelEventsForSession.booleanValue()) && Ij.A0A(c03927f) != 0;
    }

    public static boolean A0I(C03927f c03927f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        if (shouldSkipFunnelEventsForSession != null && shouldSkipFunnelEventsForSession.booleanValue()) {
            return false;
        }
        double funnelEventLogProbability = 1.0d / ((double) Ij.A0A(c03927f));
        return c03927f.A08().A00() <= funnelEventLogProbability;
    }
    ...
    */
    public static boolean A0J(com.meta.analytics.dsp.uinode.C03927f r12, java.lang.String r13, int r14, double r15, com.meta.analytics.dsp.uinode.C8B r17) {
        /*
    ...
    public static boolean A0K(C03927f c03927f, String str, int i, C8B c8b) {
        if (!Ij.A0P(c03927f)) {
            return true;
        }
        int customLimit = A00.get(i);
        int eventsLimit = Ij.A00(c03927f);
        if (c8b.A02() != -1) {
            eventsLimit = c8b.A02();
        } else {
            int currentCounter = A00(str, i, c03927f);
