...
public abstract class AbstractC02892y<K, V> {
    ...
    public abstract void A0F(K k3, V v6);
        ...
        if (this.A00 == null) {
            this.A00 = new Set<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.2u
                ...
                public final boolean contains(Object obj) {
                    ...
                    return AbstractC02822r.A04(foundVal, entry.getValue());
                }
                ...
                public final boolean equals(Object obj) {
                    return AbstractC02892y.A03(this, obj);
                }
    ...
    public final Set<K> A09() {
        if (this.A01 == null) {
            this.A01 = new Set<K>() { // from class: com.facebook.ads.redexgen.X.2v
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean containsAll(Collection<?> collection) {
                    return AbstractC02892y.A00(this.A00.A07(), collection);
                }
                ...
                public final int hashCode() {
                    ...
                    for (int i5 = result - 1; i5 >= 0; i5--) {
                        int i8 = 0;
                        Object objA0B = this.A00.A0B(i5, 0);
                        if (objA0B != null) {
                            i8 = objA0B.hashCode();
                        }
                        i += i8;
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean removeAll(Collection<?> collection) {
                    return AbstractC02892y.A01(this.A00.A07(), collection);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2v != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean retainAll(Collection<?> collection) {
                    return AbstractC02892y.A02(this.A00.A07(), collection);
                }
