    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final String A04(InterfaceC04168i interfaceC04168i) {
        C04148g.A08(this.A01, true, null);
        ...
        try {
            try {
                ...
                mapA05.put(A01(532, 10, 81), AbstractC04228o.A06(new C8K(this.A01), this.A01, false));
                if (C0653Ih.A1Y(this.A01)) {
                    mapA05.put(A01(96, 10, 97), C02350w.A01(this.A01).A0K());
                }
                Iterator it = mapA05.entrySet().iterator();
                while (it.hasNext()) {
                    if (!interfaceC04168i.A2a((String) ((Map.Entry) it.next()).getKey())) {
                        it.remove();
                    }
                }
    ...
    public final /* synthetic */ Map A05() {
        return AbstractC04158h.A00(this);
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.meta.analytics.dsp.uinode.InterfaceC04188k
    public final Map<String, String> A6w(C8Z c8z) {
        ...
        C04148g.A08(this.A01, ProcessUtils.isRemoteRenderingProcess() ? true : C0653Ih.A0i(this.A01), strA6E);
        C8J.A0B(this.A01);
        C8J.A08(this.A01);
        HashMap map = new HashMap();
        C04118d.A03(this.A01, map, strA6E);
        ...
        map.put(A01(196, 7, 81), String.valueOf(f3));
        map.put(A01(489, 12, 6), String.valueOf((int) (i / f3)));
        map.put(A01(476, 13, 47), String.valueOf((int) (i5 / f3)));
        ...
        map.put(A01(90, 6, 94), AbstractC04228o.A03(this.A01, c8k));
        map.put(A01(106, 7, 53), c8k.A08());
        map.put(A01(315, 4, 47), c8k.A09());
        map.put(A01(362, 6, 79), String.valueOf(C04148g.A00(this.A01).A00));
        map.put(A01(300, 9, 48), c8k.A0B());
        map.put(A01(501, 14, 90), L2.A01());
        map.put(A01(336, 12, 105), String.valueOf(AbstractC0720Ld.A00(this.A01).A00));
        map.put(A01(515, 12, 62), C0722Lf.A02(this.A01.A08().A01()));
        C04148g.A06(this.A01, packageName, map);
        ...
        map.put(A01(542, 9, 18), C04088a.A05(this.A01, packageName));
        map.put(A01(23, 6, 33), LJ.A01(C8J.A02()));
        if (AbstractC0652Ig.A05(this.A01) && (strA74 = this.A01.A04().A74()) != null) {
        ...
        C04027t c04027tA6i = null;
        if (c8z != null) {
            C03927f c03927f = this.A01;
            if (A05[2].charAt(4) == '1') {
                throw new RuntimeException();
            }
            A05[2] = "UkbZyMMn6UWteLCB6DOs48k1ItwI1bgo";
            c04027tA6i = c8z.A6k(c03927f);
        }
        if (c04027tA6i == null) {
            c04027tA6i = this.A01.A06().A6i();
        }
        String strA012 = A01(167, 29, 78);
        String strA013 = A01(136, 31, 31);
        String strA014 = A01(113, 23, 69);
        if (c04027tA6i != null) {
            map.put(strA014, c04027tA6i.A08());
            map.put(strA013, String.valueOf(c04027tA6i.A05()));
            map.put(strA012, String.valueOf(c04027tA6i.A06()));
        } else {
        ...
        map.put(A01(96, 10, 97), C02350w.A01(this.A01).A0K());
        ...
        while (true) {
            ...
            sb.append(c0vArr[i8].A02() + 4000);
            if (i8 != c0vArr.length - 1) {
        ...
        if (AbstractC0655Ik.A07(this.A01)) {
            String strA02 = AbstractC04098b.A02(this.A01.A01());
            if (strA02 != null) {
                map.put(A01(416, 22, 123), strA02);
            }
            String strA016 = AbstractC04098b.A01(this.A01.A01());
            if (strA02 != null) {
    ...
    public YI(C03927f c03927f, boolean z, C6S c6s) {
        this.A01 = c03927f;
        this.A00 = c6s;
        C04148g.A08(c03927f, z, null);
    }

    public static synchronized PackageInfo A00(C03927f c03927f) {
        if (!A03) {
            A02 = LM.A00(c03927f);
            A03 = true;
        }
