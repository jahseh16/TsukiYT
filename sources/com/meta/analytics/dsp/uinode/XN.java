...
public final class XN implements InterfaceC0502Bs {
    ...
    public static final InterfaceC0505Bv A0Z;
    ...
    public final C4 A0M;
    public final C0511Ce A0N;
    public final C0645Hz A0O;
    public final C0645Hz A0P;
    public final C0645Hz A0Q;
    public final C0645Hz A0R;
    public final IB A0S;
     ...
     */
    public static int A00(CV cv, int i, long j, int i5, C0645Hz c0645Hz, int i8) {
        int iA0H;
        int i10 = i8;
        long j4 = j;
        c0645Hz.A0Y(8);
        int iA00 = CJ.A00(c0645Hz.A08());
        C0511Ce c0511Ce = cv.A05;
        C0513Cg c0513Cg = cv.A07;
        CP cp = c0513Cg.A07;
        c0513Cg.A0E[i] = c0645Hz.A0H();
        c0513Cg.A0G[i] = c0513Cg.A05;
        if ((iA00 & 1) != 0) {
            long[] jArr = c0513Cg.A0G;
            jArr[i] = jArr[i] + ((long) c0645Hz.A08());
        }
        boolean z = (iA00 & 4) != 0;
        int iA0H2 = cp.A01;
        if (z) {
        ...
        boolean z5 = (iA00 & NotificationCompat.FLAG_LOCAL_ONLY) != 0;
        boolean z7 = (iA00 & NotificationCompat.FLAG_GROUP_SUMMARY) != 0;
        boolean z8 = (iA00 & UserMetadata.MAX_ATTRIBUTE_SIZE) != 0;
        boolean z9 = (iA00 & 2048) != 0;
        long jA0F = 0;
        if (c0511Ce.A08 != null && c0511Ce.A08.length == 1 && c0511Ce.A08[0] == 0) {
            jA0F = IF.A0F(c0511Ce.A09[0], 1000L, c0511Ce.A06);
        }
        int[] iArr = c0513Cg.A0D;
        int[] iArr2 = c0513Cg.A0C;
        long[] jArr2 = c0513Cg.A0F;
        boolean[] zArr = c0513Cg.A0I;
        boolean z10 = c0511Ce.A03 == 2 && (i5 & 1) != 0;
        int i11 = i10 + c0513Cg.A0E[i];
        long j7 = c0511Ce.A06;
        if (i > 0) {
            j4 = c0513Cg.A06;
        }
        while (i10 < i11) {
            int iA0H3 = z5 ? c0645Hz.A0H() : cp.A00;
            if (z7) {
                iA0H = c0645Hz.A0H();
            } else {
                iA0H = cp.A03;
            ...
            int iA08 = (i10 == 0 && z) ? iA0H2 : z8 ? c0645Hz.A08() : cp.A01;
            if (z9) {
                iArr2[i10] = (int) ((((long) c0645Hz.A08()) * 1000) / j7);
            } else {
                iArr2[i10] = 0;
            }
            jArr2[i10] = IF.A0F(j4, 1000L, j7) - jA0F;
            iArr[i10] = iA0H;
            zArr[i10] = ((iA08 >> 16) & 1) == 0 && (!z10 || i10 == 0);
            j4 += (long) iA0H3;
            i10++;
        }
        c0513Cg.A06 = j4;
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static Pair<Long, C1039Xo> A04(C0645Hz c0645Hz, long j) throws C04539v {
        long jA0N;
        long jA0N2;
        c0645Hz.A0Y(8);
        int iA01 = CJ.A01(c0645Hz.A08());
        c0645Hz.A0Z(4);
        ...
        for (int i = 0; i < iA0I; i++) {
            ...
            if ((Integer.MIN_VALUE & iA08) != 0) {
                throw new C04539v(A0A(581, 28, 126));
            }
        ...
        return Pair.create(Long.valueOf(jA0F), new C1039Xo(iArr, jArr, jArr2, jArr3));
    }
     ...
     */
    public static CV A09(C0645Hz c0645Hz, SparseArray<CV> sparseArray) {
        c0645Hz.A0Y(8);
        int iA00 = CJ.A00(c0645Hz.A08());
        CV cvA08 = A08(sparseArray, c0645Hz.A08());
        if (cvA08 == null) {
            return null;
        }
        if ((iA00 & 1) != 0) {
            long jA0N = c0645Hz.A0N();
            cvA08.A07.A05 = jA0N;
            cvA08.A07.A04 = jA0N;
        }
        CP cp = cvA08.A04;
        cvA08.A07.A07 = new CP((iA00 & 2) != 0 ? c0645Hz.A0H() - 1 : cp.A02, (iA00 & 8) != 0 ? c0645Hz.A0H() : cp.A00, (iA00 & 16) != 0 ? c0645Hz.A0H() : cp.A03, (iA00 & 32) != 0 ? c0645Hz.A0H() : cp.A01);
        return cvA08;
    }

    public static String A0A(int i, int i5, int i8) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0X, i, i + i5);
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    private void A0K(XT xt) throws C04539v {
        AbstractC0620Ha.A06(this.A0N == null, A0A(532, 20, 12));
        ...
        for (int i5 = 0; i5 < size2; i5++) {
            ...
            if (((CJ) xt2).A00 == CJ.A1M) {
                C0511Ce c0511CeA0C = CO.A0C(xt2, xt.A07(CJ.A0o), jA01, drmInitDataA05, (this.A0J & 16) != 0, false);
                if (c0511CeA0C != null) {
                    sparseArray2.put(c0511CeA0C.A00, c0511CeA0C);
                }
            }
        }
        int size3 = sparseArray2.size();
        if (this.A0K.size() != 0) {
            AbstractC0620Ha.A04(this.A0K.size() == size3);
            for (int i8 = 0; i8 < size3; i8++) {
                C0511Ce c0511Ce = (C0511Ce) sparseArray2.valueAt(i8);
                this.A0K.get(c0511Ce.A00).A07(c0511Ce, A06(sparseArray, c0511Ce.A00));
            }
            return;
        }
        for (int i10 = 0; i10 < size3; i10++) {
            C0511Ce c0511Ce2 = (C0511Ce) sparseArray2.valueAt(i10);
            CV cv = new CV(this.A0C.AGi(i10, c0511Ce2.A03));
            cv.A07(c0511Ce2, A06(sparseArray, c0511Ce2.A00));
            this.A0K.put(c0511Ce2.A00, cv);
            this.A08 = Math.max(this.A08, c0511Ce2.A04);
        }
        A0C();
        this.A0C.A5Y();
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 19 out of bounds for length 11
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static void A0M(XT xt, SparseArray<CV> sparseArray, int i, byte[] bArr) throws C04539v {
        CV cvA09 = A09(xt.A07(CJ.A1J).A00, sparseArray);
        if (cvA09 == null) {
            return;
        }
        C0513Cg c0513Cg = cvA09.A07;
        long jA02 = c0513Cg.A06;
        cvA09.A04();
        if (xt.A07(CJ.A1I) != null && (i & 2) == 0) {
            jA02 = A02(xt.A07(CJ.A1I).A00);
        }
        A0N(xt, cvA09, jA02, i);
        C0512Cf c0512CfA00 = cvA09.A05.A00(c0513Cg.A07.A02);
        XS xsA07 = xt.A07(CJ.A0v);
        if (xsA07 != null) {
            A0P(c0512CfA00, xsA07.A00, c0513Cg);
        }
        XS xsA072 = xt.A07(CJ.A0u);
        if (xsA072 != null) {
            A0S(xsA072.A00, c0513Cg);
        }
        XS xsA073 = xt.A07(CJ.A11);
        if (xsA073 != null) {
            A0T(xsA073.A00, c0513Cg);
        }
        XS xsA074 = xt.A07(CJ.A0y);
        XS xsA075 = xt.A07(CJ.A12);
        if (xsA074 != null && xsA075 != null) {
            A0V(xsA074.A00, xsA075.A00, c0512CfA00 != null ? c0512CfA00.A02 : null, c0513Cg);
        }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0P(C0512Cf c0512Cf, C0645Hz c0645Hz, C0513Cg c0513Cg) throws C04539v {
        int i = c0512Cf.A00;
        c0645Hz.A0Y(8);
        if ((CJ.A00(c0645Hz.A08()) & 1) == 1) {
            c0645Hz.A0Z(8);
        }
        int iA0E = c0645Hz.A0E();
        int iA0H = c0645Hz.A0H();
        if (iA0H != c0513Cg.A00) {
            throw new C04539v(A0A(290, 17, 20) + iA0H + A0A(0, 2, 62) + c0513Cg.A00);
        }
        int i5 = 0;
        if (iA0E == 0) {
            boolean[] zArr = c0513Cg.A0H;
            for (int i8 = 0; i8 < iA0H; i8++) {
            ...
            i5 = 0 + (iA0E * iA0H);
            Arrays.fill(c0513Cg.A0H, 0, iA0H, iA0E > i);
        }
        c0513Cg.A02(i5);
        if (A0Y[6].length() == 17) {
            throw new RuntimeException();
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0V(C0645Hz c0645Hz, C0645Hz c0645Hz2, String str, C0513Cg c0513Cg) throws C04539v {
        c0645Hz.A0Y(8);
        int iA08 = c0645Hz.A08();
        ...
        if (c0645Hz.A08() != 1) {
            throw new C04539v(A0A(50, 39, 80));
        }
        c0645Hz2.A0Y(8);
        int iA083 = c0645Hz2.A08();
        if (c0645Hz2.A08() != i) {
            return;
        }
        ...
        if (iA01 == 1) {
            if (c0645Hz2.A0M() == 0) {
                throw new C04539v(A0A(609, 55, 11));
            }
        } else if (iA01 >= 2) {
            c0645Hz2.A0Z(4);
        }
        if (c0645Hz2.A0M() != 1) {
            throw new C04539v(A0A(89, 39, 85));
        }
        c0645Hz2.A0Z(1);
        int iA0E = c0645Hz2.A0E();
        int i5 = (iA0E & 240) >> 4;
        int i8 = iA0E & 15;
        boolean z = c0645Hz2.A0E() == 1;
        if (z) {
            int iA0E2 = c0645Hz2.A0E();
            byte[] bArr = new byte[16];
            c0645Hz2.A0c(bArr, 0, bArr.length);
            byte[] bArr2 = null;
            if (z && iA0E2 == 0) {
                int iA0E3 = c0645Hz2.A0E();
                bArr2 = new byte[iA0E3];
                c0645Hz2.A0c(bArr2, 0, iA0E3);
            }
            c0513Cg.A0A = true;
            c0513Cg.A08 = new C0512Cf(z, str, iA0E2, bArr, i5, i8, bArr2);
        }
    }
    ...
    public XN(int i, IB ib, C0511Ce c0511Ce, DrmInitData drmInitData) {
        this(i, ib, c0511Ce, drmInitData, Collections.emptyList());
    }

    public XN(int i, IB ib, C0511Ce c0511Ce, DrmInitData drmInitData, List<Format> closedCaptionFormats) {
        this(i, ib, c0511Ce, drmInitData, closedCaptionFormats, null);
    }

    public XN(int i, IB ib, C0511Ce c0511Ce, DrmInitData drmInitData, List<Format> closedCaptionFormats, C4 c4) {
        this.A0J = (c0511Ce != null ? 8 : 0) | i;
        this.A0S = ib;
        this.A0N = c0511Ce;
        this.A0L = drmInitData;
        this.A0V = Collections.unmodifiableList(closedCaptionFormats);
        this.A0M = c4;
        this.A0O = new C0645Hz(16);
        this.A0R = new C0645Hz(AbstractC0641Hv.A03);
        this.A0Q = new C0645Hz(5);
        this.A0P = new C0645Hz();
    ...
    public static long A01(C0645Hz c0645Hz) {
        c0645Hz.A0Y(8);
        int fullAtom = c0645Hz.A08();
        return CJ.A01(fullAtom) == 0 ? c0645Hz.A0M() : c0645Hz.A0N();
    }

    public static long A02(C0645Hz c0645Hz) {
        c0645Hz.A0Y(8);
        int fullAtom = c0645Hz.A08();
        int version = CJ.A01(fullAtom);
        return version == 1 ? c0645Hz.A0N() : c0645Hz.A0M();
    }

    public static Pair<Integer, CP> A03(C0645Hz c0645Hz) {
        c0645Hz.A0Y(12);
        int defaultSampleDescriptionIndex = c0645Hz.A08();
        int trackId = c0645Hz.A0H();
        int defaultSampleFlags = c0645Hz.A0H();
        int defaultSampleSize = c0645Hz.A0H();
        int defaultSampleDuration = c0645Hz.A08();
    ...
    public static DrmInitData A05(List<XS> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafChildrenSize == CJ.A0s) {
                ...
                UUID uuidA02 = AbstractC0509Cb.A02(bArr);
    ...
    private CP A06(SparseArray<CP> sparseArray, int i) {
        ...
        return (CP) AbstractC0620Ha.A01(sparseArray.get(i));
    }
    ...
    public static CV A07(SparseArray<CV> sparseArray) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int i5 = cvValueAt.A02;
            if (A0Y[1].length() == 5) {
                throw new RuntimeException();
            }
            A0Y[0] = "VXm0n";
            if (i5 != cvValueAt.A07.A02) {
    ...
    */
    ...
    private void A0F(long j) throws C04539v {
    ...
    private void A0G(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        int i = ((int) this.A07) - this.A00;
        C0645Hz c0645Hz = this.A0E;
        if (c0645Hz != null) {
            interfaceC0503Bt.readFully(c0645Hz.A00, 8, i);
            int atomPayloadSize = this.A01;
            A0O(new XS(atomPayloadSize, this.A0E), interfaceC0503Bt.A7i());
        } else {
            interfaceC0503Bt.AGP(i);
        }
        A0F(interfaceC0503Bt.A7i());
        String[] strArr = A0Y;
        String str = strArr[2];
    ...
    private void A0H(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        CV cvValueAt = null;
        long j = Long.MAX_VALUE;
        int size = this.A0K.size();
        for (int i = 0; i < size; i++) {
            CV nextTrackBundle = this.A0K.valueAt(i);
            C0513Cg c0513Cg = nextTrackBundle.A07;
            if (c0513Cg.A0B && c0513Cg.A04 < j) {
                j = c0513Cg.A04;
        ...
        int iA7i = (int) (j - interfaceC0503Bt.A7i());
        if (iA7i >= 0) {
            interfaceC0503Bt.AGP(iA7i);
            cvValueAt.A07.A04(interfaceC0503Bt);
            return;
        }
        throw new C04539v(A0A(307, 39, 39));
    }

    private void A0I(XT xt) throws C04539v {
        if (((CJ) xt).A00 == CJ.A0k) {
            A0K(xt);
            return;
        }
    ...
    private void A0J(XT xt) throws C04539v {
    ...
    public static void A0L(XT xt, SparseArray<CV> sparseArray, int i, byte[] bArr) throws C04539v {
        int size = xt.A01.size();
        for (int i5 = 0; i5 < size; i5++) {
            XT child = xt.A01.get(i5);
            int i8 = ((CJ) child).A00;
            int moofContainerChildrenSize = CJ.A1L;
            if (i8 == moofContainerChildrenSize) {
    ...
    public static void A0N(XT xt, CV cv, long j, int totalSampleCount) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (trunIndex == CJ.A1O) {
                i10 = A00(cv, i8, j, totalSampleCount, xs2.A00, i10);
                i8++;
            }
        }
    }

    private void A0O(XS xs, long j) throws C04539v {
        if (!this.A0T.isEmpty()) {
            this.A0T.peek().A09(xs);
            return;
        }
        if (((CJ) xs).A00 == CJ.A13) {
            Pair<Long, C1039Xo> pairA04 = A04(xs.A00, j);
    ...
    private void A0Q(C0645Hz c0645Hz) {
        C4[] c4Arr = this.A0I;
        if (c4Arr == null || c4Arr.length == 0) {
            return;
        }
        c0645Hz.A0Y(12);
        int sampleSize = c0645Hz.A04();
        c0645Hz.A0Q();
        c0645Hz.A0Q();
        long jA0M = c0645Hz.A0M();
        long timescale = c0645Hz.A0M();
        long jA0F = IF.A0F(timescale, 1000000L, jA0M);
        for (C4 c4 : this.A0I) {
            c0645Hz.A0Y(12);
            c4.AFR(c0645Hz, sampleSize);
        }
        long j = this.A0B;
    ...
    public static void A0R(C0645Hz c0645Hz, int i, C0513Cg c0513Cg) throws C04539v {
        c0645Hz.A0Y(i + 8);
        int fullAtom = c0645Hz.A08();
        ...
        if (fullAtom2 == 0) {
            ...
            int sampleCount = c0645Hz.A0H();
            int fullAtom4 = c0513Cg.A00;
            if (sampleCount == fullAtom4) {
                Arrays.fill(c0513Cg.A0H, 0, sampleCount, z);
                int fullAtom5 = c0645Hz.A04();
                c0513Cg.A02(fullAtom5);
                c0513Cg.A05(c0645Hz);
                return;
            }
            StringBuilder sbAppend = new StringBuilder().append(A0A(290, 17, 20)).append(sampleCount).append(A0A(0, 2, 62));
            int fullAtom6 = c0513Cg.A00;
            throw new C04539v(sbAppend.append(fullAtom6).toString());
        }
        throw new C04539v(A0A(381, 56, 66));
    }

    public static void A0S(C0645Hz c0645Hz, C0513Cg c0513Cg) throws C04539v {
        c0645Hz.A0Y(8);
        int flags = c0645Hz.A08();
        ...
        if (iA0H == 1) {
            ...
            c0513Cg.A04 += entryCount == 0 ? c0645Hz.A0M() : c0645Hz.A0N();
            return;
        }
        throw new C04539v(A0A(552, 29, 63) + iA0H);
    }

    public static void A0T(C0645Hz c0645Hz, C0513Cg c0513Cg) throws C04539v {
        A0R(c0645Hz, 0, c0513Cg);
    }

    public static void A0U(C0645Hz c0645Hz, C0513Cg c0513Cg, byte[] bArr) throws C04539v {
        c0645Hz.A0Y(8);
        c0645Hz.A0c(bArr, 0, 16);
        if (!Arrays.equals(bArr, A0c)) {
            return;
        }
        A0R(c0645Hz, 16, c0513Cg);
    }
            ...
            if (A0Y[6].length() != 17) {
                ...
                if (i != i5 && i != CJ.A1J && i != CJ.A1K && i != CJ.A1N && i != CJ.A1O && i != CJ.A0s && i != CJ.A0v) {
                    ...
                    if (A0Y[1].length() != 5) {
                        ...
                        if (i != i8 && i != CJ.A11 && i != CJ.A1R && i != CJ.A0y && i != CJ.A12 && i != CJ.A0P) {
                            int i10 = CJ.A0g;
                            if (A0Y[3].length() == 6) {
                                A0Y[7] = "Eu3";
                                if (i != i10 && i != CJ.A0Q) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:45:0x0139, code lost:
        ...
        r10.A0C.AFi(new com.meta.analytics.dsp.uinode.C1034Xj(r10.A08, r0));
        r10.A0F = true;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:55:0x0188, code lost:
        ...
        throw new com.meta.analytics.dsp.uinode.C04539v(A0A(2, 48, 114));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:69:0x01c8, code lost:
        ...
        r10.A0E = new com.meta.analytics.dsp.uinode.C0645Hz((int) r2);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x01ed, code lost:
        ...
        throw new com.meta.analytics.dsp.uinode.C04539v(A0A(241, 49, 53));
     */
    /* JADX WARN: Code restructure failed: missing block: B:74:0x01fd, code lost:
    
        throw new com.meta.analytics.dsp.uinode.C04539v(A0A(190, 51, 24));
     */
    /* JADX WARN: Code restructure failed: missing block: B:76:0x020c, code lost:
    
        throw new com.meta.analytics.dsp.uinode.C04539v(A0A(479, 53, 2));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean A0Y(com.meta.analytics.dsp.uinode.InterfaceC0503Bt r11) throws java.lang.InterruptedException, java.io.IOException {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean A0Z(com.meta.analytics.dsp.uinode.InterfaceC0503Bt r19) throws java.lang.InterruptedException, java.io.IOException {
        /*
    ...
    public final void A8o(InterfaceC0504Bu interfaceC0504Bu) {
        this.A0C = interfaceC0504Bu;
        C0511Ce c0511Ce = this.A0N;
        if (c0511Ce != null) {
            CV cv = new CV(interfaceC0504Bu.AGi(0, c0511Ce.A03));
    ...
    public final int AEH(InterfaceC0503Bt interfaceC0503Bt, C0507Bz c0507Bz) throws InterruptedException, IOException {
        while (true) {
            ...
            if (A0Y[6].length() != 17) {
                ...
                switch (i) {
                    case 0:
                        if (!A0Y(interfaceC0503Bt)) {
                            return -1;
                        }
                        break;
                        break;
                    case 1:
                        A0G(interfaceC0503Bt);
                        break;
                    case 2:
                        A0H(interfaceC0503Bt);
                        break;
                    default:
                        if (A0Z(interfaceC0503Bt)) {
                            return 0;
                        }
                        break;
                }
    ...
    public final boolean AGR(InterfaceC0503Bt interfaceC0503Bt) throws InterruptedException, IOException {
        return AbstractC0510Cc.A03(interfaceC0503Bt);
    }
}
