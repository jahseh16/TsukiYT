...
public final class AJ {
    ...
    public final C0560Eo A07(int i) {
        C0560Eo c0560Eo = null;
        AH ah = this.A00;
        if (ah != null) {
            int iA00 = ah.A00();
            for (int periodIndex = 0; periodIndex < this.A05.size(); periodIndex++) {
                AK mediaPeriod = this.A05.get(periodIndex);
                C0560Eo match = mediaPeriod.A01;
                int i5 = match.A02;
                if (i5 < iA00 && this.A00.A09(i5, this.A04).A00 == i) {
                    if (c0560Eo != null) {
                        return null;
                    }
                    c0560Eo = mediaPeriod.A01;
                }
            }
        }
        return c0560Eo;
    ...
    public final void A0B(int i, C0560Eo c0560Eo) {
        this.A05.add(new AK(i, c0560Eo));
        if (this.A05.size() == 1 && !this.A00.A0E()) {
            A02();
        }
    }

    public final void A0C(int i, C0560Eo c0560Eo) {
        AK mediaPeriod;
        AK ak = new AK(i, c0560Eo);
        this.A05.remove(ak);
    ...
    public final void A0D(int i, C0560Eo c0560Eo) {
        this.A02 = new AK(i, c0560Eo);
    }
