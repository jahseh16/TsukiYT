...
public abstract class PO {
    ...
    public static String[] A01 = {"xPMOoUfbkmQ5kvnU3jbgLL47OcFEjU7z", "1dodMLotzUEJucQn2MWgY64F", "Ei0kY7ZOP", "czo3jP2JN", FirebaseRemoteConfig.DEFAULT_VALUE_FOR_STRING, "hHdeWCinA2EaAz86iaUgwk6OrkZVXmHI", "CkfkaUvdCRi5J5AIUl6JSr62iIVQ3RiE", "AT3hLPm3hPYjZ73rxoY4ER"};

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static PN A00(C1064Yn c1064Yn, JSONObject jSONObject, C03696c c03696c, JA ja, C0819Oy c0819Oy, boolean z) {
        boolean z5;
        String strA0R;
        boolean z7 = z;
        ...
        if (z7) {
            strA0R = c03696c.A0R(strOptString);
        ...
        try {
            ...
            if (jSONObjectOptJSONObject != null && jSONObjectOptJSONObject.optString(strA01) != null) {
                ...
                if (z5) {
                    jSONObjectOptJSONObject.put(strA01, c03696c.A0Q(jSONObjectOptJSONObject.optString(strA01)));
                }
            }
            ...
            if (jSONArrayOptJSONArray != null) {
                for (int i = 0; i < jSONArrayOptJSONArray.length(); i++) {
                    ...
                    if (z5) {
                        jSONArrayOptJSONArray.put(i, c03696c.A0Q(strOptString2));
                    }
                }
            }
            ...
            if (jSONArrayOptJSONArray2 != null) {
                for (int i5 = 0; i5 < jSONArrayOptJSONArray2.length(); i5++) {
                    A03(arrayList, arrayList2, jSONArrayOptJSONArray2.optJSONObject(i5), c03696c, z5);
                }
            } else {
                A03(arrayList, arrayList2, jSONObject, c03696c, z5);
            }
        } catch (JSONException unused) {
            c0819Oy.A04(C8A.A15, A01(0, 43, 79));
        }
        return new PN(jSONObject, strA0R, arrayList, arrayList2, arrayList3, z7);
    }
    ...
    public static void A03(ArrayList<String> videoUrls, ArrayList<String> arrayList, JSONObject jSONObject, C03696c c03696c, boolean z) throws JSONException {
        ...
        if (jSONObjectOptJSONObject != null) {
            ...
            if (jSONObjectOptJSONObject.optString(strA01) != null) {
                ...
                if (z) {
                    jSONObjectOptJSONObject.put(strA01, c03696c.A0Q(strOptString));
                }
            }
        }
        ...
        if (!TextUtils.isEmpty(jSONObject.optString(strA012))) {
            ...
            arrayList.add(strOptString2);
            if (z) {
                jSONObject.put(strA012, c03696c.A0R(strOptString2));
            }
        }
    }
}
