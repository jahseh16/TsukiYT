...
public final class EG {
    ...
    public EG(EL el, int i, int i5, File file, DownloadAction.Deserializer... deserializerArr) {
        AbstractC0620Ha.A05(deserializerArr.length > 0, A05(16, 38, 36));
        this.A0A = el;
        this.A04 = i;
        this.A05 = i5;
        this.A09 = new C0544Dw(file);
