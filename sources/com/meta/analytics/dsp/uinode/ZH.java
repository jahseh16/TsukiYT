...
public final class ZH extends C03415a implements MediaViewApi, Repairable, InterfaceC03887b {
    ...
    private void A06() {
        if (!this.A0D) {
            ...
            if (view != null) {
                AbstractC0731Lo.A0J(this.A08);
            }
            float f3 = LD.A02;
            float density = 4.0f * f3;
            int hPadding = Math.round(density);
            float density2 = 12.0f * f3;
    ...
    private void A0A(View view, V2 v22) {
        ...
        C0844Px c0844PxA01 = AbstractC0843Pw.A01(this.A07, strA1C);
    ...
    private void A0B(ImageView imageView) {
        if (!this.A0D) {
            ...
            if (imageView2 != null) {
                AbstractC0731Lo.A0J(imageView2);
            }
            imageView.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(imageView, layoutParams);
            imageView.setId(AbstractC0731Lo.A00());
            this.A02 = imageView;
            return;
        }
    ...
    private final void A0C(C1064Yn c1064Yn, AttributeSet attributeSet, int i, int i5, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1064Yn, attributeSet, i, i5));
        A0H(new C0774Nf(c1064Yn, attributeSet, i, i5));
        this.A08 = new C3C(c1064Yn, attributeSet, i);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1064Yn, attributeSet, i, i5));
        A07();
    }

    private final void A0D(C1064Yn c1064Yn, AttributeSet attributeSet, int i, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1064Yn, attributeSet, i));
        A0H(new C0774Nf(c1064Yn, attributeSet, i));
        this.A08 = new C3C(c1064Yn, attributeSet, i);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1064Yn, attributeSet, i));
        A07();
    }

    private final void A0E(C1064Yn c1064Yn, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1064Yn, attributeSet));
        A0H(new C0774Nf(c1064Yn, attributeSet));
        this.A08 = new C3C(c1064Yn, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1064Yn, attributeSet));
        A07();
    }

    private final void A0F(C1064Yn c1064Yn, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1064Yn));
        A0H(new C0774Nf(c1064Yn));
        this.A08 = new C3C(c1064Yn);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1064Yn));
        A07();
    }

    private void A0G(V2 v22, boolean z, JP jp) {
        AsyncTaskC0941Tq asyncTaskC0941TqA04 = new AsyncTaskC0941Tq(this.A02, this.A07).A04();
        if (z) {
            asyncTaskC0941TqA04.A06(new ZO(this, v22));
        }
        asyncTaskC0941TqA04.A07(jp.getUrl());
    }

    private void A0H(C0774Nf c0774Nf) {
        if (!this.A0D) {
            C0774Nf c0774Nf2 = this.A09;
            if (c0774Nf2 != null) {
                this.A03.removeView(c0774Nf2);
            }
            c0774Nf.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c0774Nf, layoutParams);
            this.A09 = c0774Nf;
            return;
        }
    ...
    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> carousel = ((C03495i) nativeAd.getNativeAdApi()).A03();
        if (carousel == null) {
            return false;
        }
    ...
    public boolean A0J(NativeAd nativeAd) {
        return Build.VERSION.SDK_INT >= 14 && !TextUtils.isEmpty(((C03495i) nativeAd.getNativeAdApi()).A02());
    }
    ...
    */
    ...
    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z) {
        C1064Yn c1064YnA11 = ((V2) nativeAdBaseApi).A11();
        C1064Yn adObjectContext = this.A07;
        adObjectContext.A0K(c1064YnA11);
        c1064YnA11.A0L(this);
        this.A0D = true;
        ...
        ((C03485h) this.A05.getMediaViewVideoRendererApi()).A03();
        View view = this.A01;
        if (view != null) {
        ...
        if (adIcon != null) {
            ...
            c1064YnA11.A0E().A2m(v2A0L.A0x(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (v1A15 != null) {
                v1A15.ABR(C0670Jb.A00(adErrorType));
            }
            Log.e(A04(46, 17, 115), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                C1064Yn adObjectContext2 = this.A07;
    ...
    public final void bringChildToFront(View view) {
        if (view == this.A01 || view == this.A05 || view == this.A09 || view == this.A02) {
            ...
            C0844Px c0844Px = this.A0B;
            if (c0844Px != null) {
                this.A06.bringChildToFront(c0844Px);
            }
        }
    }
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C03485h) this.A05.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C03485h) this.A05.getMediaViewVideoRendererApi()).A07(new ZI(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            ((C03485h) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A07.A09());
            ...
            mediaViewVideoRenderer.setId(AbstractC0731Lo.A00());
            return;
        }
