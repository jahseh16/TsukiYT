...
public abstract class AnonymousClass51 {
    ...
    public View A01;
    public AbstractC03304o A02;
    public C0547Eb A03;
    public boolean A04;
    public boolean A05;
    public int A00 = -1;
    public final C03404z A06 = new C03404z(0, 0);
    ...
    public abstract void A0H(int i, int i5, AnonymousClass53 anonymousClass53, C03404z c03404z);

    public abstract void A0I(View view, AnonymousClass53 anonymousClass53, C03404z c03404z);
    ...
    public void A04(int i, int i5) {
        ...
        if (!this.A05 || this.A00 == -1 || c0547Eb == null) {
            A09();
        }
        this.A04 = false;
        View view = this.A01;
        if (view != null) {
            ...
            strArr2[0] = "WYaFIbeKL";
            if (iA00 == i8) {
                A0I(this.A01, c0547Eb.A0s, this.A06);
                C03404z c03404z = this.A06;
                if (A08[5].length() != 9) {
                    String[] strArr3 = A08;
                    strArr3[6] = "M";
                    strArr3[2] = "Q";
        ...
        if (this.A05) {
            A0H(i, i5, c0547Eb.A0s, this.A06);
            boolean hadJumpTarget = this.A06.A06();
            this.A06.A05(c0547Eb);
            if (hadJumpTarget) {
                if (this.A05) {
                    this.A04 = true;
                    c0547Eb.A08.A07();
    ...
    public final AbstractC03304o A08() {
        return this.A02;
    }
    ...
    public final void A0D(C0547Eb c0547Eb, AbstractC03304o abstractC03304o) {
        this.A03 = c0547Eb;
        this.A02 = abstractC03304o;
        if (this.A00 != -1) {
            c0547Eb.A0s.A0F = this.A00;
            this.A05 = true;
            this.A04 = true;
            this.A01 = A01(A07());
            this.A03.A08.A07();
