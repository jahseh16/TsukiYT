...
public final class UD extends RelativeLayout implements MD {
    ...
    public boolean A0D;
    public boolean A0E;
    public final AbstractC1167b5 A0F;
    public final C02411c A0G;
    public final C5T A0H;
    public final C1064Yn A0I;
    public final J2 A0J;
    public final JA A0K;
    public final L9 A0L;
    public final ViewOnSystemUiVisibilityChangeListenerC0718Lb A0M;
    public final MC A0N;
    public final InterfaceC0752Mj A0O;
    public final O0 A0P;
    public final O1 A0Q;
    public final Q5 A0R;
    ...
    public static String A0D(int i, int i5, int i8) {
    ...
    static {
        ...
        A0e = AbstractC02802p.A01(-1, 77);
        A0a = (int) (LD.A02 * 8.0f);
    }

    public UD(C1064Yn c1064Yn, J2 j22, MC mc, AbstractC1167b5 abstractC1167b5, String str, InterfaceC0752Mj interfaceC0752Mj) {
        int iA07;
        super(c1064Yn);
        ...
        this.A0N = mc;
        this.A0J = j22;
        this.A0F = abstractC1167b5;
        C02411c c02411cA06 = abstractC1167b5.A0x().A0D().A06();
        this.A0G = c02411cA06;
        this.A0K = new JA(abstractC1167b5.A12(), j22);
        this.A0O = interfaceC0752Mj;
        this.A08 = new Q7(c1064Yn, interfaceC0752Mj, str, mc);
        this.A0B = abstractC1167b5.A0x().A0M() && abstractC1167b5.A0x().A0D().A02() > 0;
        boolean zA0A = abstractC1167b5.A0x().A0D().A0A();
        this.A0V = zA0A;
        if (c02411cA06 == null) {
            mc.A43(interfaceC0752Mj.A6y());
            mc.A43(interfaceC0752Mj.A6u());
        }
        if (this.A0B && zA0A) {
            iA07 = abstractC1167b5.A0x().A0D().A02();
        } else {
            iA07 = c02411cA06.A07();
        }
        atomicBoolean.set(!c02411cA06.A0I());
        UK uk = null;
        this.A0L = new L9(iA07, new UF(this, uk));
        this.A0U = C0653Ih.A0j(c1064Yn);
        FullScreenAdToolbar fullScreenAdToolbarA07 = A07();
        this.A0W = fullScreenAdToolbarA07;
        this.A0R = new Q5(c1064Yn, j22, abstractC1167b5);
        ...
        this.A0M = viewOnSystemUiVisibilityChangeListenerC0718Lb;
        viewOnSystemUiVisibilityChangeListenerC0718Lb.A05(EnumC0717La.A03);
        if (C0653Ih.A1q(c1064Yn)) {
            fullScreenAdToolbarA07.setProgressSpinnerInvisible(true);
        }
        HashMap map = new HashMap();
        map.put(A0D(56, 9, 61), interfaceC0752Mj.A7f());
        this.A07 = new Q0(c1064Yn, abstractC1167b5, c02411cA06, j22, new UE(this, uk), map);
        A0K();
        mc.A3U(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        UJ uj = new UJ(this);
        this.A0P = uj;
        this.A0Q = new O1(c1064Yn, fullScreenAdToolbarA07, abstractC1167b5, (SA) null, mc, uj, this.A06, this.A01, this.A07);
    }
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.A06(this.A0F.A0w().A01(), ViewOnClickListenerC0936Tl.A08(this.A0F));
    ...
    private ViewOnClickListenerC0936Tl A09() {
        Q0 q02 = this.A07;
        if (q02 == null || q02.getViewabilityChecker() == null || this.A07.getTouchDataRecorder() == null) {
            return null;
        }
        ViewOnClickListenerC0936Tl button = new ViewOnClickListenerC0936Tl(this.A0I, this.A0O.A6R(), this.A0F.A0w().A01(), this.A0J, this.A0N, this.A07.getViewabilityChecker(), this.A07.getTouchDataRecorder(), this.A0F.A0y());
    ...
    private void A0G() {
        ...
        new AsyncTaskC0941Tq(o32, this.A0I).A05(i, i).A07(this.A0F.A10().A01());
    ...
    private void A0J() {
        C0827Pg c0827PgA0B = new C0825Pe(this.A0I, this.A0F.A0x().A0E(), this.A0F.A10()).A08(this.A0F.A0w().A01()).A0A(this.A0G.A0G()).A09(this.A0G.A0D()).A07(2000).A0B();
        JC.A04(c0827PgA0B, this.A0K, J9.A0U);
        addView(c0827PgA0B, A0i);
        c0827PgA0B.A04(new UI(this));
    }
    ...
    private void A0K() {
        ...
        AbstractC0731Lo.A0K(relativeLayout2);
        if (this.A0U) {
            A0G();
        } else {
            RelativeLayout relativeLayout3 = this.A02;
        ...
        ViewOnClickListenerC0936Tl viewOnClickListenerC0936Tl = this.A06;
        if (viewOnClickListenerC0936Tl != null) {
            layoutParams.addRule(0, viewOnClickListenerC0936Tl.getId());
    ...
    public void A0L() {
        ...
        AbstractC0731Lo.A0a(this.A0Q, this.A00, this.A07);
        AbstractC0731Lo.A0L(this.A0W);
        AbstractC0731Lo.A0L(this.A06);
        ...
        switch (MT.A00[((Q4) pairA03.first).ordinal()]) {
            ...
            case 2:
                ...
                if (relativeLayout2 != null) {
                    AbstractC0731Lo.A0a(relativeLayout2);
                }
    ...
    public void A0O(int i) {
        ...
        AbstractC0731Lo.A0Y(toast, strA0C.replace(progress, strValueOf), 49, 0, A0g);
    }
    ...
    public void A0U(boolean z, String str) {
        ...
        new C0786Nr(this.A0I, this.A0O.A6R(), this.A07.getViewabilityChecker(), this.A07.getTouchDataRecorder(), this.A0J, this.A0F.A0y(), this.A0N).A07(this.A0F.A12(), this.A0F.A0x().A0F().A05(), map);
    }
    ...
    public boolean A0V() {
        if (!this.A0F.A0P().equals(A0D(65, 14, 37))) {
            if (this.A0F.A0P().equals(A0D(32, 12, 100))) {
                AbstractC1167b5 abstractC1167b5 = this.A0F;
                if (A0Y[4].length() != 18) {
                    throw new RuntimeException();
                }
                A0Y[0] = "r5y7OBqhAYVA47bIfl4AlIWKO2XfiX80";
                if (abstractC1167b5.A0x().A0O()) {
                }
            }
            return false;
        }
    ...
    public final void ACu(boolean z) {
        ...
        if (!z5 && this.A0T.get() && !this.A0L.A05()) {
            this.A0L.A07();
        }
    }
    ...
    public final void onDestroy() {
        ...
        if (this.A07 != null) {
            ...
            if (!TextUtils.isEmpty(abstractC1167b5.A12())) {
                this.A0J.A9X(this.A0F.A12(), new C0777Ni().A03(this.A07.getViewabilityChecker()).A02(this.A07.getTouchDataRecorder()).A05());
            }
            this.A07.A0C();
        }
        this.A0L.A06();
