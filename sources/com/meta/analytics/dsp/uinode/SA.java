...
public class SA extends RelativeLayout implements RC, QE {
    ...
    public static final C0840Pt A0G;
    public static final O8 A0H;
    public static final C0782Nn A0I;
    public static final C0748Mf A0J;
    public static final C0743Ma A0K;
    public static final MW A0L;
    public static final MU A0M;
    public static final C0737Lu A0N;
    public int A00;
    public JA A01;
    public QJ A02;
    public boolean A03;
    ...
    public final C04258r<AbstractC04268s, C04248q> A0B;
    public final List<QN> A0C;
    public final R9 A0D;

    public static String A0F(int i, int i5, int i8) {
    ...
    public SA(C1064Yn c1064Yn) {
        super(c1064Yn);
        this.A0C = new ArrayList();
        this.A07 = new Handler();
        this.A08 = new Handler();
        this.A0B = new C04258r<>();
        this.A05 = true;
        this.A00 = 200;
        this.A09 = new QD(this);
        this.A0A = c1064Yn;
        if (A0S(c1064Yn)) {
            this.A0D = new TextureViewSurfaceTextureListenerC0689Jv(c1064Yn);
        } else {
            this.A0D = new TextureViewSurfaceTextureListenerC0688Ju(c1064Yn);
        }
        A0G();
    }

    public SA(C1064Yn c1064Yn, AttributeSet attributeSet) {
        ...
        this.A0A = c1064Yn;
        if (A0S(c1064Yn)) {
            this.A0D = new TextureViewSurfaceTextureListenerC0689Jv(c1064Yn, attributeSet);
        } else {
            this.A0D = new TextureViewSurfaceTextureListenerC0688Ju(c1064Yn, attributeSet);
        }
        A0G();
    }

    public SA(C1064Yn c1064Yn, AttributeSet attributeSet, int i) {
        ...
        this.A0A = c1064Yn;
        if (A0S(c1064Yn)) {
            this.A0D = new TextureViewSurfaceTextureListenerC0689Jv(c1064Yn, attributeSet, i);
        } else {
            this.A0D = new TextureViewSurfaceTextureListenerC0688Ju(c1064Yn, attributeSet, i);
        }
        A0G();
    }

    public static /* synthetic */ C0782Nn A0C() {
        C0782Nn c0782Nn = A0I;
        if (A0F[0].length() != 31) {
            throw new RuntimeException();
        }
    ...
    private void A0R(QQ qq) {
        if (qq instanceof C7R) {
            ...
            AbstractC0731Lo.A0J(qq);
        }
    }

    private boolean A0S(C1064Yn c1064Yn) {
        return C0653Ih.A2S(c1064Yn, C0869Qw.A03());
    }
    ...
    public final void A0f(boolean z, boolean z5, int i) {
        this.A05 = z5;
        A0e(z, i);
    }
    ...
    public final void ABa(final long j, final long j4, final long j7, final float f3) {
        if (!C0653Ih.A1X(this.A0A)) {
            return;
        }
        this.A0B.A02(new QA(j, j4, j7, f3) { // from class: com.facebook.ads.redexgen.X.9F
        });
    }
    ...
    public final void AD3(int i, int i5) {
        SC sc = new SC(this, i, i5);
        if (this.A06) {
            ExecutorC0725Li.A00(sc);
        } else {
            this.A08.post(sc);
        }
        A0H();
    ...
    public C04258r<AbstractC04268s, C04248q> getEventBus() {
        return this.A0B;
    }
    ...
    public void setVideoURI(String str) {
        ...
        setVideoURI(str != null ? AbstractC0715Ky.A00(str) : null);
    }
    ...
    public void setVolume(float f3) {
        ...
        this.A0D.setRequestedVolume(f3);
        C04258r<AbstractC04268s, C04248q> eventBus = getEventBus();
        if (A0F[2].length() == 19) {
            throw new RuntimeException();
        }
