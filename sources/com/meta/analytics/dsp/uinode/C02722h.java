...
public final class C02722h extends Drawable {
    ...
    public C02722h(ColorStateList colorStateList, float f3) {
        this.A01 = f3;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = C02742j.A01(this.A00, this.A01, this.A07);
            float vInset = C02742j.A00(this.A00, this.A01, this.A07);
    ...
    public final void A07(float f3, boolean z, boolean z5) {
        if (f3 == this.A00) {
            boolean z7 = this.A06;
