...
import com.meta.analytics.dsp.uinode.AbstractC0701Ki;
import com.meta.analytics.dsp.uinode.C0653Ih;
import com.meta.analytics.dsp.uinode.C0706Kp;
import com.meta.analytics.dsp.uinode.C1063Ym;
...
import com.meta.analytics.dsp.uinode.ExecutorC0725Li;
import com.meta.analytics.dsp.uinode.InterfaceC0704Kl;
import com.meta.analytics.dsp.uinode.RunnableC0703Kk;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
    ...
    public static final C0706Kp A05;
    public static final List<InterfaceC0704Kl> A06;
     ...
     */
    public static synchronized void A04(C1063Ym c1063Ym, Class<? extends Activity> cls) {
        A02 = c1063Ym;
        Context applicationContext = c1063Ym.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c1063Ym.A07().A9a(A01(208, 8, 114), C8A.A02, new C8B(A01(72, 80, 103)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c1063Ym);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c1063Ym.A07().A9a(A01(216, 3, 105), C8A.A0d, new C8B(A01(42, 30, 122)));
        }
    }
    ...
    public static synchronized Activity A00() {
        ...
        if (z) {
            activityA00 = AbstractC0701Ki.A00();
        }
    ...
    public static void A03(C1064Yn c1064Yn) {
        if (!C0653Ih.A1N(c1064Yn) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        RunnableC0703Kk runnableC0703Kk = new RunnableC0703Kk(c1064Yn);
        List<Runnable> list = A07;
        synchronized (list) {
            list.add(runnableC0703Kk);
        }
        ExecutorC0725Li.A01.A01().postDelayed(runnableC0703Kk, 2000L);
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        A08.put(activity, 1);
        Iterator<InterfaceC0704Kl> it = A06.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (activity.getClass() != this.A00) {
            ...
            while (it.hasNext()) {
                ExecutorC0725Li.A01.A01().removeCallbacks((Runnable) it.next());
            }
        }
        A05.A01();
    }
