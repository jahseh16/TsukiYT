...
public abstract class CronetEngine {
    ...
    public static class Builder {
        ...
        public static int compareVersions(String str, String str2) {
            ...
            for (int i = 0; i < strArrSplit.length && i < strArrSplit2.length; i++) {
                try {
                    int i5 = Integer.parseInt(strArrSplit[i]);
                    int i8 = Integer.parseInt(strArrSplit2[i]);
                    if (i5 != i8) {
                        return Integer.signum(i5 - i8);
                    }
                } catch (NumberFormatException e4) {
                    throw new IllegalArgumentException("Unable to convert version segments into integers: " + strArrSplit[i] + " & " + strArrSplit2[i], e4);
                }
            }
    ...
    /* JADX INFO: renamed from: newUrlRequestBuilder */
    public abstract UrlRequest.Builder mo215newUrlRequestBuilder(String str, UrlRequest.Callback callback, Executor executor);
