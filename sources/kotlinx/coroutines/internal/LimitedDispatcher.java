...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo210dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo210dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        this.dispatcher.mo210dispatch(this, new Worker(runnableObtainTaskOrDeallocateWorker));
    }
    ...
    public void mo211scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo211scheduleResumeAfterDelay(j, cancellableContinuation);
    }
}
