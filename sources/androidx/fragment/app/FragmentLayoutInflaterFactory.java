...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (attributeValue == null) {
            attributeValue = typedArrayObtainStyledAttributes.getString(R$styleable.n3);
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(R$styleable.zn, -1);
        String string = typedArrayObtainStyledAttributes.getString(R$styleable.f816gv);
