...
final class FragmentManagerViewModel extends b {
    private static final rz.n3 FACTORY = new rz.n3() { // from class: androidx.fragment.app.FragmentManagerViewModel.1
        @Override // androidx.lifecycle.rz.n3
        public /* bridge */ /* synthetic */ b create(Class cls, yg.y yVar) {
    ...
    private final HashMap<String, hw> mViewModelStores = new HashMap<>();
    ...
    private void clearNonConfigStateInternal(@NonNull String str, boolean z) {
        ...
        hw hwVar = this.mViewModelStores.get(str);
        if (hwVar != null) {
            hwVar.y();
    ...
    @NonNull
    public static FragmentManagerViewModel getInstance(hw hwVar) {
        return (FragmentManagerViewModel) new rz(hwVar, FACTORY).y(FragmentManagerViewModel.class);
    }
    ...
    public hw getViewModelStore(@NonNull Fragment fragment) {
        hw hwVar = this.mViewModelStores.get(fragment.mWho);
        if (hwVar != null) {
            return hwVar;
        }
        hw hwVar2 = new hw();
        this.mViewModelStores.put(fragment.mWho, hwVar2);
        return hwVar2;
    }
    ...
    public void restoreFromSnapshot(@Nullable FragmentManagerNonConfig fragmentManagerNonConfig) {
        ...
        if (fragmentManagerNonConfig != null) {
            ...
            Map<String, hw> viewModelStores = fragmentManagerNonConfig.getViewModelStores();
