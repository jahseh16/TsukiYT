...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, mt, j5, a, qk.v {
    ...
    qk.gv mSavedStateRegistryController;
    ...
    d0<mt> mViewLifecycleOwnerLiveData;
    ...
    public static class AnimationInfo {
        ...
        i4 mEnterTransitionCallback;
        boolean mEnterTransitionPostponed;
        int mExitAnim;
        Object mExitTransition;
        i4 mExitTransitionCallback;
        View mFocusedView;
        boolean mIsPop;
        int mNextTransition;
        int mPopEnterAnim;
    ...
    public Fragment() {
        ...
        this.mSavedStateAttachListener = new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.2
            ...
            public void onPreAttached() {
                Fragment.this.mSavedStateRegistryController.zn();
                f3.zn(Fragment.this);
                Bundle bundle = Fragment.this.mSavedFragmentState;
                Fragment.this.mSavedStateRegistryController.gv(bundle != null ? bundle.getBundle("registryState") : null);
            }
        };
        initLifecycle();
    }
    ...
    private int getMinimumMaxLifecycleState() {
        s.n3 n3Var = this.mMaxState;
        return (n3Var == s.n3.INITIALIZED || this.mParentFragment == null) ? n3Var.ordinal() : Math.min(n3Var.ordinal(), this.mParentFragment.getMinimumMaxLifecycleState());
    }

    private void initLifecycle() {
        this.mLifecycleRegistry = new wz(this);
        this.mSavedStateRegistryController = qk.gv.y(this);
    ...
    @NonNull
    private <I, O> s.n3<I> prepareCallInternal(@NonNull final c5.y<I, O> yVar, @NonNull final co.y<Void, s.zn> yVar2, @NonNull final s.y<O> yVar3) {
        if (this.mState <= 1) {
            ...
            registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.9
                ...
                public void onPreAttached() {
                    ...
                    atomicReference.set(((s.zn) yVar2.apply(null)).c5(strGenerateActivityResultKey, Fragment.this, yVar, yVar3));
                }
            });
            return new s.n3<I>() { // from class: androidx.fragment.app.Fragment.10
                @Override // s.n3
                @NonNull
                ...
                @Override // s.n3
                public void launch(I i, @Nullable ta.gv gvVar) {
                    s.n3 n3Var = (s.n3) atomicReference.get();
                    if (n3Var == null) {
                        throw new IllegalStateException("Operation cannot be started before fragment is in created state");
                    }
                    n3Var.launch(i, gvVar);
                }

                @Override // s.n3
                public void unregister() {
                    s.n3 n3Var = (s.n3) atomicReference.getAndSet(null);
                    if (n3Var != null) {
                        n3Var.unregister();
                    }
                }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        if (getContext() != null) {
            yc.y.n3(this).y(str, fileDescriptor, printWriter, strArr);
        }
        printWriter.print(str);
    ...
    public rz.n3 getDefaultViewModelProviderFactory() {
        ...
        if (this.mDefaultFactory == null) {
            ...
            this.mDefaultFactory = new n(application, this, getArguments());
        }
    ...
    public i4 getEnterTransitionCallback() {
        AnimationInfo animationInfo = this.mAnimationInfo;
        if (animationInfo == null) {
            return null;
        }
    ...
    public i4 getExitTransitionCallback() {
        AnimationInfo animationInfo = this.mAnimationInfo;
        if (animationInfo == null) {
            return null;
        }
    ...
    @NonNull
    public mt getViewLifecycleOwner() {
    ...
    @NonNull
    public xc<mt> getViewLifecycleOwnerLiveData() {
    ...
    public hw getViewModelStore() {
        ...
        if (getMinimumMaxLifecycleState() != s.n3.INITIALIZED.ordinal()) {
    ...
    public void onActivityResult(int i, int i5, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i + " resultCode: " + i5 + " data: " + intent);
        }
    }
    ...
    @Nullable
    public Animation onCreateAnimation(int i, boolean z, int i5) {
        return null;
    }

    @Nullable
    public Animator onCreateAnimator(int i, boolean z, int i5) {
        return null;
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        this.mState = 1;
        this.mCalled = false;
        this.mLifecycleRegistry.y(new t() { // from class: androidx.fragment.app.Fragment.6
            @Override // androidx.lifecycle.t
            public void onStateChanged(@NonNull mt mtVar, @NonNull s.y yVar) {
                View view;
                if (yVar != s.y.ON_STOP || (view = Fragment.this.mView) == null) {
                    return;
                }
        ...
        if (this.mCalled) {
            this.mLifecycleRegistry.c5(s.y.ON_CREATE);
            return;
        }
    ...
    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new Runnable() { // from class: nf.a
            @Override // java.lang.Runnable
            public final void run() {
                this.y.lambda$performCreateView$0();
            }
        });
        ...
        qn.n3(this.mView, this.mViewLifecycleOwner);
        o.y(this.mView, this.mViewLifecycleOwner);
        qk.a.y(this.mView, this.mViewLifecycleOwner);
        this.mViewLifecycleOwnerLiveData.setValue(this.mViewLifecycleOwner);
    }

    public void performDestroy() {
        this.mChildFragmentManager.dispatchDestroy();
        this.mLifecycleRegistry.c5(s.y.ON_DESTROY);
        this.mState = 0;
        this.mCalled = false;
    ...
    public void performDestroyView() {
        ...
        if (this.mView != null && this.mViewLifecycleOwner.getLifecycle().n3().n3(s.n3.CREATED)) {
            this.mViewLifecycleOwner.handleLifecycleEvent(s.y.ON_DESTROY);
        }
        this.mState = 1;
        this.mCalled = false;
        onDestroyView();
    ...
    public void performPause() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleOwner.handleLifecycleEvent(s.y.ON_PAUSE);
        }
        this.mLifecycleRegistry.c5(s.y.ON_PAUSE);
        this.mState = 6;
        this.mCalled = false;
        onPause();
        if (this.mCalled) {
    ...
    public void performResume() {
        ...
        wz wzVar = this.mLifecycleRegistry;
        s.y yVar = s.y.ON_RESUME;
        wzVar.c5(yVar);
        if (this.mView != null) {
            this.mViewLifecycleOwner.handleLifecycleEvent(yVar);
        }
    ...
    public void performStop() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleOwner.handleLifecycleEvent(s.y.ON_STOP);
        }
        this.mLifecycleRegistry.c5(s.y.ON_STOP);
        this.mState = 4;
        this.mCalled = false;
        onStop();
        if (this.mCalled) {
    ...
    public final <I, O> s.n3<I> registerForActivityResult(@NonNull c5.y<I, O> yVar, @NonNull s.y<O> yVar2) {
        return prepareCallInternal(yVar, new co.y<Void, s.zn>() { // from class: androidx.fragment.app.Fragment.7
            @Override // co.y
            public s.zn apply(Void r3) {
                Fragment fragment = Fragment.this;
                Object obj = fragment.mHost;
                return obj instanceof s.gv ? ((s.gv) obj).getActivityResultRegistry() : fragment.requireActivity().getActivityResultRegistry();
            }
        }, yVar2);
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (this.mCalled) {
            if (this.mView != null) {
                this.mViewLifecycleOwner.handleLifecycleEvent(s.y.ON_CREATE);
            }
        } else {
    ...
    public void setAnimations(int i, int i5, int i8, int i10) {
        if (this.mAnimationInfo == null && i == 0 && i5 == 0 && i8 == 0 && i10 == 0) {
            return;
        }
    ...
    public void setEnterSharedElementCallback(@Nullable i4 i4Var) {
        ensureAnimationInfo().mEnterTransitionCallback = i4Var;
    }
    ...
    public void setExitSharedElementCallback(@Nullable i4 i4Var) {
        ensureAnimationInfo().mExitTransitionCallback = i4Var;
    }
    ...
    public void startIntentSenderForResult(@NonNull IntentSender intentSender, int i, @Nullable Intent intent, int i5, int i8, int i10, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        ...
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i, intent, i5, i8, i10, bundle);
    }
    ...
    @NonNull
    public final <I, O> s.n3<I> registerForActivityResult(@NonNull c5.y<I, O> yVar, @NonNull final s.zn znVar, @NonNull s.y<O> yVar2) {
        return prepareCallInternal(yVar, new co.y<Void, s.zn>() { // from class: androidx.fragment.app.Fragment.8
            @Override // co.y
            public s.zn apply(Void r1) {
                return znVar;
            }
        }, yVar2);
    }
    ...
    public LayoutInflater getLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (fragmentHostCallback != null) {
            ...
            qn.mt.y(layoutInflaterOnGetLayoutInflater, this.mChildFragmentManager.getLayoutInflaterFactory());
            return layoutInflaterOnGetLayoutInflater;
        }
