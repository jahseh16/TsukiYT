...
class FragmentStateManager {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            int[] iArr = new int[s.n3.values().length];
            $SwitchMap$androidx$lifecycle$Lifecycle$State = iArr;
            try {
                iArr[s.n3.RESUMED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$androidx$lifecycle$Lifecycle$State[s.n3.STARTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$androidx$lifecycle$Lifecycle$State[s.n3.CREATED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$androidx$lifecycle$Lifecycle$State[s.n3.INITIALIZED.ordinal()] = 4;
    ...
    public void createView() {
        ...
        if (this.mFragment.mView != null) {
            ...
            Fragment fragment4 = this.mFragment;
            fragment4.mView.setTag(R$id.y, fragment4);
            if (viewGroup != null) {
                addViewToContainer();
            }
            Fragment fragment5 = this.mFragment;
            ...
            if (ut.ut(this.mFragment.mView)) {
                ut.yg(this.mFragment.mView);
            } else {
    ...
    public void destroy() {
        ...
        if (fragmentHostCallback instanceof j5) {
    ...
    public Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            this.mFragment.mSavedStateRegistryController.v(bundle4);
            if (!bundle4.isEmpty()) {
