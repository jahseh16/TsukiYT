...
class FragmentAnim {
    ...
    private static int getNextAnim(Fragment fragment, boolean z, boolean z5) {
        return z5 ? z ? fragment.getPopEnterAnim() : fragment.getPopExitAnim() : z ? fragment.getEnterAnim() : fragment.getExitAnim();
    }
    ...
    */
    public static androidx.fragment.app.FragmentAnim.AnimationOrAnimator loadAnimation(@androidx.annotation.NonNull android.content.Context r4, @androidx.annotation.NonNull androidx.fragment.app.Fragment r5, boolean r6, boolean r7) {
        /*
            ...
            r2 = 0
            if (r1 == 0) goto L20
            int r3 = androidx.fragment.R$id.zn
    ...
    private static int transitToAnimResourceId(@NonNull Context context, int i, boolean z) {
        if (i == 4097) {
            return z ? R$animator.f813v : R$animator.f811a;
        }
        if (i == 8194) {
            return z ? R$animator.y : R$animator.n3;
        }
        if (i == 8197) {
        ...
        if (i == 4099) {
            return z ? R$animator.zn : R$animator.f812gv;
        }
        if (i != 4100) {
            return -1;
        }
    ...
    public static class EndViewTransitionAnimation extends AnimationSet implements Runnable {
        ...
        public boolean getTransformation(long j, @NonNull Transformation transformation, float f3) {
            this.mAnimating = true;
            if (this.mEnded) {
                return !this.mTransitionEnded;
            }
