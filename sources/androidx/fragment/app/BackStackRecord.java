...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    */
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull s.n3 n3Var) {
        ...
        if (n3Var == s.n3.INITIALIZED && fragment.mState > -1) {
            throw new IllegalArgumentException("Cannot set maximum Lifecycle to " + n3Var + " after the Fragment has been created");
        }
        if (n3Var != s.n3.DESTROYED) {
            return super.setMaxLifecycle(fragment, n3Var);
        }
        throw new IllegalArgumentException("Cannot set maximum Lifecycle to " + n3Var + ". Use remove() to remove the fragment from the FragmentManager and trigger its destruction.");
    }
    ...
    */
    public androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        ...
        L1c:
            goto L32
        L1d:
            androidx.lifecycle.s$n3 r3 = r2.mOldMaxState
