...
final class BackStackRecordState implements Parcelable {
    ...
    public BackStackRecordState(BackStackRecord backStackRecord) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            ...
            int[] iArr = this.mOps;
            iArr[i8] = op.mFromExpandedOp ? 1 : 0;
    ...
    private void fillInBackStackRecord(@NonNull BackStackRecord backStackRecord) {
        ...
        while (true) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Instantiate " + backStackRecord + " op #" + i5 + " base fragment #" + this.mOps[i8]);
            }
            op.mOldMaxState = s.n3.values()[this.mOldMaxLifecycleStates[i5]];
            op.mCurrentMaxState = s.n3.values()[this.mCurrentMaxLifecycleStates[i5]];
            int[] iArr = this.mOps;
            int i10 = i + 2;
            if (iArr[i8] == 0) {
                z = false;
