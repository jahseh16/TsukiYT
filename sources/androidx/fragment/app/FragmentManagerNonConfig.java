...
public class FragmentManagerNonConfig {
    ...
    @Nullable
    private final Map<String, hw> mViewModelStores;

    public FragmentManagerNonConfig(@Nullable Collection<Fragment> collection, @Nullable Map<String, FragmentManagerNonConfig> map, @Nullable Map<String, hw> map2) {
    ...
    @Nullable
    public Map<String, hw> getViewModelStores() {
