...
public abstract class FragmentTransaction {
    ...
    public static final class Op {
        ...
        public Op(int i, Fragment fragment) {
            ...
            this.mOldMaxState = n3Var;
            this.mCurrentMaxState = n3Var;
        }
        ...
        public Op(int i, @NonNull Fragment fragment, s.n3 n3Var) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
    ...
    public FragmentTransaction addSharedElement(@NonNull View view, @NonNull String str) {
        if (FragmentTransition.supportsTransition()) {
            ...
            if (this.mSharedElementSourceNames == null) {
                ...
                if (this.mSharedElementSourceNames.contains(strYt)) {
                    throw new IllegalArgumentException("A shared element with the source name '" + strYt + "' has already been added to the transaction.");
                }
            }
            this.mSharedElementSourceNames.add(strYt);
    ...
    @NonNull
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull s.n3 n3Var) {
        addOp(new Op(10, fragment, n3Var));
        return this;
    }
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(int i, int i5, int i8, int i10) {
        this.mEnterAnim = i;
        this.mExitAnim = i5;
