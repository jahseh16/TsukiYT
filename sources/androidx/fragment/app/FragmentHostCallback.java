...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    @Deprecated
    public void onStartIntentSenderFromFragment(@NonNull Fragment fragment, @NonNull IntentSender intentSender, int i, @Nullable Intent intent, int i5, int i8, int i10, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i != -1) {
            throw new IllegalStateException("Starting intent sender with a requestCode requires a FragmentActivity host");
        }
        ta.n3.tl(this.mActivity, intentSender, i, intent, i5, i8, i10, bundle);
    }
    ...
    public void onStartActivityFromFragment(@NonNull Fragment fragment, @NonNull Intent intent, int i, @Nullable Bundle bundle) {
        ...
        d.y.startActivity(this.mContext, intent, bundle);
    }
