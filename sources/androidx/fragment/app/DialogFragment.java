...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public DialogFragment() {
        ...
        this.mBackStackId = -1;
        this.mObserver = new fh<mt>() { // from class: androidx.fragment.app.DialogFragment.4
            @Override // ap.fh
            @SuppressLint({"SyntheticAccessor"})
            public void onChanged(mt mtVar) {
                if (mtVar == null || !DialogFragment.this.mShowsDialog) {
                    return;
                }
    ...
    private void dismissInternal(boolean z, boolean z5, boolean z7) {
        if (this.mDismissed) {
            return;
        }
    ...
    public Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        return new i9(requireContext(), getTheme());
    }
    ...
    public void onSaveInstanceState(@NonNull Bundle bundle) {
        ...
        int i8 = this.mBackStackId;
        if (i8 != -1) {
            bundle.putInt(SAVED_BACK_STACK_ID, i8);
        }
    }
    ...
    @NonNull
    public final i9 requireComponentDialog() {
        Dialog dialogRequireDialog = requireDialog();
        if (dialogRequireDialog instanceof i9) {
            return (i9) dialogRequireDialog;
        }
    ...
    public void setStyle(int i, int i5) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.d(FragmentManager.TAG, "Setting style and theme for DialogFragment " + this + " to " + i + ", " + i5);
        }
        this.mStyle = i;
        if (i == 2 || i == 3) {
